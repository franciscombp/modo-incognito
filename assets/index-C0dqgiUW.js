...
`,_p=class{constructor(e,{pixelSize:t=2,levels:n=24,saturation:r=1.12}={}){this.renderer=e,this.pixelSize=t,this.enabled=t>1,this.target=new Kt(1,1,{minFilter:a,magFilter:a,depthBuffer:!0,stencilBuffer:!1,colorSpace:Ie}),this.material=new Lo({uniforms:{tDiffuse:{value:this.target.texture},uResolution:{value:new G(1,1)},uLevels:{value:n},uSaturation:{value:r}},vertexShader:hp,fragmentShader:gp,depthTest:!1,depthWrite:!1}),this.quadScene=new Mn,this.quadCamera=new Cs(-1,1,1,-1,0,1),this.quadScene.add(new mi(new Eo(2,2),this.material)),this.size=new G(1,1)}setSize(e,t){this.size.set(e,t),this._resizeTarget()}setPixelSize(e){this.pixelSize=Math.max(1,Math.round(e)),this.enabled=this.pixelSize>1,this._resizeTarget()}setLevels(e){this.material.uniforms.uLevels.value=e}_resizeTarget(){let e=Math.max(1,Math.floor(this.size.x/this.pixelSize)),t=Math.max(1,Math.floor(this.size.y/this.pixelSize));this.target.setSize(e,t),this.material.uniforms.uResolution.value.set(e,t)}render(e,t){if(!this.enabled){this.renderer.setRenderTarget(null),this.renderer.render(e,t);return}this.renderer.setRenderTarget(this.target),this.renderer.clear(),this.renderer.render(e,t),this.renderer.setRenderTarget(null),this.renderer.render(this.quadScene,this.quadCamera)}dispose(){this.target.dispose(),this.material.dispose()}},vp=`./`;async function yp(e){let t=await fetch(`${vp}data/${e}`,{cache:`no-cache`});if(!t.ok)throw Error(`No se pudo cargar data/${e} (${t.status})`);try{return await t.json()}catch(t){throw Error(`data/${e} no es JSON válido: ${t.message}`)}}var bp=e=>({...e,x:e.x*Z,z:e.z*Z}),xp=e=>({...e,x:e.x*Z,z:e.z*Z,w:e.w*Z,d:e.d*Z});function Sp(e,t,n){if(e[t]==null)throw Error(`${n}: falta el campo "${t}"`);return e[t]}function Cp(e){let t=`escena "${e.id??`?`}"`,n=Sp(e,`areas`,t).map(e=>(e.capacity??=0,xp(e)));return{id:e.id,name:e.name,areas:n,areaById:new Map(n.map(e=>[e.id,e])),footprint:Sp(e,`footprint`,t).map(([e,t])=>[e*Z,t*Z]),spawn:bp(Sp(e,`spawn`,t)),entrance:{...e.entrance,x:e.entrance.x*Z,z:e.entrance.z*Z,w:e.entrance.w*Z},corridors:(e.corridors??[]).map(xp),plants:(e.props??[]).filter(e=>e.type===`plant`).map(bp),props:(e.props??[]).map(bp),patrolRoute:(e.routes?.jefe??Sp(e,`patrol`,t)).map(bp),routes:Object.fromEntries(Object.entries(e.routes??{jefe:e.patrol??[]}).map(([e,t])=>[e,t.map(bp)])),activityStations:(e.activities??[]).map(bp),hidingSpots:(e.hidingSpots??[]).map(e=>({...bp(e),r:(e.r??1.3)*Z})),safeSpots:(e.safeSpots??[]).map(e=>({...bp(e),radius:(e.radius??1.3)*Z})),distractions:(e.distractions??[]).map(e=>({...bp(e),radius:(e.radius??1.2)*Z})),npcs:(e.npcs??[]).map(bp),locationEggs:(e.eggs??[]).map(e=>({...bp(e),radius:(e.radius??2)*Z}))}}function wp(e){let t=e=>({...e,height:(e.height??1.45)*Z,radius:(e.radius??.28)*Z,speed:e.speed==null?void 0:e.speed*Z,visionRange:e.visionRange==null?void 0:e.visionRange*Z,speeds:e.speeds?Object.fromEntries(Object.entries(e.speeds).map(([e,t])=>[e,t*Z])):void 0});return{player:t(e.player),boss:t(e.boss),minions:Object.fromEntries(Object.entries(e.minions??{}).map(([e,n])=>[e,t(n)])),npcs:Object.fromEntries(Object.entries(e.npcs??{}).map(([e,n])=>[e,t(n)]))}}async function Tp(){let e=await yp(`manifest.json`),[t,n,r,i,a]=await Promise.all([yp(e.characters??`characters.json`),yp(e.dialogues??`dialogues.json`).catch(()=>({cast:{},encounters:{},barks:{}})),yp(e.modes??`modes.json`).catch(()=>({characters:{}})),Promise.all((e.scenes??[]).map(e=>yp(`scenes/${e}.json`))),Promise.all((e.levels??[]).map(e=>yp(`levels/${e}.json`)))]),o=new Map(i.map(e=>[e.id,Cp(e)]));if(!o.size)throw Error(`manifest.json no declara ninguna escena`);let s=a.map((e,t)=>({...e,number:e.number??t+1,scene:e.scene??i[0].id,rules:e.rules??{}}));if(!s.length)throw Error(`manifest.json no declara ningún nivel`);for(let e of s)if(!o.has(e.scene))throw Error(`El nivel "${e.id}" apunta a la escena "${e.scene}", que no existe`);return{manifest:e,dialogues:{cast:n.cast??{},encounters:n.encounters??{},barks:n.barks??{}},characters:wp(t),modes:r.characters??{},scenes:o,levels:s,codeEggs:e.codeEggs??[]}}var Ep={south:0,west:1,east:2,north:3},Dp=32/44,Op=8,kp=new cs,Ap=new Map;function jp(e){return Ap.has(e)||Ap.set(e,new Promise((t,n)=>{kp.load(e,e=>{e.colorSpace=Ie,e.magFilter=a,e.minFilter=a,e.generateMipmaps=!1,t(e)},void 0,n)})),Ap.get(e)}var Mp=class{constructor(e,{height:t=1.5,y:n=0}={}){this.texture=e.clone(),this.texture.needsUpdate=!0,this.texture.repeat.set(1/4,1/4),this.material=new Mr({map:this.texture,transparent:!0,alphaTest:.4,depthWrite:!0,toneMapped:!1}),this.object=new Kr(this.material),this.height=t,this.object.scale.set(t*Dp,t,1),this.baseY=n+t/2,this.object.position.y=this.baseY,this.facing=`south`,this.frame=0,this._timer=0,this._moving=!1,this._applyFrame()}setFacing(e){e&&e!==this.facing&&Ep[e]!==void 0&&(this.facing=e,this._applyFrame())}setMoving(e){e!==this._moving&&(this._moving=e,e||(this.frame=0,this._timer=0,this._applyFrame()))}setPosition(e,t){this.object.position.x=e,this.object.position.z=t}setTint(e){this.material.color.setScalar(e)}update(e){if(!this._moving)return;this._timer+=e;let t=1/Op;for(;this._timer>=t;)this._timer-=t,this.frame=(this.frame+1)%4,this._applyFrame()}_applyFrame(){let e=Ep[this.facing]??0;this.texture.offset.set(this.frame/4,1-(e+1)/4)}},Np=class{constructor(e,{x:t=0,z:n=12.6,radius:r=.26*Z,height:i=1.45*Z,speed:a=4.4*Z}={}){this.speed=a,this.radius=r,this.position={x:t,z:n},this.keys=new Set,this.touchAxis={x:0,z:0},this.speedMul=1,this.isHiding=!1,this.isPretending=!1,this.isDoingActivity=!1,this.facing=`south`,this.sprite=new Mp(e,{height:i}),this.sprite.setPosition(t,n),this._onKeyDown=e=>{let t=e.key.toLowerCase();this.keys.add(t),[`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,` `].includes(t)&&e.preventDefault()},this._onKeyUp=e=>this.keys.delete(e.key.toLowerCase()),window.addEventListener(`keydown`,this._onKeyDown),window.addEventListener(`keyup`,this._onKeyUp)}get object3D(){return this.sprite.object}_readInput(){let e=this.touchAxis.x,t=this.touchAxis.z;if(Math.hypot(e,t)>.08)return{right:e,up:-t};let n=0,r=0;return(this.keys.has(`w`)||this.keys.has(`arrowup`))&&(r+=1),(this.keys.has(`s`)||this.keys.has(`arrowdown`))&&--r,(this.keys.has(`a`)||this.keys.has(`arrowleft`))&&--n,(this.keys.has(`d`)||this.keys.has(`arrowright`))&&(n+=1),{right:n,up:r}}update(e,t){let{right:n,up:r}=this._readInput(),i=Math.min(Math.hypot(n,r),1),a=!1;if(i>.001){let{dx:t,dz:o}=Od(n,r),s=Math.hypot(t,o)||1,c=(this.isPretending?.45:1)*this.speedMul,l=this.speed*c*i*e;this.position.x+=t/s*l,this.position.z+=o/s*l,this.facing=kd(t,o,this.facing),a=!0}t&&t.resolveCircle(this.position,this.radius),this.sprite.setFacing(this.facing),this.sprite.setMoving(a&&!this.isPretending),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.setTint(this.isHiding?.6:1),this.sprite.update(e)}dispose(){window.removeEventListener(`keydown`,this._onKeyDown),window.removeEventListener(`keyup`,this._onKeyUp)}},Pp=class{constructor(e,{id:t,x:n,z:r,radius:i=.28*Z,height:a=1.4*Z,facing:o=`south`,sway:s=0}={}){this.id=t,this.position={x:n,z:r},this.home={x:n,z:r},this.radius=i,this.sway=s*Z,this.sprite=new Mp(e,{height:a}),this.sprite.setFacing(o),this.sprite.setPosition(n,r),this._phase=Math.random()*Math.PI*2}get object3D(){return this.sprite.object}update(e,t){if(this.sway>0){let e=Math.sin(t*.6+this._phase)*this.sway,n=this.position.x;this.position.x=this.home.x+e,this.sprite.setFacing(this.position.x>=n?`east`:`west`),this.sprite.setMoving(Math.abs(this.position.x-n)>5e-4),this.sprite.setPosition(this.position.x,this.position.z)}this.sprite.update(e)}},Fp={PATROL:`PATROL`,INVESTIGATE:`INVESTIGATE`,CHASE:`CHASE`,SEARCH:`SEARCH`},{PATROL:Ip,INVESTIGATE:Lp,CHASE:Rp,SEARCH:zp}=Fp;function Bp(e,t){return Math.atan2(-e,-t)}function Vp(e,t,n=24){let r=[];for(let i=0;i<n;i++){let a=-t+2*t*(i/n),o=-t+2*t*((i+1)/n);r.push(0,0,0),r.push(Math.sin(a)*e,0,-Math.cos(a)*e),r.push(Math.sin(o)*e,0,-Math.cos(o)*e)}let i=new Er;return i.setAttribute(`position`,new mr(r,3)),i}var Hp=class{constructor(e,{world:t,route:n,navmesh:r=null,radius:i=.3*Z,height:a=1.55*Z,speeds:o={},visionRange:s=7.5*Z,visionHalfAngleDeg:c=30,speedMul:l=1,role:u=`boss`,name:d=`Jefe`,coneColor:f=15910724,onSpot:p=null}){this.role=u,this.name=d,this.onSpot=p,this._reportCooldown=0,this.world=t,this.navmesh=r,this.route=n,this.routeIndex=0,this.position={x:n[0].x,z:n[0].z},this.radius=i,this.facingDir={x:0,z:-1},this._path=null,this._pathTarget=null,this._repathTimer=0,this._stuckTimer=0,this._lastPos={x:this.position.x,z:this.position.z},this._waypointTimer=0,this.prowlTarget=null,this.prowlTimer=0,this.pointsOfInterest=[],this.state=Ip,this.baseSpeeds={patrol:o.patrol??2.4*1.2,investigate:o.investigate??3.2*1.2,chase:o.chase??4.9*1.2,search:o.search??3*1.2},this.speed=this.baseSpeeds.patrol*l,this.investigateSpeed=this.baseSpeeds.investigate*l,this.chaseSpeed=this.baseSpeeds.chase*l,this.searchSpeed=this.baseSpeeds.search*l,this.investigateTarget=null,this.investigateTimer=0,this.searchTarget=null,this.searchTimer=0,this.loseSightTimer=0,this.lastSeenPlayerPos=null,this.baseVisionRange=s,this.visionRange=s,this.halfAngle=Tt.degToRad(c),this.playerVisible=!1,this.redAlert=!1,this.sprite=new Mp(e,{height:a}),this.sprite.setPosition(this.position.x,this.position.z);let m=Vp(this.visionRange,this.halfAngle);this.baseConeColor=f,this.coneMaterial=new ni({color:f,transparent:!0,opacity:.55,side:2,depthWrite:!1,toneMapped:!1}),this.cone=new mi(m,this.coneMaterial),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.renderOrder=2;let h=new qi(new oa(m,1),new Fi({color:16777215,transparent:!0,opacity:.45,toneMapped:!1}));this.cone.add(h)}get object3D(){return this.sprite.object}get isHunting(){return this.state===Rp||this.state===zp}startChase(){this.state=Rp,this.loseSightTimer=0}distract(e,t){return this.state===Rp?!1:(this.state=Lp,this.investigateTarget={x:e.x,z:e.z},this.investigateTimer=t,!0)}catches(e,t){return this.role!==`minion`&&Math.hypot(e.x-this.position.x,e.z-this.position.z)<this.radius+t+.25*Z}setPointsOfInterest(e){this.pointsOfInterest=e,this.prowlTarget=null,this.prowlTimer=4+Math.random()*6}setRoute(e,t=0){this.route=e,this.routeIndex=Math.min(t,e.length-1),this.position.x=e[this.routeIndex].x,this.position.z=e[this.routeIndex].z,this._path=null,this._waypointTimer=0,this._stuckTimer=0,this.resetToPatrol()}setActive(e){this.active=e,this.sprite.object.visible=e,this.cone.visible=e,e||(this.playerVisible=!1,this.redAlert=!1)}resetToPatrol(){this.state=Ip,this.loseSightTimer=0,this.searchTimer=0,this.lastSeenPlayerPos=null}update(e,t,n){if(this.active===!1)return;this._reportCooldown>0&&(this._reportCooldown-=e),this._updateVision(t,n),this.role===`minion`&&this.redAlert&&this._reportCooldown<=0&&(this._reportCooldown=8,this.onSpot?.(this,{x:t.position.x,z:t.position.z})),this._advanceState(e,t),this._updateStuck(e);let r=this._pickTarget(t),i=this._moveToward(e,this._steer(e,r));if(i)this.facingDir=i;else if(this.playerVisible){let e=t.position.x-this.position.x,n=t.position.z-this.position.z,r=Math.hypot(e,n);r>.001&&(this.facingDir={x:e/r,z:n/r})}this.sprite.setFacing(kd(this.facingDir.x,this.facingDir.z,`south`)),this.sprite.setMoving(!!i),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.update(e),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.rotation.y=Bp(this.facingDir.x,this.facingDir.z);let a=this.redAlert||this.state===Rp;this.coneMaterial.color.set(a?15091775:this.state===zp?14721084:this.baseConeColor),this.coneMaterial.opacity=a?.68:.55}_advanceState(e,t){switch(this.state){case Rp:this.playerVisible?this.loseSightTimer=0:(this.loseSightTimer+=e,this.loseSightTimer>1.2&&(this.state=zp,this.searchTarget=this.lastSeenPlayerPos??{...this.position},this.searchTimer=5));break;case zp:this.searchTimer-=e,this.playerVisible?this.startChase():this.searchTimer<=0&&this._resumeNearestRoutePoint();break;case Lp:this.investigateTimer-=e,this.playerVisible&&t.isDoingActivity?this.startChase():(this.investigateTimer<=0||this._reached(this.investigateTarget))&&this._resumeNearestRoutePoint();break;default:if(this.redAlert){this.startChase();break}this.prowlTimer-=e,this.prowlTimer<=0&&this.pointsOfInterest.length&&(this.prowlTimer=14+Math.random()*10,this.prowlTarget=this.pointsOfInterest[Math.floor(Math.random()*this.pointsOfInterest.length)]),this.prowlTarget&&this._reached(this.prowlTarget,1.6*1.2)&&(this.prowlTarget=null),this._waypointTimer+=e,(this._reached(this.route[this.routeIndex])||this._waypointTimer>14)&&(this.routeIndex=(this.routeIndex+1)%this.route.length,this._waypointTimer=0,this._path=null);break}}_resumeNearestRoutePoint(){let e=0,t=1/0;this.route.forEach((n,r)=>{let i=Math.hypot(n.x-this.position.x,n.z-this.position.z);i<t&&(t=i,e=r)}),this.routeIndex=e,this.state=Ip,this.searchTimer=0,this.loseSightTimer=0}_updateStuck(e){let t=Math.hypot(this.position.x-this._lastPos.x,this.position.z-this._lastPos.z);if(this._lastPos.x=this.position.x,this._lastPos.z=this.position.z,t>.02*1.2){this._stuckTimer=0;return}this._stuckTimer+=e,!(this._stuckTimer<1.4)&&(this._stuckTimer=0,this._path=null,this._pathTarget=null,this.prowlTarget=null,this.state===Ip?(this.routeIndex=(this.routeIndex+1)%this.route.length,this._waypointTimer=0):this.state===zp?this._resumeNearestRoutePoint():this.state===Lp&&(this.investigateTimer=0))}_pickTarget(e){return this.state===Rp?e.isHiding?this.lastSeenPlayerPos??this.route[this.routeIndex]:{x:e.position.x,z:e.position.z}:this.state===zp?this.searchTarget??this.route[this.routeIndex]:this.state===Lp?this.investigateTarget:this.prowlTarget??this.route[this.routeIndex]}_steer(e,t){if(!t||!this.navmesh)return t;if(this._repathTimer-=e,this.world&&!this.world.lineBlocked(this.position,t))return this._path=null,t;let n=!this._pathTarget||Math.hypot(this._pathTarget.x-t.x,this._pathTarget.z-t.z)>1.2*1.2;if((!this._path||n||this._repathTimer<=0)&&(this._path=this.navmesh.path(this.position,t),this._pathTarget={x:t.x,z:t.z},this._repathTimer=.5),!this._path||!this._path.length)return t;for(;this._path.length>1&&Math.hypot(this._path[0].x-this.position.x,this._path[0].z-this.position.z)<.6*1.2;)this._path.shift();return this._path[0]}_reached(e,t=.4*Z){return!e||Math.hypot(e.x-this.position.x,e.z-this.position.z)<t}_speed(){return this.state===Rp?this.chaseSpeed:this.state===zp?this.searchSpeed:this.state===Lp?this.investigateSpeed:this.speed}_moveToward(e,t){if(!t)return null;let n=t.x-this.position.x,r=t.z-this.position.z,i=Math.hypot(n,r);if(i<.06*1.2)return null;let a=n/i,o=r/i,s=this._speed()*e,c={x:this.position.x,z:this.position.z};if(this.position.x+=a*s,this.position.z+=o*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)<s*.3){for(let[e,t]of[[a,0],[0,o]])if(this.position.x=c.x+e*s,this.position.z=c.z+t*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)>s*.3)break}let l=this.position.x-c.x,u=this.position.z-c.z;return Math.hypot(l,u)<1e-4?null:{x:a,z:o}}_updateVision(e,t){if(this.playerVisible=!1,this.redAlert=!1,e.isHiding)return;let n=e.position.x-this.position.x,r=e.position.z-this.position.z,i=Math.hypot(n,r);if(i>this.visionRange||i<.001)return;let a={x:n/i,z:r/i};if(this.facingDir.x*a.x+this.facingDir.z*a.z<Math.cos(this.halfAngle))return;let o=t.map(e=>({x:e.position.x,z:e.position.z,radius:e.radius}));this.world&&this.world.lineBlocked(this.position,e.position,o)||(this.playerVisible=!0,this.lastSeenPlayerPos={x:e.position.x,z:e.position.z},e.isDoingActivity&&!e.isPretending&&(this.redAlert=!0))}},Up=`modo-incognito:settings:v1`,Wp={auto:{label:`Auto`},alto:{label:`Alto`,shadows:!0,shadowMap:2048,maxPixelRatio:2},medio:{label:`Medio`,shadows:!0,shadowMap:1024,maxPixelRatio:1.5},bajo:{label:`Bajo`,shadows:!1,shadowMap:512,maxPixelRatio:1}},Gp={quality:{label:`Calidad gráfica`,type:`choice`,options:[`auto`,`alto`,`medio`,`bajo`],hint:`Auto baja sola si el dispositivo no da abasto`},pixelSize:{label:`Tamaño de píxel`,type:`range`,min:1,max:6,step:1,hint:`1 = 3D nítido · 4+ = pixel art grueso`},colorLevels:{label:`Niveles de color`,type:`range`,min:6,max:64,step:2,hint:`Menos niveles = paleta más marcada`},showLabels:{label:`Rótulos de zona`,type:`toggle`},showMarkers:{label:`Marcas de suelo`,type:`toggle`},vibration:{label:`Vibración (móvil)`,type:`toggle`},screenShake:{label:`Sacudida de cámara`,type:`toggle`}},Kp=Object.freeze({quality:`auto`,pixelSize:2,colorLevels:24,showLabels:!1,showMarkers:!0,vibration:!0,screenShake:!0});function qp(e){let t={...Kp,...e};for(let[e,n]of Object.entries(Gp))if(n.type===`range`){let r=Number(t[e]);t[e]=Number.isFinite(r)?Math.min(n.max,Math.max(n.min,r)):Kp[e]}else n.type===`choice`?t[e]=n.options.includes(t[e])?t[e]:Kp[e]:t[e]=!!t[e];return t}function Jp(){try{let e=localStorage.getItem(Up);return qp(e?JSON.parse(e):{})}catch{return{...Kp}}}var Yp=Jp(),Xp=new Set;function Zp(){return Yp}function Qp(e){Yp=qp({...Yp,...e});try{localStorage.setItem(Up,JSON.stringify(Yp))}catch{}return Xp.forEach(e=>e(Yp)),Yp}function $p(e){return Xp.add(e),e(Yp),()=>Xp.delete(e)}function em(e=Yp.quality){if(e!==`auto`)return Wp[e]??Wp.medio;let t=matchMedia(`(pointer: coarse)`).matches,n=(navigator.deviceMemory??8)<=4,r=(navigator.hardwareConcurrency??8)<=4;return t||n||r?Wp.medio:Wp.alto}function tm(e=12){Yp.vibration&&navigator.vibrate?.(e)}var nm=100,rm=45,im=12,am=16,om=12,sm=9,cm=5,lm=1.5*Z,um=7,dm=6,fm=14,pm=[12,34,58,80],mm=[{vision:1,speed:1,huntEvery:1/0},{vision:1.08,speed:1.05,huntEvery:1/0},{vision:1.18,speed:1.12,huntEvery:14},{vision:1.3,speed:1.2,huntEvery:9},{vision:1.45,speed:1.3,huntEvery:6}],hm=new Set([jd.OPEN_OFFICE,jd.MEETING]),gm=.25,_m=30,vm=3.4*Z,ym=.55,bm=25,xm=22,Sm=.5,Cm=4,wm=11*Z,Tm=.8,Em=1.4,Dm=15,Om={duration:240,maxWarnings:3,objectives:null,decayMul:1,distractionsOff:!1,targetScore:1e3,minionSuspicionMul:1,explore:!1,pretendAlways:!1},km=class{constructor({player:e,boss:t,npcs:n,minions:r=[],hud:i,rules:a={},onFinish:o=null,onEgg:s=null,onPopup:c=null,onTalk:l=null}){this.player=e,this.boss=t,this.npcs=n,this.minions=r,this.onTalk=l,this.hud=i,this.rules={...Om,...a},this.onFinish=o,this.onEgg=s,this.onPopup=c,this.suspicion=0,this.warnings=0,this.timeLeft=this.rules.duration,this.gameOver=!1,this.win=!1,this.paused=!1,this._finished=!1,this.score=0,this.combo=1,this.comboLeft=0,this.perk=null,this.perkLeft=0,this._perkSpeedMul=1,this.revealBossUntil=0,this.heat=0,this.inWorkspace=!1,this.inSafeSpot=!1,this._huntTimer=0;let u=this.rules.objectives;this.objectives=Ud.filter(e=>!u||u.includes(e.id)).map(e=>({...e,progress:0,done:!1})),this.distractionState=this.rules.distractionsOff?[]:Kd.map(e=>({...e,cooldownLeft:0})),this.nearStation=null,this.nearDistraction=null,this.nearNpc=null,this.focusStation=null,this.message=null,this.currentArea=null,this.talkCooldowns=new Map,this.hideState=Wd.map(()=>({cooldownLeft:0,usedFor:0})),this._hidingCharge=e=>this.hidingCharge(e),this.safeSpotState=Gd.map(()=>({left:bm,spent:!1})),this._safeSpotCharge=e=>this.safeSpotCharge(e),this._prevInteractKey=!1,this._caughtCooldown=0,this._eggDwell=new Map,this._foundEggs=new Set}setPaused(e){this.paused=e,e&&(this.player.keys.clear(),this.player.touchAxis.x=0,this.player.touchAxis.z=0)}update(e){if(this.gameOver||this.paused){this.hud.render(this._snapshot());return}this.timeLeft=Math.max(0,this.timeLeft-e),this._caughtCooldown>0&&(this._caughtCooldown-=e),this.revealBossUntil>0&&(this.revealBossUntil-=e),this.comboLeft>0&&(this.comboLeft=Math.max(0,this.comboLeft-e),this.comboLeft===0&&(this.combo=1)),this.perkLeft>0&&(this.perkLeft=Math.max(0,this.perkLeft-e),this.perkLeft===0&&this._clearPerk());let t=this.player.position;this.currentArea=Xd(t.x,t.z)??Zd(t.x,t.z).area,this.player.isHiding=this._updateHiding(e,t),this.inSafeSpot=this._updateSafeSpot(e,t);let n=this.player.keys.has(`e`),r=this.player.keys.has(`f`);if(this.player.isPretending=r,this.inWorkspace=!!(this.currentArea&&hm.has(this.currentArea.kind)),this.nearStation=this.objectives.find(e=>!e.done&&Math.hypot(e.x-t.x,e.z-t.z)<lm)??null,this.focusStation=this.objectives.filter(e=>!e.done).reduce((e,n)=>{let r=Math.hypot(n.x-t.x,n.z-t.z);return!e||r<e._d?Object.assign(n,{_d:r}):e},null),this.nearStation&&n&&!r?(this.player.isDoingActivity=!0,this.nearStation.progress=Math.min(this.nearStation.time,this.nearStation.progress+e),this.nearStation.progress>=this.nearStation.time&&!this.nearStation.done&&(this.nearStation.done=!0,this._completeActivity(this.nearStation))):this.player.isDoingActivity=!1,this.distractionState.forEach(t=>{t.cooldownLeft>0&&(t.cooldownLeft=Math.max(0,t.cooldownLeft-e))}),this.nearDistraction=this.distractionState.find(e=>e.cooldownLeft<=0&&Math.hypot(e.x-t.x,e.z-t.z)<lm)??null,this.talkCooldowns.forEach((t,n)=>{t>0&&this.talkCooldowns.set(n,Math.max(0,t-e))}),this.nearNpc=this.npcs.find(e=>e.cast&&(this.talkCooldowns.get(e.id)??0)<=0&&Math.hypot(e.position.x-t.x,e.position.z-t.z)<lm*1.3)??null,n&&!this._prevInteractKey&&this.nearNpc&&!this.nearStation){let e=this.nearNpc;this.talkCooldowns.set(e.id??e.cast,e.talkCooldown??40),this.onTalk?.(e)}else if(n&&!this._prevInteractKey&&this.nearDistraction&&!this.nearStation){let e={x:this.nearDistraction.x,z:this.nearDistraction.z};this.boss.distract(e,um)?(this.nearDistraction.cooldownLeft=this.nearDistraction.cooldown,this._toast(`Distracción: ${this.nearDistraction.label}`),this._award(40,`Distracción`,this.player.position)):this._toast(`¡Ya te vio! Una distracción no lo detiene ahora.`)}if(this._prevInteractKey=n,this.boss.update(e,this.player,this.npcs),this.minions.forEach(t=>t.update(e,this.player,this.npcs)),this._updateMinionApproach(),this._updateEggs(e),this._updateSpeedMul(),this.rules.explore)this.suspicion=0;else if(this.inSafeSpot)this.suspicion=Math.max(0,this.suspicion-im*this.rules.decayMul*e);else{let t=this.rules.decayMul,n=!this.player.isPretending&&!this.inWorkspace,r=this.minions.some(e=>e.redAlert),i=!r&&n&&this.minions.some(e=>e.playerVisible);if(r&&!this.boss.redAlert?this.suspicion=Math.min(nm,this.suspicion+om*this.rules.minionSuspicionMul*e):i&&!this.boss.redAlert&&(this.suspicion=Math.min(nm,this.suspicion+cm*this.rules.minionSuspicionMul*e)),this.boss.redAlert){let t=this.nearStation?.riskRate??20;this.suspicion=Math.min(nm,this.suspicion+t*e)}else if(this.boss.state===Fp.CHASE&&this.boss.playerVisible)this.suspicion=Math.min(nm,this.suspicion+am*e);else if(this.boss.playerVisible&&n)this.suspicion=Math.min(nm,this.suspicion+sm*e);else if(this.player.isHiding)this.suspicion=Math.max(0,this.suspicion-rm*t*e);else if(this.player.isPretending){let n=this.inWorkspace?1:gm;this.suspicion=Math.max(0,this.suspicion-rm*n*t*e)}else this.suspicion=Math.max(0,this.suspicion-im*t*e)}this._updateHeat(e);let i=this.player.isPretending&&(this.rules.pretendAlways||this.suspicion<_m);!this.rules.explore&&this._caughtCooldown<=0&&this.boss.isHunting&&!this.player.isHiding&&!this.inSafeSpot&&!i&&this.boss.catches(t,this.player.radius)&&this._warn(),!this.gameOver&&!this.rules.explore&&(this.objectives.every(e=>e.done)?this._finish(!0):this.timeLeft<=0&&this._finish(!1)),this.message&&(this.message.timer-=e,this.message.timer<=0&&(this.message=null)),this.hud.render(this._snapshot())}_completeActivity(e){let t=Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),n=0,r=``;this.boss.playerVisible?(n=Em,r=` · ¡EN SUS NARICES!`):t<wm&&(n=Tm,r=` · con el jefe cerca`);let i=e.points??120,a=Math.round(i*(this.combo+n));this.score+=a,this.combo=Math.min(Cm,this.combo+Sm),this.comboLeft=xm,e.perk&&this._applyPerk(e.perk),tm([12,40,18]),this._toast(`${e.label} ✔${r}`),this.onPopup?.({text:`+${a}`,sub:this.combo>1?`x${this.combo.toFixed(1)}`:``,x:e.x,z:e.z,kind:n?`nerve`:`score`})}_award(e,t,n){let r=Math.round(e*this.combo);this.score+=r,this.onPopup?.({text:`+${r}`,sub:t,x:n.x,z:n.z,kind:`minor`})}_applyPerk(e){this._clearPerk(),this.perk=e,this.perkLeft=Dm,e===`caffeine`&&(this._perkSpeedMul=1.35,this._toast(`☕ Cafeína: +35% de velocidad`))}_clearPerk(){this.perk===`caffeine`&&(this._perkSpeedMul=1),this.perk=null}_updateSpeedMul(){let e=this.minions.find(e=>e.cast===`washo`),t=e&&e.playerVisible?ym:1;this.player.speedMul=this._perkSpeedMul*t}_updateHeat(e){let t=pm.filter(e=>this.suspicion>=e).length;t!==this.heat&&(t>this.heat&&(tm([20,30,20]),this._toast(`Nivel de búsqueda ${t}`)),this.heat=t);let n=mm[this.heat],r=this.boss.dayTuning??{vision:this.boss.baseVisionRange,speedMul:1};this.boss.visionRange=r.vision*n.vision;let i=r.speedMul*n.speed;this.boss.speed=this.boss.baseSpeeds.patrol*i,this.boss.investigateSpeed=this.boss.baseSpeeds.investigate*i,this.boss.chaseSpeed=this.boss.baseSpeeds.chase*i,this.boss.searchSpeed=this.boss.baseSpeeds.search*i,this._huntTimer-=e,this._huntTimer<=0&&Number.isFinite(n.huntEvery)&&(this._huntTimer=n.huntEvery,this.player.isHiding||this.boss.distract({x:this.player.position.x,z:this.player.position.z},8))}_updateMinionApproach(){if(!this.onTalk)return;let e=this.player.position;for(let t of this.minions)if(t.active!==!1&&!(!t.cast||(this.talkCooldowns.get(t.id??t.cast)??0)>0)&&!(Math.hypot(t.position.x-e.x,t.position.z-e.z)>vm)){this.talkCooldowns.set(t.id??t.cast,t.talkCooldown??35),this.onTalk(t,{unsolicited:!0});return}}_updateHiding(e,t){let n=!1;return Wd.forEach((r,i)=>{let a=this.hideState[i],o=Math.hypot(r.x-t.x,r.z-t.z)<r.r;if(a.cooldownLeft>0){a.cooldownLeft=Math.max(0,a.cooldownLeft-e),a.cooldownLeft===0&&(a.usedFor=0);return}if(!o){a.usedFor=Math.max(0,a.usedFor-e*.6);return}if(a.usedFor+=e,a.usedFor>=dm){a.cooldownLeft=fm,this._toast(`Ese escondite se quemó. Busca otro.`),tm(30);return}n=!0}),n}hidingCharge(e){let t=this.hideState[e];return t?t.cooldownLeft>0?0:1-t.usedFor/dm:1}_updateSafeSpot(e,t){let n=!1;return Gd.forEach((r,i)=>{let a=this.safeSpotState[i];a.spent||Math.hypot(r.x-t.x,r.z-t.z)<r.radius&&(n=!0,a.left=Math.max(0,a.left-e),a.left===0&&(a.spent=!0,this._toast(`${r.label??`Lugar seguro`}: gastaste tu tiempo ahí hoy.`)))}),n}safeSpotCharge(e){let t=this.safeSpotState[e];return t?t.spent?0:t.left/bm:1}_updateEggs(e){if(!this.onEgg)return;let t=this.player.position;for(let n of Jd){if(this._foundEggs.has(n.id))continue;let r=Math.hypot(n.x-t.x,n.z-t.z)<n.radius,i=(this._eggDwell.get(n.id)??0)+(r?e:-e*2);this._eggDwell.set(n.id,Math.max(0,i)),i>=n.dwell&&(this._foundEggs.add(n.id),this.score+=250,this.onEgg(n))}}_warn(){this.rules.explore||(this.warnings+=1,this.suspicion=0,this._caughtCooldown=3,this.combo=1,this.comboLeft=0,this.boss.resetToPatrol(),tm([40,60,40]),this.warnings>=this.rules.maxWarnings?(this._toast(`Última advertencia: despedida.`),this._finish(!1)):this._toast(`Advertencia ${this.warnings}/${this.rules.maxWarnings}`))}_finish(e){this._finished||(this._finished=!0,this.gameOver=!0,this.win=e,this._clearPerk(),e&&(this.score+=Math.round(this.timeLeft*4)),this.onFinish?.({win:e,score:this.score,targetScore:this.rules.targetScore,warnings:this.warnings,timeLeft:this.timeLeft,elapsed:this.rules.duration-this.timeLeft,objectives:this.objectives,eggsFound:this._foundEggs.size}))}applyEffect(e){switch(e){case`suspicion-`:this.suspicion=Math.max(0,this.suspicion-45),this._toast(`La sospecha baja`);break;case`suspicion+`:this.suspicion=Math.min(nm,this.suspicion+30),this._toast(`Alguien levantó la voz…`);break;case`score+`:this._award(120,`Buena conversación`,this.player.position);break;case`speed+`:this._applyPerk(`caffeine`);break;case`reveal-boss`:this.revealBossUntil=12,this._toast(`Sabes dónde está el jefe`);break;case`time+`:this.timeLeft=Math.max(0,this.timeLeft-45),this._toast(`El reloj corre más rápido…`);break;case`chispita-report`:this.suspicion=Math.min(nm,this.suspicion+30),this._chispitaReport();break;default:break}}_chispitaReport(){let e=this.minions.find(e=>e.cast===`chispita`);if(Math.random()<.45){this._toast(`Chispita corre a avisar al jefe… que pasa de ella.`);return}(!this.objectives.some(e=>e.done)||this.player.isPretending)&&e?(e.setActive(!1),this._toast(`El jefe se harta de falsas alarmas: encierra a Chispita en una sala. Hoy no molesta más.`)):(this.boss.distract({x:this.player.position.x,z:this.player.position.z},10),this._toast(`¡Chispita avisó al jefe! Viene para acá.`))}_toast(e){this.message={text:e,timer:2.6}}_snapshot(){return this.lastSnapshot={suspicion:this.suspicion,suspicionMax:nm,warnings:this.warnings,maxWarnings:this.rules.maxWarnings,timeLeft:this.timeLeft,levelDuration:this.rules.duration,objectives:this.objectives,nearStation:this.nearStation,nearDistraction:this.nearDistraction,nearNpc:this.nearNpc,focusStation:this.focusStation,playerPos:this.player.position,bossPos:this.boss.position,bossDistance:Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),heat:this.heat,maxHeat:pm.length,inWorkspace:this.inWorkspace,minionAlert:this.minions.some(e=>e.redAlert),minionPositions:this.minions.map(e=>e.position),hidingCharge:this._hidingCharge,safeSpotCharge:this._safeSpotCharge,inSafeSpot:this.inSafeSpot,worldScale:Z,revealBoss:this.revealBossUntil>0,isPretending:this.player.isPretending,isHiding:this.player.isHiding,redAlert:this.boss.redAlert,bossState:this.boss.state,gameOver:this.gameOver,win:this.win,message:this.message,area:this.currentArea,score:this.score,combo:this.combo,comboLeft:this.comboLeft,comboWindow:xm,perk:this.perk,perkLeft:this.perkLeft,perkDuration:Dm,targetScore:this.rules.targetScore},this.lastSnapshot}};function Am(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function jm(e){return`#${e.toString(16).padStart(6,`0`)}`}function Q(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n&&n.appendChild(r),r}jd.OPEN_OFFICE,jd.MEETING,jd.SOCIAL,jd.AUDITORIUM,jd.CORE,jd.ELEVATOR;function Mm(e){let t=Q(`div`,`hud-root`,e),n=Q(`div`,`hud-topbar`,t),r=Q(`div`,`hud-panel hud-objectives`,n),i=Q(`div`,`hud-panel-title`,r);i.innerHTML=`<span class="hud-title-icon">🎯</span> OBJETIVOS <span class="hud-objectives-count"></span>`;let a=i.querySelector(`.hud-objectives-count`),o=Q(`div`,`hud-objectives-list`,r),s=Q(`div`,`hud-center`,n),c=Q(`div`,`hud-day-chip`,s),l=Q(`div`,`heat-stars`,s),u=Q(`div`,`hud-panel hud-suspicion`,s),d=Q(`div`,`hud-panel-title`,u);d.innerHTML=`<span class="hud-title-icon">👁️</span> SOSPECHA`;let f=Q(`div`,`hud-suspicion-fill`,Q(`div`,`hud-suspicion-track`,u)),p=Q(`div`,`hud-suspicion-glint`,f),m=Q(`div`,`hud-warnings`,u),h=[],g=Q(`div`,`hud-status-badge`,s),_=Q(`div`,`hud-toast`,s),v=Q(`div`,`hud-right`,n),y=Q(`div`,`hud-panel hud-timer`,v),b=Q(`div`,`hud-panel-title`,y);b.innerHTML=`<span class="hud-title-icon">⏱️</span> JORNADA`;let x=Q(`div`,`hud-timer-value`,y),S=Q(`div`,`hud-timer-fill`,Q(`div`,`hud-timer-track`,y)),C=Q(`div`,`hud-panel hud-scorepanel`,v),w=Q(`div`,`hud-panel-title`,C);w.innerHTML=`<span class="hud-title-icon">◆</span> PUNTOS`;let T=Q(`div`,`hud-score`,C),E=Q(`span`,`hud-score-value`,T),D=Q(`span`,`hud-combo`,T),O=Q(`span`,`hud-combo-bar`,D),k=Q(`span`,`hud-combo-text`,D),A=Q(`div`,`hud-perk`,C),j=Q(`div`,`hud-overlay hidden`,t),ee=Q(`div`,`hud-overlay-card`,j),M=Q(`div`,`hud-overlay-icon`,ee),N=Q(`div`,`hud-overlay-title`,ee),P=Q(`div`,`hud-overlay-score`,ee),F=Q(`div`,`hud-overlay-body`,ee),te=Q(`div`,`hud-overlay-actions`,ee),I=-1;function ne(e){c.textContent=`DÍA ${e.number} · ${e.title.toUpperCase()}`}function re(e){t.classList.toggle(`hidden`,!e)}function L({icon:e,title:t,body:n,win:r,actions:i,rank:a,score:o,target:s}){if(M.textContent=e,N.textContent=t,N.classList.toggle(`win`,!!r),N.classList.toggle(`lose`,!r),P.innerHTML=``,o!=null){let e=Q(`div`,`hud-result-score`,P);if(Q(`span`,`hud-result-points`,e,`${o.toLocaleString(`es`)} pts`),s){let t=Q(`div`,`hud-result-fill`,Q(`div`,`hud-result-track`,e));t.style.width=`${Math.min(100,Math.round(o/s*100))}%`,Q(`span`,`hud-result-target`,e,`objetivo ${s.toLocaleString(`es`)}`)}}if(a){let e=Q(`div`,`hud-rank rank-${a.label}`,P);Q(`span`,`hud-rank-letter`,e,a.label),Q(`span`,`hud-rank-blurb`,e,a.blurb)}F.textContent=n,te.innerHTML=``,i.forEach(e=>{let t=Q(`button`,`hud-overlay-btn${e.primary?` primary`:``}`,te);t.type=`button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick)}),j.classList.remove(`hidden`),document.body.classList.add(`overlay-open`)}function ie(){j.classList.add(`hidden`),document.body.classList.remove(`overlay-open`)}function ae(e){e.maxWarnings!==I&&(I=e.maxWarnings,m.innerHTML=``,h=Array.from({length:e.maxWarnings},()=>{let e=Q(`div`,`hud-warning-pip`,m);return e.textContent=`!`,e}));let t=e.objectives.filter(e=>e.done).length;a.textContent=`${t}/${e.objectives.length}`,e.maxHeat!=null&&(l.innerHTML=Array.from({length:e.maxHeat},(t,n)=>n<e.heat?`<span class="lit">★</span>`:`<span class="off">★</span>`).join(``)),E.textContent=e.score.toLocaleString(`es`);let n=e.combo>1;D.classList.toggle(`on`,n),k.textContent=`x${e.combo.toFixed(1)}`,O.style.width=n?`${Math.round(e.comboLeft/e.comboWindow*100)}%`:`0%`,A.classList.toggle(`visible`,!!e.perk),e.perk&&(A.textContent=`☕ CAFEÍNA ${Math.ceil(e.perkLeft)}s`,A.style.setProperty(`--p`,e.perkLeft/e.perkDuration));let r=Math.round(e.suspicion/e.suspicionMax*100);f.style.width=`${r}%`,f.classList.toggle(`danger`,r>70&&r<=92),f.classList.toggle(`hot`,e.redAlert||r>92),p.classList.toggle(`pulse`,e.redAlert),h.forEach((t,n)=>t.classList.toggle(`lit`,n<e.warnings)),x.textContent=Am(e.timeLeft);let i=Math.round(e.timeLeft/e.levelDuration*100);S.style.width=`${i}%`;let s=e.timeLeft<30;x.classList.toggle(`danger`,s),S.classList.toggle(`danger`,s),o.innerHTML=``,e.objectives.forEach(e=>{let t=Q(`div`,`hud-objective${e.done?` done`:``}`,o),n=Q(`span`,`hud-objective-dot`,t);n.style.background=jm(Md[e.type]??16777215);let r=Q(`span`,`hud-objective-icon`,t);r.textContent=e.done?`✓`:e.icon??`•`;let i=Q(`span`,`hud-objective-label`,t);if(i.textContent=e.label,!e.done&&e.progress>0){let n=Q(`div`,`hud-objective-bar-fill`,Q(`div`,`hud-objective-bar`,t));n.style.width=`${Math.round(e.progress/e.time*100)}%`,n.style.background=jm(Md[e.type]??14709292)}}),e.message?(_.textContent=e.message.text,_.classList.add(`visible`)):_.classList.remove(`visible`);let c=[];e.isHiding&&c.push(`🫥 ESCONDIDA`),e.isPretending&&c.push(`⌨️ FINGIENDO TRABAJAR`),e.bossState===`CHASE`?c.push(`🚨 ¡TE PERSIGUE!`):e.bossState===`SEARCH`?c.push(`🔎 TE ESTÁ BUSCANDO`):e.bossState===`INVESTIGATE`&&c.push(`❓ DISTRAÍDO`),g.textContent=c.join(`   ·   `),g.classList.toggle(`visible`,c.length>0),g.classList.toggle(`alert`,e.bossState===`CHASE`)}return{render:ae,setDay:ne,setVisible:re,showResult:L,hideResult:ie,root:t}}var Nm=new Set([` `,`enter`,`e`]),Pm=new Set([`arrowdown`,`s`,`tab`]),Fm=new Set([`arrowup`,`w`]),Im=`./`,Lm=e=>`${Im}sprites/${e}.png`;function Rm(e){let t=document.createElement(`div`);t.className=`vn-layer hidden`,t.innerHTML=`
  ...
  `,e.appendChild(t);let n=t.querySelector(`.vn-box`),r=t.querySelector(`.vn-portrait`),i=t.querySelector(`.vn-portrait-emoji`),a=t.querySelector(`.vn-portrait-sprite`),o=t.querySelector(`.vn-speaker`),s=t.querySelector(`.vn-speaker-text`),c=t.querySelector(`.vn-text`),l=t.querySelector(`.vn-options`),u=t.querySelector(`.vn-hint`);function d(e){e.sheet?(a.style.backgroundImage=`url(${Lm(e.sheet)})`,a.style.backgroundPosition=`0 0`,a.classList.remove(`hidden`),i.classList.add(`hidden`)):(a.classList.add(`hidden`),i.classList.remove(`hidden`),i.textContent=e.portrait??`🗨️`)}let f=[],p=0;function m(e){f.length&&(p=(e%f.length+f.length)%f.length,f.forEach((e,t)=>e.classList.toggle(`focused`,t===p)))}let h=null,g=null,_=``,v=null,y=!1;function b(e){return new Promise(t=>{_=e,g=t,c.textContent=``;let n=0,r=()=>{if(n+=1,c.textContent=e.slice(0,n),n>=e.length){h=null,g=null,t();return}h=setTimeout(r,18)};h=setTimeout(r,18)})}function x(){if(!h)return!1;clearTimeout(h),h=null,c.textContent=_;let e=g;return g=null,e?.(),!0}function S(){return u.classList.remove(`hidden`),new Promise(e=>{v=e})}function C(){if(y&&!x()&&v){let e=v;v=null,u.classList.add(`hidden`),e()}}let w=e=>{if(!y)return;let t=e.key.toLowerCase();if(f.length){if(Pm.has(t)){e.preventDefault(),m(p+1);return}if(Fm.has(t)){e.preventDefault(),m(p-1);return}if(Nm.has(t)){e.preventDefault(),f[p]?.click();return}let n=Number(t);Number.isInteger(n)&&n>=1&&n<=f.length&&(e.preventDefault(),f[n-1]?.click());return}Nm.has(t)&&(e.preventDefault(),C())};window.addEventListener(`keydown`,w),t.addEventListener(`pointerdown`,e=>{e.target.closest(`.vn-option`)||C()});async function T(e,i){typeof e.effect==`string`&&i.applyEffect?.(e.effect),l.innerHTML=``,l.classList.add(`hidden`),f=[];let a=D(e.speaker,i)??``;s.textContent=a,o.classList.toggle(`hidden`,!a),d(e),r.dataset.mood=e.mood??`neutral`,n.dataset.mood=e.mood??`neutral`,e.color&&t.style.setProperty(`--vn-accent`,e.color),await b(D(e.text,i)),await S()}function E(e,t){return new Promise(async r=>{s.textContent=D(e.speaker,t)??``,o.classList.toggle(`hidden`,!e.speaker),d(e),n.dataset.mood=e.mood??`neutral`,await b(D(e.prompt,t)),u.classList.add(`hidden`),l.innerHTML=``,l.classList.remove(`hidden`),e.options.forEach(e=>{let n=document.createElement(`button`);n.className=`vn-option`,n.type=`button`,n.textContent=e.label,n.addEventListener(`click`,async n=>{n.stopPropagation(),l.innerHTML=``,l.classList.add(`hidden`),f=[],e.flag&&t.setFlag?.(e.flag,!0),typeof e.effect==`function`?e.effect(t):e.effect&&t.applyEffect?.(e.effect),e.reply&&await T({speaker:e.replySpeaker??`Tú`,portrait:`🙂`,sheet:e.replySheet??`employee`,text:e.reply},t),e.then&&await O(e.then,t),r(e)}),l.appendChild(n)}),f=[...l.querySelectorAll(`.vn-option`)],m(0)})}function D(e,t){return typeof e==`function`?e(t):e}async function O(e,t){for(let n of e)n.when&&!n.when(t)||(n.options?await E(n,t):await T(n,t))}async function k(e,n={}){if(!(!e||!e.length)){y=!0,t.classList.remove(`hidden`),document.body.classList.add(`vn-open`);try{await O(e,n)}finally{y=!1,t.classList.add(`hidden`),document.body.classList.remove(`vn-open`),l.innerHTML=``,f=[]}}}return{play:k,get isOpen(){return y},dispose(){window.removeEventListener(`keydown`,w),t.remove()}}}var zm=`modo-incognito:progress:v1`,Bm={dayIndex:0,completedDays:[],eggs:[],flags:{},bestTimes:{},bestScores:{},characterId:null,hadWarningYesterday:!1};function Vm(){try{let e=localStorage.getItem(zm);return e?{...Bm,...JSON.parse(e)}:{...Bm}}catch{return{...Bm}}}function Hm(e){try{localStorage.setItem(zm,JSON.stringify(e))}catch{}}function Um(){let e=Vm();return{get state(){return e},get dayIndex(){return e.dayIndex},setDayIndex(t){e.dayIndex=t,Hm(e)},get characterId(){return e.characterId},setCharacter(t){e.characterId=t,Hm(e)},get hadWarningYesterday(){return!!e.hadWarningYesterday},setHadWarningYesterday(t){e.hadWarningYesterday=!!t,Hm(e)},completeDay(t,{seconds:n,score:r}={}){if(e.completedDays.includes(t)||e.completedDays.push(t),n!=null){let r=e.bestTimes[t];(r==null||n<r)&&(e.bestTimes[t]=n)}if(r!=null){let n=e.bestScores[t];(n==null||r>n)&&(e.bestScores[t]=r)}Hm(e)},recordScore(t,n){let r=e.bestScores[t];(r==null||n>r)&&(e.bestScores[t]=n,Hm(e))},hasCompleted(t){return e.completedDays.includes(t)},findEgg(t){return e.eggs.includes(t)?!1:(e.eggs.push(t),Hm(e),!0)},hasEgg(t){return e.eggs.includes(t)},setFlag(t,n=!0){e.flags[t]=n,Hm(e)},getFlag(t){return e.flags[t]},reset(){e={...Bm,completedDays:[],eggs:[],flags:{},bestTimes:{},bestScores:{}},Hm(e)}}}var Wm={morning:{background:329226,ambient:{color:16777215,intensity:1},hemi:{sky:14674175,ground:5261626,intensity:.85},key:{color:16773846,intensity:1.35},exposure:1.15},overcast:{background:526866,ambient:{color:15330805,intensity:1.05},hemi:{sky:13950186,ground:4868944,intensity:.9},key:{color:15199477,intensity:.95},exposure:1.05},dusk:{background:722707,ambient:{color:16770767,intensity:.85},hemi:{sky:16767408,ground:3814214,intensity:.75},key:{color:16759674,intensity:1.25},exposure:1.2}};function Gm(e,{renderer:t,scene:n,ambient:r,hemi:i,key:a}){let o=Wm[e]??Wm.morning;return n.background=new J(o.background),r.color.set(o.ambient.color),r.intensity=o.ambient.intensity,i.color.set(o.hemi.sky),i.groundColor.set(o.hemi.ground),i.intensity=o.hemi.intensity,a.color.set(o.key.color),a.intensity=o.key.intensity,t.toneMappingExposure=o.exposure,o}function Km(){let e=document.createElement(`div`);e.className=`cam-panel`;let t=new Map,n=document.createElement(`div`);n.className=`cam-grid`,e.appendChild(n);for(let[e,r]of Object.entries(ld)){let i=document.createElement(`label`);i.className=`cam-row`;let a=document.createElement(`div`);a.className=`cam-row-head`;let o=document.createElement(`span`);o.textContent=r.label;let s=document.createElement(`output`);s.className=`cam-value`,a.append(o,s);let c=document.createElement(`input`);c.type=`range`,c.min=r.min,c.max=r.max,c.step=r.step,c.className=`cam-slider`,c.addEventListener(`input`,()=>vd({[e]:Number(c.value)})),i.append(a,c),n.appendChild(i),t.set(e,{input:c,value:s,lim:r})}let r=document.createElement(`p`);r.className=`cam-hint`,r.innerHTML=`Arrastra con el <b>botón derecho</b> (o con <b>dos dedos</b>) sobre el escenario para orbitar. Cuando te guste, copia los parámetros y pégalos en <code>src/scene/config.js</code>.`,e.appendChild(r);let i=document.createElement(`pre`);i.className=`cam-code`,e.appendChild(i);let a=document.createElement(`div`);a.className=`cam-actions`,e.appendChild(a);let o=document.createElement(`button`);o.type=`button`,o.className=`px-btn px-btn-primary`,o.textContent=`Copiar parámetros`,o.addEventListener(`click`,async()=>{let e=xd(),t=!1;try{await navigator.clipboard.writeText(e),t=!0}catch{let e=document.createRange();e.selectNodeContents(i);let t=window.getSelection();t.removeAllRanges(),t.addRange(e)}o.textContent=t?`¡Copiado!`:`Selecciona y copia ↑`,setTimeout(()=>o.textContent=`Copiar parámetros`,1800)}),a.appendChild(o);let s=document.createElement(`button`);return s.type=`button`,s.className=`px-btn`,s.textContent=`Restablecer`,s.addEventListener(`click`,()=>yd()),a.appendChild(s),{root:e,dispose:bd(e=>{for(let[n,{input:r,value:i,lim:a}]of t){document.activeElement!==r&&(r.value=e[n]);let t=a.step<1?2:0;i.textContent=`${e[n].toFixed(t)}${a.unit}`}i.textContent=xd()})}}function $(e,t,n,r){let i=document.createElement(e);return t&&(i.className=t),r!=null&&(i.textContent=r),n&&n.appendChild(i),i}function qm(e,t,{primary:n=!1,icon:r=``,onClick:i}={}){let a=$(`button`,`px-btn${n?` px-btn-primary`:``}`,e);return a.type=`button`,r&&$(`span`,`px-btn-icon`,a,r),$(`span`,null,a,t),a.addEventListener(`click`,()=>{tm(10),i?.()}),a}var Jm=[{min:1,label:`S`,blurb:`Fantasma corporativo`},{min:.8,label:`A`,blurb:`Prácticamente invisible`},{min:.6,label:`B`,blurb:`Sospechosamente eficiente`},{min:.35,label:`C`,blurb:`Te vieron un par de veces`},{min:0,label:`D`,blurb:`Necesitas practicar`}];function Ym(e,t){let n=t>0?e/t:0;return Jm.find(e=>n>=e.min)??Jm[Jm.length-1]}function Xm(e,{levels:t,save:n,actions:r,modes:i={},title:a=`Modo Incógnito`,subtitle:o=``}){let s=$(`div`,`px-menu hidden`,e),c=$(`div`,`px-menu-scrim`,s),l=$(`div`,`px-menu-stage`,s),u=null,d=null,f=null,p={};function m(e,t=``){let n=$(`section`,`px-screen ${t}`,l);return n.dataset.screen=e,p[e]=n,n}let h=m(`title`,`px-screen-title`),g=$(`div`,`px-logo`,h);$(`span`,`px-logo-main`,g,a),$(`span`,`px-logo-sub`,g,o);let _=$(`div`,`px-menu-list`,h),v=qm(_,`Continuar`,{primary:!0,icon:`▶`,onClick:()=>r.play(n.dayIndex)});qm(_,`Nueva semana`,{icon:`✦`,onClick:()=>{n.setDayIndex(0),r.play(0)}}),qm(_,`Elegir día`,{icon:`▦`,onClick:()=>L(`days`)}),qm(_,`Personaje`,{icon:`🕵️`,onClick:()=>{E(),L(`characters`)}}),qm(_,`Ajustes`,{icon:`⚙`,onClick:()=>L(`settings`)}),qm(_,`Cómo se juega`,{icon:`?`,onClick:()=>L(`help`)});let y=$(`div`,`px-title-char`,h),b=$(`div`,`px-title-foot`,h),x=m(`days`);$(`h2`,`px-screen-title-text`,x,`Elige un día`);let S=$(`div`,`px-day-grid`,x);qm($(`div`,`px-screen-foot`,x),`Volver`,{onClick:()=>L(`title`)});function C(){S.innerHTML=``,t.forEach((e,i)=>{let a=i===0||n.hasCompleted(t[i-1].id)||n.dayIndex>=i,o=$(`button`,`px-day${n.hasCompleted(e.id)?` done`:``}${a?``:` locked`}`,S);o.type=`button`,o.disabled=!a,$(`span`,`px-day-num`,o,String(e.number).padStart(2,`0`)),$(`span`,`px-day-name`,o,e.title),$(`span`,`px-day-sub`,o,a?e.subtitle??``:`Bloqueado`);let s=n.state.bestScores?.[e.id];s!=null&&$(`span`,`px-day-best`,o,`${s} pts · ${Ym(s,e.rules?.targetScore??1).label}`),o.addEventListener(`click`,()=>{a&&(tm(10),r.play(i))})})}let w=m(`characters`);$(`h2`,`px-screen-title-text`,w,`Elige tu personaje`);let T=$(`div`,`px-day-grid px-char-grid`,w);qm($(`div`,`px-screen-foot`,w),`Volver`,{onClick:()=>L(d??`title`)});function E(){T.innerHTML=``,Object.entries(i).forEach(([e,t])=>{let i=t.playable===!1,a=n.characterId===e||!n.characterId&&e===`fran`,o=$(`button`,`px-day px-char${i?` locked`:``}${a?` done`:``}`,T);o.type=`button`,o.disabled=i,$(`span`,`px-day-num`,o,t.portrait??`🙂`),$(`span`,`px-day-name`,o,t.alias?`${t.name} · "${t.alias}"`:t.name),$(`span`,`px-day-sub`,o,i?t.lockedReason??`Bloqueado`:t.blurb??``),!i&&t.difficulty&&$(`span`,`px-day-best`,o,`Modo ${t.difficulty}`),o.addEventListener(`click`,()=>{i||(tm(10),r.selectCharacter(e),D(),E(),L(d??`title`))})})}function D(){let e=i[n.characterId]??i.fran;y.textContent=e?`Jugando como ${e.name}${e.alias?` "${e.alias}"`:``}`:``}let O=m(`settings`);$(`h2`,`px-screen-title-text`,O,`Ajustes`);let k=$(`div`,`px-tabs`,O),A=$(`div`,`px-panes`,O),j=$(`div`,`px-pane`,A),ee=$(`div`,`px-pane hidden`,A),M=[{id:`game`,label:`Juego`,pane:j},{id:`camera`,label:`Cámara`,pane:ee}].map(e=>{let t=$(`button`,`px-tab`,k,e.label);return t.type=`button`,t.addEventListener(`click`,()=>N(e.id)),{...e,btn:t}});function N(e){M.forEach(t=>{t.btn.classList.toggle(`active`,t.id===e),t.pane.classList.toggle(`hidden`,t.id!==e)})}let P=new Map;for(let[e,t]of Object.entries(Gp)){let n=$(`label`,`px-opt`,j),r=$(`div`,`px-opt-head`,n);$(`span`,`px-opt-label`,r,t.label);let i=$(`span`,`px-opt-value`,r),a;t.type===`range`?(a=$(`input`,`cam-slider`,n),a.type=`range`,a.min=t.min,a.max=t.max,a.step=t.step,a.addEventListener(`input`,()=>Qp({[e]:Number(a.value)}))):t.type===`choice`?(a=$(`div`,`px-choice`,n),t.options.forEach(t=>{let n=$(`button`,`px-chip`,a,t.toUpperCase());n.type=`button`,n.dataset.value=t,n.addEventListener(`click`,()=>Qp({[e]:t}))})):(a=$(`button`,`px-switch`,n),a.type=`button`,a.addEventListener(`click`,()=>Qp({[e]:!Zp()[e]}))),t.hint&&$(`span`,`px-opt-hint`,n,t.hint),P.set(e,{input:a,readout:i,def:t})}$p(e=>{for(let[t,{input:n,readout:r,def:i}]of P)i.type===`range`?(document.activeElement!==n&&(n.value=e[t]),r.textContent=String(e[t])):i.type===`choice`?(n.querySelectorAll(`.px-chip`).forEach(n=>n.classList.toggle(`on`,n.dataset.value===e[t])),r.textContent=``):(n.classList.toggle(`on`,e[t]),n.textContent=e[t]?`SÍ`:`NO`,r.textContent=``)}),qm($(`div`,`px-screen-foot`,O),`Volver`,{onClick:()=>L(d??`title`)});let F=m(`help`);$(`h2`,`px-screen-title-text`,F,`Cómo se juega`);let te=$(`div`,`px-help`,F);te.innerHTML=`
  ...
  `,qm($(`div`,`px-screen-foot`,F),`Volver`,{onClick:()=>L(d??`title`)});let I=m(`pause`,`px-screen-pause`);$(`h2`,`px-screen-title-text`,I,`Pausa`);let ne=$(`p`,`px-pause-info`,I),re=$(`div`,`px-menu-list`,I);qm(re,`Continuar`,{primary:!0,icon:`▶`,onClick:()=>r.resume()}),qm(re,`Reiniciar día`,{icon:`↺`,onClick:()=>r.restart()}),qm(re,`Ajustes`,{icon:`⚙`,onClick:()=>L(`settings`)}),qm(re,`Menú principal`,{icon:`⌂`,onClick:()=>r.toTitle()});function L(e){e===`settings`&&!f&&(f=Km(),ee.appendChild(f.root),N(`game`)),u&&u!==e&&(d=u),u=e,Object.entries(p).forEach(([t,n])=>n.classList.toggle(`hidden`,t!==e)),s.classList.remove(`hidden`),document.body.classList.add(`menu-open`),s.dataset.screen=e,R()}function ie(){s.classList.add(`hidden`),document.body.classList.remove(`menu-open`),u=null}c.addEventListener(`click`,()=>{u===`pause`&&r.resume()});function ae(){let e=p[u];return e?[...e.querySelectorAll(`button:not(:disabled), .px-chip, input[type='range']`)].filter(e=>e.offsetParent!==null):[]}function R(){let[e]=ae();e?.focus()}function oe(e){let t=ae();if(!t.length)return;let n=t.indexOf(document.activeElement);t[(((n<0?0:n)+e)%t.length+t.length)%t.length].focus()}return window.addEventListener(`keydown`,e=>{if(s.classList.contains(`hidden`))return;let t=e.key.toLowerCase(),n=document.activeElement?.tagName===`INPUT`;if(!n&&(t===`arrowdown`||t===`s`||t===`arrowright`||t===`d`)){e.preventDefault(),oe(1);return}if(!n&&(t===`arrowup`||t===`w`||t===`arrowleft`||t===`a`)){e.preventDefault(),oe(-1);return}t===`e`&&document.activeElement&&document.activeElement!==document.body&&(e.preventDefault(),document.activeElement.click())}),{show:L,close:ie,openTitle(e){C(),D(),v.classList.toggle(`hidden`,!e.hasProgress),b.textContent=e.summary,L(`title`)},openPause(e){ne.textContent=e??``,L(`pause`)},openDays(){C(),L(`days`)},get isOpen(){return!s.classList.contains(`hidden`)},get screen(){return u}}}var Zm=46;function Qm(e,t,{id:n,side:r=`right`,accent:i=`cyan`}){let a=document.createElement(`div`);a.className=`track-layer track-${r} track-${i}`,a.dataset.tracker=n,a.innerHTML=`
  ...
  `,e.appendChild(a);let o=a.querySelector(`.track-card`),s=a.querySelector(`.track-top`),c=a.querySelector(`.track-icon`),l=a.querySelector(`.track-label`),u=a.querySelector(`.track-meta`),d=a.querySelector(`.track-bar i`),f=a.querySelector(`.track-marker`),p=a.querySelector(`.track-arrow`),m=a.querySelector(`.track-dist`),h=new K;function g(e){if(!e){a.classList.remove(`visible`);return}a.classList.add(`visible`),s.textContent=e.top??``,c.textContent=e.icon??`•`,l.textContent=e.label??``,u.textContent=e.meta??``;let n=Tt.clamp(e.urgency??0,0,1);d.style.width=`${Math.round(n*100)}%`,o.classList.toggle(`hot`,n>.62),o.classList.toggle(`warm`,n>.32&&n<=.62);let r=a.clientWidth,i=a.clientHeight;h.set(e.x,(e.y??1.2)*Z,e.z).project(t);let g=h.z<1&&Math.abs(h.x)<.94&&Math.abs(h.y)<.9,_=(h.x+1)/2*r,v=(1-h.y)/2*i,y=0;if(!g){let e=h.x,t=h.y;h.z>=1&&(e=-e,t=-t);let n=Math.hypot(e,t)||1,a=e/n,o=t/n,s=r/2-Zm,c=i/2-Zm,l=Math.min(s/Math.abs(a||.001),c/Math.abs(o||.001));_=r/2+a*l,v=i/2-o*l,y=180/Math.PI*Math.atan2(a,o)}f.classList.toggle(`edge`,!g),f.style.transform=`translate(-50%, -50%) translate(${_}px, ${v}px)`,p.style.transform=`rotate(${y}deg)`,m.textContent=g?``:e.short??``}return{update:g,root:a}}var $m={sur:`ALA SUR`,norte:`ALA NORTE`,centro:`CENTRO`},eh={PATROL:{label:`De ronda`,tone:0},INVESTIGATE:{label:`Distraído`,tone:.2},SEARCH:{label:`Te está buscando`,tone:.75},CHASE:{label:`¡Te persigue!`,tone:1}};function th(e,t){let n=Qm(e,t,{id:`task`,side:`right`,accent:`cyan`}),r=Qm(e,t,{id:`boss`,side:`left`,accent:`red`});function i(e){if(!e||e.gameOver){n.update(null),r.update(null);return}let t=e.playerPos.x,i=e.playerPos.z,a=e.focusStation;if(a){let r=Math.hypot(a.x-t,a.z-i)/Z,o=e.area,s=Math.hypot(e.bossPos.x-a.x,e.bossPos.z-a.z)/Z;n.update({x:a.x,z:a.z,icon:a.icon??`•`,top:o?`${$m[o.wing]??`PISO 7`} · ${o.name}`:`PISO 7`,label:a.label,meta:e.nearStation&&e.nearStation.id===a.id?`EN CURSO`:`${Math.round(r)} m`,short:`${Math.round(r)} m`,urgency:Math.max(0,1-s/16)})}else n.update(null);let o=e.bossDistance/Z,s=eh[e.bossState]??eh.PATROL,c=Math.max(0,1-o/22);r.update({x:e.bossPos.x,z:e.bossPos.z,y:2.2,icon:e.bossState===`CHASE`?`🚨`:`🕴️`,top:`JEFE · NIVEL ${e.heat}`,label:s.label,meta:`${Math.round(o)} m`,short:`${Math.round(o)} m`,urgency:Math.max(c,s.tone)})}return{update:i}}function nh(e,t,{isTouch:n=!1}={}){let r=document.createElement(`div`);r.className=`wprompt`,r.innerHTML=`
  ...
  `,e.appendChild(r);let i=r.querySelector(`.wprompt-card`),a=r.querySelector(`.wprompt-key`),o=r.querySelector(`.wprompt-label`),s=r.querySelector(`.wprompt-hint`),c=r.querySelector(`.wprompt-fill`),l=new K,u=n?`USAR`:`E`;function d(){r.classList.remove(`visible`)}function f(e){if(!e||e.gameOver)return d();let f=null;if(e.nearStation?f={x:e.nearStation.x,z:e.nearStation.z,icon:e.nearStation.icon??`•`,label:e.nearStation.label,hint:n?`MANTÉN USAR`:`MANTÉN E`,progress:e.nearStation.progress/e.nearStation.time,kind:`task`}:e.nearNpc?f={x:e.nearNpc.position.x,z:e.nearNpc.position.z,icon:`💬`,label:`Hablar con ${e.nearNpc.displayName}`,hint:`PULSA ${u}`,progress:0,kind:`talk`}:e.nearDistraction&&(f={x:e.nearDistraction.x,z:e.nearDistraction.z,icon:`⭐`,label:e.nearDistraction.label,hint:`PULSA ${u}`,progress:0,kind:`distract`}),!f||(l.set(f.x,1.9*Z,f.z).project(t),l.z>=1))return d();let p=r.parentElement.clientWidth,m=r.parentElement.clientHeight;r.style.transform=`translate(-50%, -100%) translate(${(l.x+1)/2*p}px, ${(1-l.y)/2*m}px)`,a.textContent=f.icon,o.textContent=f.label,s.textContent=f.hint,c.style.width=`${Math.round(Tt.clamp(f.progress,0,1)*100)}%`,i.dataset.kind=f.kind,r.classList.add(`visible`)}return{update:f,hide:d}}function rh({app:e,lights:t,renderer:n,scene:r,player:i,boss:a,npcs:o,camera:s,levels:c,codeEggs:l=[],manifest:u={},dialogues:d={cast:{},encounters:{},barks:{}},modes:f={},playerSheet:p=`employee`,playerName:m=`Tú`,minions:h=new Map,onPopup:g=null}){let _=Mm(e),v=th(e,s.camera),y=nh(e,s.camera,{isTouch:matchMedia(`(pointer: coarse)`).matches}),b=Rm(e),x=Um(),S=[...Jd.map(e=>e.id),...l.map(e=>e.id)],C=new Map(Object.values(d.cast).filter(e=>e.name&&e.sheet).map(e=>[e.name,e.sheet]));C.set(m,p),C.set(`Tú`,p);function w(e){return e&&e.map(e=>{let t=e.sheet??(typeof e.speaker==`string`?C.get(e.speaker):void 0),n=e.options?e.options.map(e=>e.then?{...e,then:w(e.then)}:e):void 0;return{...e,...t?{sheet:t}:{},...n?{options:n}:{}}})}let T=Math.min(x.dayIndex,c.length-1),E=null,D=1,O=!1,k=!1,A={setFlag:(e,t)=>x.setFlag(e,t),getFlag:e=>x.getFlag(e),applyEffect:e=>{if(j[e]){ee=e;return}E?.applyEffect(e)}},j={wait:{timeDelta:-25,toast:`Llegaste con la fila. Menos jornada por delante.`},stairs:{timeDelta:0,tired:!0,toast:`Siete pisos. Llegas entera pero lenta.`},cut:{timeDelta:15,risky:!0,toast:`Te colaste. A ver si nadie lo comenta.`}},ee=null,M={slowBoss:()=>{D=.78,te()}};function N(e,t){a.distract(t,6),E?._toast(`${e.name} te delató`)}h.forEach(e=>{e.onSpot=N});function P(){return f[x.characterId]??f.fran??null}function F(e){let t=P()?.rules??{},n={...e.rules};return t.maxWarnings!=null&&(n.maxWarnings=t.maxWarnings),t.explore&&(n.explore=!0),t.pretendAlways&&(n.pretendAlways=!0),n.minionSuspicionMul=(e.rules?.minionSuspicionMul??1)*(t.minionSuspicionMul??1),n}function te(){let e=c[T].rules??{},t=P()?.rules??{},n=(e.bossSpeedMul??1)*(t.bossSpeedMul??1)*D;a.speed=a.baseSpeeds.patrol*n,a.investigateSpeed=a.baseSpeeds.investigate*n,a.chaseSpeed=a.baseSpeeds.chase*n,a.searchSpeed=a.baseSpeeds.search*n;let r=(e.visionMul??1)*(t.visionMul??1);a.visionRange=a.baseVisionRange*r,a.dayTuning={vision:a.baseVisionRange*r,speedMul:n};let i=e.objectives,o=Ud.filter(e=>!i||i.includes(e.id)).map(e=>({x:e.x,z:e.z}));a.setPointsOfInterest(o)}let I=Xm(e,{levels:c,save:x,modes:f,title:u.title??`Modo Incógnito`,subtitle:u.subtitle??``,actions:{play:e=>ce(e),resume:()=>L(),restart:()=>ce(T),toTitle:()=>ne(),selectCharacter:e=>x.setCharacter(e)}});function ne(){k=!1,O=!1,E?.setPaused(!0),_.setVisible(!1),_.hideResult();let e=x.state.completedDays.length;I.openTitle({hasProgress:e>0||x.dayIndex>0,summary:`${e}/${c.length} días superados · ${x.state.eggs.length}/${S.length} secretos`})}function re(){!k||b.isOpen||E?.gameOver||(O=!0,E?.setPaused(!0),I.openPause(`Día ${c[T].number} · ${c[T].title}`))}function L(){I.close(),k&&(O=!1,_.setVisible(!0),!b.isOpen&&!E?.gameOver&&E?.setPaused(!1))}let ie=[],ae=e=>{let t=e.key.toLowerCase();if(t===`escape`){e.preventDefault(),I.isOpen&&I.screen===`pause`?L():I.isOpen||re();return}if(!I.isOpen){ie.push(t),ie.length>12&&ie.shift();for(let e of l)x.hasEgg(e.id)||ie.slice(-e.keys.length).join(`,`)===e.keys.join(`,`)&&(ie.length=0,R(e))}};window.addEventListener(`keydown`,ae);async function R(e){x.findEgg(e.id)&&(e.perk&&M[e.perk]?.(),await oe(()=>b.play(w([...e.scene??[],{speaker:`Secreto encontrado`,portrait:`🥚`,text:`Llevas ${x.state.eggs.length} de ${S.length}. +250 puntos.`}]),A)))}async function oe(e){E?.setPaused(!0);try{await e()}finally{!O&&!E?.gameOver&&E?.setPaused(!1)}}function se(){i.position.x=Ld.x,i.position.z=Ld.z,i.keys.clear(),i.touchAxis.x=0,i.touchAxis.z=0,i.speedMul=1,i.isHiding=!1,i.isPretending=!1,i.isDoingActivity=!1;let e=0,t=-1/0;Vd.forEach((n,r)=>{let i=Math.hypot(n.x-Ld.x,n.z-Ld.z);i>t&&(t=i,e=r)}),a.position.x=Vd[e].x,a.position.z=Vd[e].z,a.routeIndex=e,a.resetToPatrol()}async function ce(e){T=Math.min(Math.max(e,0),c.length-1),x.setDayIndex(T);let l=c[T];if(I.close(),O=!1,k=!0,D=1,Gm(l.theme,{renderer:n,scene:r,...t}),_.setDay(l),_.setVisible(!0),_.hideResult(),se(),te(),E=new km({player:i,boss:a,npcs:o,minions:ue(l),hud:_,rules:F(l),onFinish:e=>fe(l,e),onEgg:e=>R(e),onPopup:g,onTalk:e=>de(e)}),E.setPaused(!0),s.setFraming(s.camera.aspect>=1.15?.35:.8),ee=null,l.prologue){let e=[...l.prologue.intro??[]];x.hadWarningYesterday&&e.unshift({speaker:`Recepción`,portrait:`🛎️`,text:`El ascensor viene lleno otra vez. Después de lo de ayer, ya ni te guardan hueco.`}),l.prologue.choice&&e.push(l.prologue.choice),await b.play(w(e),A),le(l)}await b.play(w(l.intro??[]),A),O||E.setPaused(!1)}function le(e){let t=j[ee];!E||!t||(E.timeLeft=Math.max(60,E.timeLeft+t.timeDelta),t.tired&&(i.speedMul=.85,setTimeout(()=>{i.speedMul===.85&&(i.speedMul=1)},3e4)),t.risky&&Math.random()<.35?(E.warnings=1,E._toast(`Te vieron colarte: advertencia 1`)):E._toast(t.toast))}function ue(e){let t=[],n=e.rules?.objectives,r=Ud.filter(e=>!n||n.includes(e.id)).map(e=>({x:e.x,z:e.z}));return h.forEach(e=>e.setActive(!1)),(e.minions??[]).forEach(e=>{let n=h.get(e.id);if(!n)return;let i=Hd[e.route]??Hd.jefe??Vd;n.setRoute(i),n.setPointsOfInterest(r),n.setActive(!0),t.push(n)}),t}async function de(e){let t=d.encounters[e.cast];if(!t?.scenes?.length)return;let n=x.getFlag(`talk:${e.cast}`)??0;x.setFlag(`talk:${e.cast}`,n+1);let r=t.scenes[n%t.scenes.length],i=d.cast[e.cast];await oe(()=>b.play(w(r.map(e=>({color:i?.color,sheet:i?.sheet,...e}))),A))}async function fe(e,t){k=!1,x.setHadWarningYesterday(t.warnings>0);let n=t.targetScore??1e3,r=Ym(t.score,n);t.win?x.completeDay(e.id,{seconds:Math.round(t.elapsed),score:t.score}):x.recordScore(e.id,t.score),await b.play(w((t.win?e.outroWin:e.outroLose)??[]),A);let i=T>=c.length-1,a=t.objectives.filter(e=>e.done).length,o=[];t.win&&!i&&o.push({label:`Día ${c[T+1].number} →`,primary:!0,onClick:()=>ce(T+1)}),o.push({label:t.win?`Repetir`:`Reintentar`,primary:!t.win,onClick:()=>ce(T)}),o.push({label:`Menú`,onClick:()=>ne()}),_.showResult({icon:t.win?i?`🏆`:`🎉`:`🚪`,title:t.win?i?`Semana completada`:`${e.title}: superado`:`Despedida`,rank:t.win?r:null,score:t.score,target:n,body:t.win?`${a}/${t.objectives.length} actividades · ${t.eggsFound} secretos hoy · objetivo ${n} pts`:t.warnings>=(e.rules?.maxWarnings??3)?`Te quedaste sin advertencias.`:`Se acabó la jornada con objetivos pendientes.`,win:t.win,actions:o})}function pe(e){E?.update(e);let t=E&&!I.isOpen?E.lastSnapshot:null;v.update(t),y.update(b.isOpen?null:t)}return{hud:_,dialogue:b,menus:I,guides:v,save:x,start:()=>ne(),startDay:ce,openPause:re,update:pe,get game(){return E},get isPaused(){return I.isOpen||!!E?.paused},get inLevel(){return k},dispose(){window.removeEventListener(`keydown`,ae),b.dispose()}}}function ih(e,t,{onZoom:n,onInspect:r,onPause:i}={}){let a=`ontouchstart`in window||navigator.maxTouchPoints>0||matchMedia(`(pointer: coarse)`).matches;document.body.classList.toggle(`touch-device`,a);let o=document.createElement(`div`);o.className=`touch-controls`,t.appendChild(o);let s=document.createElement(`div`);s.className=`touch-stick-zone`;let c=document.createElement(`div`);c.className=`touch-stick-base`;let l=document.createElement(`div`);l.className=`touch-stick-thumb`,c.appendChild(l),s.appendChild(c),o.appendChild(s);let u=null,d={x:0,y:0};function f(t,n){e.touchAxis.x=t,e.touchAxis.z=n}function p(e){let t=e.clientX-d.x,n=e.clientY-d.y,r=Math.hypot(t,n);r>56&&(t=t/r*56,n=n/r*56),l.style.transform=`translate(${t}px, ${n}px)`,f(t/56,n/56)}function m(e){e.pointerId===u&&(u=null,c.classList.remove(`active`),l.style.transform=`translate(0, 0)`,f(0,0))}s.addEventListener(`pointerdown`,e=>{u=e.pointerId,d={x:e.clientX,y:e.clientY};let t=s.getBoundingClientRect();c.style.left=`${e.clientX-t.left}px`,c.style.top=`${e.clientY-t.top}px`,c.classList.add(`active`),s.setPointerCapture(e.pointerId),p(e)}),s.addEventListener(`pointermove`,e=>{e.pointerId===u&&p(e)}),s.addEventListener(`pointerup`,m),s.addEventListener(`pointercancel`,m);let h=document.createElement(`div`);h.className=`touch-actions`,o.appendChild(h);function g(t,n,r,i){let a=document.createElement(`div`);a.className=`touch-btn ${t}`,a.innerHTML=`<span class="touch-btn-icon">${n}</span><span>${r}</span>`;let o=t=>{t.preventDefault(),e.keys.add(i),a.classList.add(`active`),tm(8)},s=()=>{e.keys.delete(i),a.classList.remove(`active`)};return a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointercancel`,s),a.addEventListener(`pointerleave`,s),h.appendChild(a),a}g(`touch-btn-pretend`,`⌨️`,`FINGIR`,`f`),g(`touch-btn-interact`,`✋`,`USAR`,`e`);let _=document.createElement(`div`);_.className=`touch-utils`,o.appendChild(_);function v(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`touch-util`,r.textContent=e,r.title=t,r.setAttribute(`aria-label`,t),r.addEventListener(`click`,e=>{e.preventDefault(),tm(8),n()}),_.appendChild(r),r}return n&&(v(`＋`,`Acercar`,()=>n(.18)),v(`－`,`Alejar`,()=>n(-.18))),r&&v(`🗺️`,`Inspeccionar plano`,r),i&&v(`⏸`,`Pausa`,i),{isTouch:a}}var ah=1.5;function oh(e,t){let n=document.createElement(`div`);n.className=`px-popups`,e.appendChild(n);let r=[],i=new K;function a({text:e,sub:t=``,x:i,z:a,kind:o=`score`}){let s=document.createElement(`div`);s.className=`px-pop px-pop-${o}`,s.innerHTML=`<span class="px-pop-main">${e}</span>${t?`<span class="px-pop-sub">${t}</span>`:``}`,n.appendChild(s),r.push({node:s,x:i,y:1.6*Z,z:a,life:ah})}function o(e){if(!r.length)return;let a=n.clientWidth,o=n.clientHeight;for(let n=r.length-1;n>=0;n--){let s=r[n];if(s.life-=e,s.life<=0){s.node.remove(),r.splice(n,1);continue}let c=1-s.life/ah;i.set(s.x,s.y+c*1.4*Z,s.z).project(t);let l=i.z<1;s.node.style.display=l?`block`:`none`,l&&(s.node.style.transform=`translate(-50%, -50%) translate(${(i.x+1)/2*a}px, ${(1-i.y)/2*o}px)`,s.node.style.opacity=String(Math.min(1,s.life/.4)))}}function s(){r.forEach(e=>e.node.remove()),r.length=0}return{spawn:a,update:o,clear:s}}var sh=`./`,ch=e=>`${sh}sprites/${e}.png`,lh=document.getElementById(`scene`),uh=document.getElementById(`app`),dh=document.getElementById(`boot`),fh=new od({canvas:lh,antialias:!1,powerPreference:`high-performance`}),ph=em();fh.setPixelRatio(Math.min(window.devicePixelRatio,ph.maxPixelRatio)),fh.shadowMap.enabled=ph.shadows,fh.shadowMap.type=2,fh.toneMapping=4,fh.toneMappingExposure=1.15,fh.outputColorSpace=Ie,fh.setSize(window.innerWidth,window.innerHeight);var mh=new Mn;mh.background=new J(329226);var hh=new Es(16777215,1);mh.add(hh);var gh=new us(14674175,5261626,.85);mh.add(gh);var _h=new Ts(16773846,1.35);_h.position.set(26*Z,40*Z,20*Z),_h.castShadow=!0,_h.shadow.mapSize.set(ph.shadowMap,ph.shadowMap);var vh=44*Z;_h.shadow.camera.left=-vh,_h.shadow.camera.right=vh,_h.shadow.camera.top=vh,_h.shadow.camera.bottom=-vh,_h.shadow.camera.far=220*Z,_h.shadow.bias=-.0018,mh.add(_h);async function yh(){let e=await Tp(),t=e.levels[0];Yd(e.scenes.get(t.scene));let n=dp(),{roomLabels:r,markerGroup:i,hidingMarkers:a,safeSpotMarkers:o}=Bf(mh,n),s=mp(n,{radius:.3*Z}),c=e=>e.forEach(e=>{let t=s.snap(e.x,e.z);e.x=t.x,e.z=t.z});c(Vd),Object.values(Hd).forEach(c),c(Ud),c(Kd),c(Wd),c(Gd);let l=new ef(window.innerWidth/window.innerHeight),u=l.camera,d=new _p(fh,{pixelSize:Zp().pixelSize,levels:Zp().colorLevels});d.setSize(window.innerWidth,window.innerHeight);let f=e.characters,p=new Set([f.player.sheet,f.boss.sheet,...Object.values(f.minions??{}).map(e=>e.sheet),...qd.map(e=>e.sheet)]),m=new Map;await Promise.all([...p].map(async e=>m.set(e,await jp(ch(e)))));let h=new Np(m.get(f.player.sheet),{x:Ld.x,z:Ld.z,radius:f.player.radius,height:f.player.height,speed:f.player.speed});mh.add(h.object3D);let g=qd.map(t=>{let n=f.npcs[t.sheet]??{},r=e.dialogues.cast[t.cast],i=new Pp(m.get(r?.sheet??t.sheet)??m.values().next().value,{...t,radius:n.radius,height:n.height});return i.cast=t.cast??null,i.displayName=r?.name??n.name??`Compañero`,i.talkCooldown=e.dialogues.encounters[t.cast]?.cooldown??40,i});g.forEach(e=>mh.add(e.object3D));let _=new Hp(m.get(f.boss.sheet),{world:n,route:Vd,navmesh:s,radius:f.boss.radius,height:f.boss.height,speeds:f.boss.speeds,visionRange:f.boss.visionRange,visionHalfAngleDeg:f.boss.visionHalfAngleDeg});mh.add(_.object3D),mh.add(_.cone);let v={chispita:15910724,washo:4579536,crispo:12616791},y=new Map;for(let[t,r]of Object.entries(f.minions??{})){let i=new Hp(m.get(r.sheet),{world:n,route:Hd[t]??Vd,navmesh:s,role:`minion`,name:r.name??t,coneColor:v[t]??10466505,radius:r.radius,height:r.height,speeds:r.speeds,visionRange:r.visionRange,visionHalfAngleDeg:r.visionHalfAngleDeg});i.cast=t,i.id=t,i.displayName=r.name??t,i.talkCooldown=e.dialogues.encounters[t]?.cooldown??35,i.setActive(!1),mh.add(i.object3D),mh.add(i.cone),y.set(t,i)}let b=oh(uh,u),x=rh({app:uh,renderer:fh,scene:mh,lights:{ambient:hh,hemi:gh,key:_h},player:h,boss:_,npcs:g,camera:l,levels:e.levels,codeEggs:e.codeEggs,manifest:e.manifest,dialogues:e.dialogues,modes:e.modes,playerSheet:f.player.sheet,playerName:f.player.name??`Tú`,minions:y,onPopup:e=>b.spawn(e)}),S=!1;function C(){S=!S,document.body.classList.toggle(`inspect-mode`,S)}ih(h,uh,{onZoom:e=>l.zoomBy(e),onInspect:C,onPause:()=>x.openPause()}),window.addEventListener(`wheel`,e=>{x.dialogue.isOpen||x.menus.isOpen||l.zoomBy(-e.deltaY*.0012)},{passive:!0});let w=null,T={x:0,y:0};lh.addEventListener(`contextmenu`,e=>e.preventDefault()),lh.addEventListener(`pointerdown`,e=>{e.button!==2||x.menus.isOpen||(w=e.pointerId,T={x:e.clientX,y:e.clientY},lh.setPointerCapture(e.pointerId))}),lh.addEventListener(`pointermove`,e=>{e.pointerId===w&&(l.orbitBy((e.clientX-T.x)*.25,-(e.clientY-T.y)*.2),T={x:e.clientX,y:e.clientY})});let E=e=>{e.pointerId===w&&(w=null)};lh.addEventListener(`pointerup`,E),lh.addEventListener(`pointercancel`,E);let D=null,O=0,k=null,A=e=>Math.hypot(e[0].clientX-e[1].clientX,e[0].clientY-e[1].clientY),j=e=>({x:(e[0].clientX+e[1].clientX)/2,y:(e[0].clientY+e[1].clientY)/2});lh.addEventListener(`touchstart`,e=>{e.touches.length===2&&(D=A(e.touches),O=l.framing,k=j(e.touches))},{passive:!0}),lh.addEventListener(`touchmove`,e=>{if(e.touches.length!==2||!D)return;let t=A(e.touches),n=j(e.touches),r=Math.abs(t/D-1),i=Math.hypot(n.x-k.x,n.y-k.y);r*400>i?l.setFraming(O+(t/D-1)*.9):l.orbitBy((n.x-k.x)*.3,-(n.y-k.y)*.25),k=n},{passive:!0}),lh.addEventListener(`touchend`,e=>{e.touches.length<2&&(D=null)},{passive:!0});function ee(){let e=window.innerWidth,t=window.innerHeight;fh.setSize(e,t),d.setSize(e,t),l.setAspect(e/t)}window.addEventListener(`resize`,ee),window.addEventListener(`keydown`,e=>{e.key.toLowerCase()===`m`&&!x.dialogue.isOpen&&!x.menus.isOpen&&C()});let M=0;document.addEventListener(`touchend`,e=>{let t=Date.now();t-M<320&&e.preventDefault(),M=t},{passive:!1}),[`gesturestart`,`gesturechange`,`gestureend`].forEach(e=>document.addEventListener(e,e=>e.preventDefault(),{passive:!1})),document.addEventListener(`dblclick`,e=>e.preventDefault(),{passive:!1}),$p(e=>{d.setPixelSize(e.pixelSize),d.setLevels(e.colorLevels),i&&(i.visible=e.showMarkers);let t=em(e.quality);fh.setPixelRatio(Math.min(window.devicePixelRatio,t.maxPixelRatio)),fh.shadowMap.enabled=t.shadows,_h.shadow.mapSize.x!==t.shadowMap&&(_h.shadow.mapSize.set(t.shadowMap,t.shadowMap),_h.shadow.map?.dispose(),_h.shadow.map=null),mh.traverse(e=>{(e.isMesh||e.isInstancedMesh)&&(e.castShadow=e.castShadow&&t.shadows)}),fh.setSize(window.innerWidth,window.innerHeight),d.setSize(window.innerWidth,window.innerHeight)});let N=0,P=!1;function F(e){P||Zp().quality!==`auto`||(N=e>.033?N+1:Math.max(0,N-1),N>180&&(P=!0,Qp({quality:`bajo`,pixelSize:Math.max(2,Zp().pixelSize)}),console.info(`Calidad reducida automáticamente para mantener la fluidez.`)))}let te=7*Z,I=13*Z,ne=46*Z,re=new K;function L(){let e=!l.isFollowing,t=Zp().showLabels;r.forEach(n=>{let r=n.userData.priority??2,i;if(S)i=1;else if(r===1)i=1;else if(r>=3)i=0;else if(!t)i=0;else if(e)i=1;else{let e=Math.hypot(n.userData.homeX-h.position.x,n.userData.homeZ-h.position.z);i=Tt.clamp((I-e)/(I-te),0,1)}n.material.opacity=i,n.visible=i>.02;let a=n.userData.baseScale;if(a&&n.visible){n.getWorldPosition(re);let e=Tt.clamp(u.position.distanceTo(re)/ne,.35,1.6);n.scale.set(a.x*e,a.y*e,1)}})}let ie=new J(5025642),ae=new J(5594990);function R(){let e=x.game;!e||!a||a.forEach((t,n)=>{let r=e.hidingCharge(n);t.material.color.copy(ae).lerp(ie,r),t.material.opacity=.28+r*.62,t.scale.setScalar(.82+r*.18)})}let oe=new J(4890080),se=new J(5594990);function ce(){let e=x.game;!e||!o||o.forEach((t,n)=>{let r=e.safeSpotCharge(n);t.material.color.copy(se).lerp(oe,r),t.material.opacity=.22+r*.63,t.scale.setScalar(.82+r*.18)})}let le=[];mh.traverse(e=>{e.userData&&e.userData.bob&&le.push(e)}),dh?.remove(),x.start();let ue=performance.now();function de(e){let t=Math.min((e-ue)/1e3,.05);ue=e;let r=e/1e3;x.isPaused||(h.update(t,n),g.forEach(e=>e.update(t,r))),x.update(t),le.forEach(e=>{let t=e.userData.bob;e.position.y=t.base+Math.sin(r*t.speed+t.offset)*t.amp,e.rotation.y=r*.6+t.offset}),F(t),R(),ce(),L(),l.update(t,h.position),b.update(t),d.render(mh,u),requestAnimationFrame(de)}requestAnimationFrame(de),window.__game={world:n,navmesh:s,player:h,boss:_,engine:x,camera:u,scene:mh,view:l,pixels:d,data:e},window.__floorplan=Ad}yh().catch(e=>{console.error(e);let t=document.createElement(`div`);t.className=`boot-error`,t.innerHTML=`<b>No se pudo iniciar el juego</b><br>${e.message??e}`,(dh??uh).replaceChildren(t)});