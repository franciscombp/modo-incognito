...
`,gp=class{constructor(e,{pixelSize:t=2,levels:n=24,saturation:r=1.12}={}){this.renderer=e,this.pixelSize=t,this.enabled=t>1,this.target=new Kt(1,1,{minFilter:a,magFilter:a,depthBuffer:!0,stencilBuffer:!1,colorSpace:Le}),this.material=new Lo({uniforms:{tDiffuse:{value:this.target.texture},uResolution:{value:new W(1,1)},uLevels:{value:n},uSaturation:{value:r}},vertexShader:mp,fragmentShader:hp,depthTest:!1,depthWrite:!1}),this.quadScene=new Mn,this.quadCamera=new Cs(-1,1,1,-1,0,1),this.quadScene.add(new mi(new Eo(2,2),this.material)),this.size=new W(1,1)}setSize(e,t){this.size.set(e,t),this._resizeTarget()}setPixelSize(e){this.pixelSize=Math.max(1,Math.round(e)),this.enabled=this.pixelSize>1,this._resizeTarget()}setLevels(e){this.material.uniforms.uLevels.value=e}_resizeTarget(){let e=Math.max(1,Math.floor(this.size.x/this.pixelSize)),t=Math.max(1,Math.floor(this.size.y/this.pixelSize));this.target.setSize(e,t),this.material.uniforms.uResolution.value.set(e,t)}render(e,t){if(!this.enabled){this.renderer.setRenderTarget(null),this.renderer.render(e,t);return}this.renderer.setRenderTarget(this.target),this.renderer.clear(),this.renderer.render(e,t),this.renderer.setRenderTarget(null),this.renderer.render(this.quadScene,this.quadCamera)}dispose(){this.target.dispose(),this.material.dispose()}},_p=`./`;async function vp(e){let t=await fetch(`${_p}data/${e}`,{cache:`no-cache`});if(!t.ok)throw Error(`No se pudo cargar data/${e} (${t.status})`);try{return await t.json()}catch(t){throw Error(`data/${e} no es JSON válido: ${t.message}`)}}var yp=e=>({...e,x:e.x*Z,z:e.z*Z}),bp=e=>({...e,x:e.x*Z,z:e.z*Z,w:e.w*Z,d:e.d*Z});function xp(e,t,n){if(e[t]==null)throw Error(`${n}: falta el campo "${t}"`);return e[t]}function Sp(e){let t=`escena "${e.id??`?`}"`,n=xp(e,`areas`,t).map(e=>(e.capacity??=0,bp(e)));return{id:e.id,name:e.name,areas:n,areaById:new Map(n.map(e=>[e.id,e])),footprint:xp(e,`footprint`,t).map(([e,t])=>[e*Z,t*Z]),spawn:yp(xp(e,`spawn`,t)),entrance:{...e.entrance,x:e.entrance.x*Z,z:e.entrance.z*Z,w:e.entrance.w*Z},corridors:(e.corridors??[]).map(bp),plants:(e.props??[]).filter(e=>e.type===`plant`).map(yp),props:(e.props??[]).map(yp),patrolRoute:(e.routes?.jefe??xp(e,`patrol`,t)).map(yp),routes:Object.fromEntries(Object.entries(e.routes??{jefe:e.patrol??[]}).map(([e,t])=>[e,t.map(yp)])),activityStations:(e.activities??[]).map(yp),hidingSpots:(e.hidingSpots??[]).map(e=>({...yp(e),r:(e.r??1.3)*Z})),distractions:(e.distractions??[]).map(e=>({...yp(e),radius:(e.radius??1.2)*Z})),npcs:(e.npcs??[]).map(yp),locationEggs:(e.eggs??[]).map(e=>({...yp(e),radius:(e.radius??2)*Z}))}}function Cp(e){let t=e=>({...e,height:(e.height??1.45)*Z,radius:(e.radius??.28)*Z,speed:e.speed==null?void 0:e.speed*Z,visionRange:e.visionRange==null?void 0:e.visionRange*Z,speeds:e.speeds?Object.fromEntries(Object.entries(e.speeds).map(([e,t])=>[e,t*Z])):void 0});return{player:t(e.player),boss:t(e.boss),minions:Object.fromEntries(Object.entries(e.minions??{}).map(([e,n])=>[e,t(n)])),npcs:Object.fromEntries(Object.entries(e.npcs??{}).map(([e,n])=>[e,t(n)]))}}async function wp(){let e=await vp(`manifest.json`),[t,n,r,i]=await Promise.all([vp(e.characters??`characters.json`),vp(e.dialogues??`dialogues.json`).catch(()=>({cast:{},encounters:{},barks:{}})),Promise.all((e.scenes??[]).map(e=>vp(`scenes/${e}.json`))),Promise.all((e.levels??[]).map(e=>vp(`levels/${e}.json`)))]),a=new Map(r.map(e=>[e.id,Sp(e)]));if(!a.size)throw Error(`manifest.json no declara ninguna escena`);let o=i.map((e,t)=>({...e,number:e.number??t+1,scene:e.scene??r[0].id,rules:e.rules??{}}));if(!o.length)throw Error(`manifest.json no declara ningún nivel`);for(let e of o)if(!a.has(e.scene))throw Error(`El nivel "${e.id}" apunta a la escena "${e.scene}", que no existe`);return{manifest:e,dialogues:{cast:n.cast??{},encounters:n.encounters??{},barks:n.barks??{}},characters:Cp(t),scenes:a,levels:o,codeEggs:e.codeEggs??[]}}var Tp={south:0,west:1,east:2,north:3},Ep=32/44,Dp=8,Op=new cs,kp=new Map;function Ap(e){return kp.has(e)||kp.set(e,new Promise((t,n)=>{Op.load(e,e=>{e.colorSpace=Le,e.magFilter=a,e.minFilter=a,e.generateMipmaps=!1,t(e)},void 0,n)})),kp.get(e)}var jp=class{constructor(e,{height:t=1.5,y:n=0}={}){this.texture=e.clone(),this.texture.needsUpdate=!0,this.texture.repeat.set(1/4,1/4),this.material=new Mr({map:this.texture,transparent:!0,alphaTest:.4,depthWrite:!0,toneMapped:!1}),this.object=new Kr(this.material),this.height=t,this.object.scale.set(t*Ep,t,1),this.baseY=n+t/2,this.object.position.y=this.baseY,this.facing=`south`,this.frame=0,this._timer=0,this._moving=!1,this._applyFrame()}setFacing(e){e&&e!==this.facing&&Tp[e]!==void 0&&(this.facing=e,this._applyFrame())}setMoving(e){e!==this._moving&&(this._moving=e,e||(this.frame=0,this._timer=0,this._applyFrame()))}setPosition(e,t){this.object.position.x=e,this.object.position.z=t}setTint(e){this.material.color.setScalar(e)}update(e){if(!this._moving)return;this._timer+=e;let t=1/Dp;for(;this._timer>=t;)this._timer-=t,this.frame=(this.frame+1)%4,this._applyFrame()}_applyFrame(){let e=Tp[this.facing]??0;this.texture.offset.set(this.frame/4,1-(e+1)/4)}},Mp=class{constructor(e,{x:t=0,z:n=12.6,radius:r=.26*Z,height:i=1.45*Z,speed:a=4.4*Z}={}){this.speed=a,this.radius=r,this.position={x:t,z:n},this.keys=new Set,this.touchAxis={x:0,z:0},this.speedMul=1,this.isHiding=!1,this.isPretending=!1,this.isDoingActivity=!1,this.facing=`south`,this.sprite=new jp(e,{height:i}),this.sprite.setPosition(t,n),this._onKeyDown=e=>{let t=e.key.toLowerCase();this.keys.add(t),[`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,` `].includes(t)&&e.preventDefault()},this._onKeyUp=e=>this.keys.delete(e.key.toLowerCase()),window.addEventListener(`keydown`,this._onKeyDown),window.addEventListener(`keyup`,this._onKeyUp)}get object3D(){return this.sprite.object}_readInput(){let e=this.touchAxis.x,t=this.touchAxis.z;if(Math.hypot(e,t)>.08)return{right:e,up:-t};let n=0,r=0;return(this.keys.has(`w`)||this.keys.has(`arrowup`))&&(r+=1),(this.keys.has(`s`)||this.keys.has(`arrowdown`))&&--r,(this.keys.has(`a`)||this.keys.has(`arrowleft`))&&--n,(this.keys.has(`d`)||this.keys.has(`arrowright`))&&(n+=1),{right:n,up:r}}update(e,t){let{right:n,up:r}=this._readInput(),i=Math.min(Math.hypot(n,r),1),a=!1;if(i>.001){let{dx:t,dz:o}=Od(n,r),s=Math.hypot(t,o)||1,c=(this.isPretending?.45:1)*this.speedMul,l=this.speed*c*i*e;this.position.x+=t/s*l,this.position.z+=o/s*l,this.facing=kd(t,o,this.facing),a=!0}t&&t.resolveCircle(this.position,this.radius),this.sprite.setFacing(this.facing),this.sprite.setMoving(a&&!this.isPretending),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.setTint(this.isHiding?.6:1),this.sprite.update(e)}dispose(){window.removeEventListener(`keydown`,this._onKeyDown),window.removeEventListener(`keyup`,this._onKeyUp)}},Np=class{constructor(e,{id:t,x:n,z:r,radius:i=.28*Z,height:a=1.4*Z,facing:o=`south`,sway:s=0}={}){this.id=t,this.position={x:n,z:r},this.home={x:n,z:r},this.radius=i,this.sway=s*Z,this.sprite=new jp(e,{height:a}),this.sprite.setFacing(o),this.sprite.setPosition(n,r),this._phase=Math.random()*Math.PI*2}get object3D(){return this.sprite.object}update(e,t){if(this.sway>0){let e=Math.sin(t*.6+this._phase)*this.sway,n=this.position.x;this.position.x=this.home.x+e,this.sprite.setFacing(this.position.x>=n?`east`:`west`),this.sprite.setMoving(Math.abs(this.position.x-n)>5e-4),this.sprite.setPosition(this.position.x,this.position.z)}this.sprite.update(e)}},Pp={PATROL:`PATROL`,INVESTIGATE:`INVESTIGATE`,CHASE:`CHASE`,SEARCH:`SEARCH`},{PATROL:Fp,INVESTIGATE:Ip,CHASE:Lp,SEARCH:Rp}=Pp;function zp(e,t){return Math.atan2(-e,-t)}function Bp(e,t,n=24){let r=[];for(let i=0;i<n;i++){let a=-t+2*t*(i/n),o=-t+2*t*((i+1)/n);r.push(0,0,0),r.push(Math.sin(a)*e,0,-Math.cos(a)*e),r.push(Math.sin(o)*e,0,-Math.cos(o)*e)}let i=new Er;return i.setAttribute(`position`,new mr(r,3)),i}var Vp=class{constructor(e,{world:t,route:n,navmesh:r=null,radius:i=.3*Z,height:a=1.55*Z,speeds:o={},visionRange:s=7.5*Z,visionHalfAngleDeg:c=30,speedMul:l=1,role:u=`boss`,name:d=`Jefe`,coneColor:f=15910724,onSpot:p=null}){this.role=u,this.name=d,this.onSpot=p,this._reportCooldown=0,this.world=t,this.navmesh=r,this.route=n,this.routeIndex=0,this.position={x:n[0].x,z:n[0].z},this.radius=i,this.facingDir={x:0,z:-1},this._path=null,this._pathTarget=null,this._repathTimer=0,this._stuckTimer=0,this._lastPos={x:this.position.x,z:this.position.z},this._waypointTimer=0,this.prowlTarget=null,this.prowlTimer=0,this.pointsOfInterest=[],this.state=Fp,this.baseSpeeds={patrol:o.patrol??2.4*1.2,investigate:o.investigate??3.2*1.2,chase:o.chase??4.9*1.2,search:o.search??3*1.2},this.speed=this.baseSpeeds.patrol*l,this.investigateSpeed=this.baseSpeeds.investigate*l,this.chaseSpeed=this.baseSpeeds.chase*l,this.searchSpeed=this.baseSpeeds.search*l,this.investigateTarget=null,this.investigateTimer=0,this.searchTarget=null,this.searchTimer=0,this.loseSightTimer=0,this.lastSeenPlayerPos=null,this.baseVisionRange=s,this.visionRange=s,this.halfAngle=Et.degToRad(c),this.playerVisible=!1,this.redAlert=!1,this.sprite=new jp(e,{height:a}),this.sprite.setPosition(this.position.x,this.position.z);let m=Bp(this.visionRange,this.halfAngle);this.baseConeColor=f,this.coneMaterial=new ni({color:f,transparent:!0,opacity:.55,side:2,depthWrite:!1,toneMapped:!1}),this.cone=new mi(m,this.coneMaterial),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.renderOrder=2;let h=new qi(new oa(m,1),new Fi({color:16777215,transparent:!0,opacity:.45,toneMapped:!1}));this.cone.add(h)}get object3D(){return this.sprite.object}get isHunting(){return this.state===Lp||this.state===Rp}startChase(){this.state=Lp,this.loseSightTimer=0}distract(e,t){return this.state===Lp?!1:(this.state=Ip,this.investigateTarget={x:e.x,z:e.z},this.investigateTimer=t,!0)}catches(e,t){return this.role!==`minion`&&Math.hypot(e.x-this.position.x,e.z-this.position.z)<this.radius+t+.25*Z}setPointsOfInterest(e){this.pointsOfInterest=e,this.prowlTarget=null,this.prowlTimer=4+Math.random()*6}setRoute(e,t=0){this.route=e,this.routeIndex=Math.min(t,e.length-1),this.position.x=e[this.routeIndex].x,this.position.z=e[this.routeIndex].z,this._path=null,this._waypointTimer=0,this._stuckTimer=0,this.resetToPatrol()}setActive(e){this.active=e,this.sprite.object.visible=e,this.cone.visible=e}resetToPatrol(){this.state=Fp,this.loseSightTimer=0,this.searchTimer=0,this.lastSeenPlayerPos=null}update(e,t,n){if(this.active===!1)return;this._reportCooldown>0&&(this._reportCooldown-=e),this._updateVision(t,n),this.role===`minion`&&this.redAlert&&this._reportCooldown<=0&&(this._reportCooldown=8,this.onSpot?.(this,{x:t.position.x,z:t.position.z})),this._advanceState(e,t),this._updateStuck(e);let r=this._pickTarget(t),i=this._moveToward(e,this._steer(e,r));if(i)this.facingDir=i;else if(this.playerVisible){let e=t.position.x-this.position.x,n=t.position.z-this.position.z,r=Math.hypot(e,n);r>.001&&(this.facingDir={x:e/r,z:n/r})}this.sprite.setFacing(kd(this.facingDir.x,this.facingDir.z,`south`)),this.sprite.setMoving(!!i),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.update(e),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.rotation.y=zp(this.facingDir.x,this.facingDir.z);let a=this.redAlert||this.state===Lp;this.coneMaterial.color.set(a?15091775:this.state===Rp?14721084:this.baseConeColor),this.coneMaterial.opacity=a?.68:.55}_advanceState(e,t){switch(this.state){case Lp:this.playerVisible?this.loseSightTimer=0:(this.loseSightTimer+=e,this.loseSightTimer>1.2&&(this.state=Rp,this.searchTarget=this.lastSeenPlayerPos??{...this.position},this.searchTimer=5));break;case Rp:this.searchTimer-=e,this.playerVisible?this.startChase():this.searchTimer<=0&&this._resumeNearestRoutePoint();break;case Ip:this.investigateTimer-=e,this.playerVisible&&t.isDoingActivity?this.startChase():(this.investigateTimer<=0||this._reached(this.investigateTarget))&&this._resumeNearestRoutePoint();break;default:if(this.redAlert){this.startChase();break}this.prowlTimer-=e,this.prowlTimer<=0&&this.pointsOfInterest.length&&(this.prowlTimer=14+Math.random()*10,this.prowlTarget=this.pointsOfInterest[Math.floor(Math.random()*this.pointsOfInterest.length)]),this.prowlTarget&&this._reached(this.prowlTarget,1.6*1.2)&&(this.prowlTarget=null),this._waypointTimer+=e,(this._reached(this.route[this.routeIndex])||this._waypointTimer>14)&&(this.routeIndex=(this.routeIndex+1)%this.route.length,this._waypointTimer=0,this._path=null);break}}_resumeNearestRoutePoint(){let e=0,t=1/0;this.route.forEach((n,r)=>{let i=Math.hypot(n.x-this.position.x,n.z-this.position.z);i<t&&(t=i,e=r)}),this.routeIndex=e,this.state=Fp,this.searchTimer=0,this.loseSightTimer=0}_updateStuck(e){let t=Math.hypot(this.position.x-this._lastPos.x,this.position.z-this._lastPos.z);if(this._lastPos.x=this.position.x,this._lastPos.z=this.position.z,t>.02*1.2){this._stuckTimer=0;return}this._stuckTimer+=e,!(this._stuckTimer<1.4)&&(this._stuckTimer=0,this._path=null,this._pathTarget=null,this.prowlTarget=null,this.state===Fp?(this.routeIndex=(this.routeIndex+1)%this.route.length,this._waypointTimer=0):this.state===Rp?this._resumeNearestRoutePoint():this.state===Ip&&(this.investigateTimer=0))}_pickTarget(e){return this.state===Lp?e.isHiding?this.lastSeenPlayerPos??this.route[this.routeIndex]:{x:e.position.x,z:e.position.z}:this.state===Rp?this.searchTarget??this.route[this.routeIndex]:this.state===Ip?this.investigateTarget:this.prowlTarget??this.route[this.routeIndex]}_steer(e,t){if(!t||!this.navmesh)return t;if(this._repathTimer-=e,this.world&&!this.world.lineBlocked(this.position,t))return this._path=null,t;let n=!this._pathTarget||Math.hypot(this._pathTarget.x-t.x,this._pathTarget.z-t.z)>1.2*1.2;if((!this._path||n||this._repathTimer<=0)&&(this._path=this.navmesh.path(this.position,t),this._pathTarget={x:t.x,z:t.z},this._repathTimer=.5),!this._path||!this._path.length)return t;for(;this._path.length>1&&Math.hypot(this._path[0].x-this.position.x,this._path[0].z-this.position.z)<.6*1.2;)this._path.shift();return this._path[0]}_reached(e,t=.4*Z){return!e||Math.hypot(e.x-this.position.x,e.z-this.position.z)<t}_speed(){return this.state===Lp?this.chaseSpeed:this.state===Rp?this.searchSpeed:this.state===Ip?this.investigateSpeed:this.speed}_moveToward(e,t){if(!t)return null;let n=t.x-this.position.x,r=t.z-this.position.z,i=Math.hypot(n,r);if(i<.06*1.2)return null;let a=n/i,o=r/i,s=this._speed()*e,c={x:this.position.x,z:this.position.z};if(this.position.x+=a*s,this.position.z+=o*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)<s*.3){for(let[e,t]of[[a,0],[0,o]])if(this.position.x=c.x+e*s,this.position.z=c.z+t*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)>s*.3)break}let l=this.position.x-c.x,u=this.position.z-c.z;return Math.hypot(l,u)<1e-4?null:{x:a,z:o}}_updateVision(e,t){if(this.playerVisible=!1,this.redAlert=!1,e.isHiding)return;let n=e.position.x-this.position.x,r=e.position.z-this.position.z,i=Math.hypot(n,r);if(i>this.visionRange||i<.001)return;let a={x:n/i,z:r/i};if(this.facingDir.x*a.x+this.facingDir.z*a.z<Math.cos(this.halfAngle))return;let o=t.map(e=>({x:e.position.x,z:e.position.z,radius:e.radius}));this.world&&this.world.lineBlocked(this.position,e.position,o)||(this.playerVisible=!0,this.lastSeenPlayerPos={x:e.position.x,z:e.position.z},e.isDoingActivity&&!e.isPretending&&(this.redAlert=!0))}},Hp=`modo-incognito:settings:v1`,Up={auto:{label:`Auto`},alto:{label:`Alto`,shadows:!0,shadowMap:2048,maxPixelRatio:2},medio:{label:`Medio`,shadows:!0,shadowMap:1024,maxPixelRatio:1.5},bajo:{label:`Bajo`,shadows:!1,shadowMap:512,maxPixelRatio:1}},Wp={quality:{label:`Calidad gráfica`,type:`choice`,options:[`auto`,`alto`,`medio`,`bajo`],hint:`Auto baja sola si el dispositivo no da abasto`},pixelSize:{label:`Tamaño de píxel`,type:`range`,min:1,max:6,step:1,hint:`1 = 3D nítido · 4+ = pixel art grueso`},colorLevels:{label:`Niveles de color`,type:`range`,min:6,max:64,step:2,hint:`Menos niveles = paleta más marcada`},showLabels:{label:`Rótulos de zona`,type:`toggle`},showMarkers:{label:`Marcas de suelo`,type:`toggle`},vibration:{label:`Vibración (móvil)`,type:`toggle`},screenShake:{label:`Sacudida de cámara`,type:`toggle`}},Gp=Object.freeze({quality:`auto`,pixelSize:2,colorLevels:24,showLabels:!0,showMarkers:!0,vibration:!0,screenShake:!0});function Kp(e){let t={...Gp,...e};for(let[e,n]of Object.entries(Wp))if(n.type===`range`){let r=Number(t[e]);t[e]=Number.isFinite(r)?Math.min(n.max,Math.max(n.min,r)):Gp[e]}else n.type===`choice`?t[e]=n.options.includes(t[e])?t[e]:Gp[e]:t[e]=!!t[e];return t}function qp(){try{let e=localStorage.getItem(Hp);return Kp(e?JSON.parse(e):{})}catch{return{...Gp}}}var Jp=qp(),Yp=new Set;function Xp(){return Jp}function Zp(e){Jp=Kp({...Jp,...e});try{localStorage.setItem(Hp,JSON.stringify(Jp))}catch{}return Yp.forEach(e=>e(Jp)),Jp}function Qp(e){return Yp.add(e),e(Jp),()=>Yp.delete(e)}function $p(e=Jp.quality){if(e!==`auto`)return Up[e]??Up.medio;let t=matchMedia(`(pointer: coarse)`).matches,n=(navigator.deviceMemory??8)<=4,r=(navigator.hardwareConcurrency??8)<=4;return t||n||r?Up.medio:Up.alto}function em(e=12){Jp.vibration&&navigator.vibrate?.(e)}var tm=100,nm=45,rm=12,im=16,am=1.5*Z,om=7,sm=6,cm=14,lm=22,um=.5,dm=4,fm=11*Z,pm=.8,mm=1.4,hm=15,gm={duration:240,maxWarnings:3,objectives:null,decayMul:1,distractionsOff:!1,targetScore:1e3},_m=class{constructor({player:e,boss:t,npcs:n,minions:r=[],hud:i,rules:a={},onFinish:o=null,onEgg:s=null,onPopup:c=null,onTalk:l=null}){this.player=e,this.boss=t,this.npcs=n,this.minions=r,this.onTalk=l,this.hud=i,this.rules={...gm,...a},this.onFinish=o,this.onEgg=s,this.onPopup=c,this.suspicion=0,this.warnings=0,this.timeLeft=this.rules.duration,this.gameOver=!1,this.win=!1,this.paused=!1,this._finished=!1,this.score=0,this.combo=1,this.comboLeft=0,this.perk=null,this.perkLeft=0,this.revealBossUntil=0;let u=this.rules.objectives;this.objectives=Ud.filter(e=>!u||u.includes(e.id)).map(e=>({...e,progress:0,done:!1})),this.distractionState=this.rules.distractionsOff?[]:Gd.map(e=>({...e,cooldownLeft:0})),this.nearStation=null,this.nearDistraction=null,this.nearNpc=null,this.focusStation=null,this.message=null,this.currentArea=null,this.talkCooldowns=new Map,this.hideState=Wd.map(()=>({cooldownLeft:0,usedFor:0})),this._hidingCharge=e=>this.hidingCharge(e),this._prevInteractKey=!1,this._caughtCooldown=0,this._eggDwell=new Map,this._foundEggs=new Set}setPaused(e){this.paused=e,e&&(this.player.keys.clear(),this.player.touchAxis.x=0,this.player.touchAxis.z=0)}update(e){if(this.gameOver||this.paused){this.hud.render(this._snapshot());return}this.timeLeft=Math.max(0,this.timeLeft-e),this._caughtCooldown>0&&(this._caughtCooldown-=e),this.revealBossUntil>0&&(this.revealBossUntil-=e),this.comboLeft>0&&(this.comboLeft=Math.max(0,this.comboLeft-e),this.comboLeft===0&&(this.combo=1)),this.perkLeft>0&&(this.perkLeft=Math.max(0,this.perkLeft-e),this.perkLeft===0&&this._clearPerk());let t=this.player.position;this.currentArea=Yd(t.x,t.z)??Xd(t.x,t.z).area,this.player.isHiding=this._updateHiding(e,t);let n=this.player.keys.has(`e`),r=this.player.keys.has(`f`);this.player.isPretending=r,this.nearStation=this.objectives.find(e=>!e.done&&Math.hypot(e.x-t.x,e.z-t.z)<am)??null,this.focusStation=this.objectives.filter(e=>!e.done).reduce((e,n)=>{let r=Math.hypot(n.x-t.x,n.z-t.z);return!e||r<e._d?Object.assign(n,{_d:r}):e},null),this.nearStation&&n&&!r?(this.player.isDoingActivity=!0,this.nearStation.progress=Math.min(this.nearStation.time,this.nearStation.progress+e),this.nearStation.progress>=this.nearStation.time&&!this.nearStation.done&&(this.nearStation.done=!0,this._completeActivity(this.nearStation))):this.player.isDoingActivity=!1,this.distractionState.forEach(t=>{t.cooldownLeft>0&&(t.cooldownLeft=Math.max(0,t.cooldownLeft-e))}),this.nearDistraction=this.distractionState.find(e=>e.cooldownLeft<=0&&Math.hypot(e.x-t.x,e.z-t.z)<am)??null,this.talkCooldowns.forEach((t,n)=>{t>0&&this.talkCooldowns.set(n,Math.max(0,t-e))});let i=[...this.npcs,...this.minions.filter(e=>e.cast)];if(this.nearNpc=i.find(e=>e.cast&&(this.talkCooldowns.get(e.id??e.cast)??0)<=0&&Math.hypot(e.position.x-t.x,e.position.z-t.z)<am*1.3)??null,n&&!this._prevInteractKey&&this.nearNpc&&!this.nearStation){let e=this.nearNpc;this.talkCooldowns.set(e.id??e.cast,e.talkCooldown??40),this.onTalk?.(e)}else if(n&&!this._prevInteractKey&&this.nearDistraction&&!this.nearStation){let e={x:this.nearDistraction.x,z:this.nearDistraction.z};this.boss.distract(e,om)?(this.nearDistraction.cooldownLeft=this.nearDistraction.cooldown,this._toast(`Distracción: ${this.nearDistraction.label}`),this._award(40,`Distracción`,this.player.position)):this._toast(`¡Ya te vio! Una distracción no lo detiene ahora.`)}this._prevInteractKey=n,this.boss.update(e,this.player,this.npcs),this.minions.forEach(t=>t.update(e,this.player,this.npcs)),this._updateEggs(e);let a=this.minions.some(e=>e.redAlert),o=this.rules.decayMul;if(a&&!this.boss.redAlert&&(this.suspicion=Math.min(tm,this.suspicion+12*e)),this.boss.redAlert){let t=this.nearStation?.riskRate??20;this.suspicion=Math.min(tm,this.suspicion+t*e)}else this.boss.state===Pp.CHASE&&this.boss.playerVisible?this.suspicion=Math.min(tm,this.suspicion+im*e):this.player.isHiding||this.player.isPretending?this.suspicion=Math.max(0,this.suspicion-nm*o*e):this.suspicion=Math.max(0,this.suspicion-rm*o*e);let s=this._caughtCooldown<=0&&this.boss.isHunting&&!this.player.isHiding&&this.boss.catches(t,this.player.radius);(this.suspicion>=tm||s)&&this._warn(),this.gameOver||(this.objectives.every(e=>e.done)?this._finish(!0):this.timeLeft<=0&&this._finish(!1)),this.message&&(this.message.timer-=e,this.message.timer<=0&&(this.message=null)),this.hud.render(this._snapshot())}_completeActivity(e){let t=Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),n=0,r=``;this.boss.playerVisible?(n=mm,r=` · ¡EN SUS NARICES!`):t<fm&&(n=pm,r=` · con el jefe cerca`);let i=e.points??120,a=Math.round(i*(this.combo+n));this.score+=a,this.combo=Math.min(dm,this.combo+um),this.comboLeft=lm,e.perk&&this._applyPerk(e.perk),em([12,40,18]),this._toast(`${e.label} ✔${r}`),this.onPopup?.({text:`+${a}`,sub:this.combo>1?`x${this.combo.toFixed(1)}`:``,x:e.x,z:e.z,kind:n?`nerve`:`score`})}_award(e,t,n){let r=Math.round(e*this.combo);this.score+=r,this.onPopup?.({text:`+${r}`,sub:t,x:n.x,z:n.z,kind:`minor`})}_applyPerk(e){this._clearPerk(),this.perk=e,this.perkLeft=hm,e===`caffeine`&&(this.player.speedMul=1.35,this._toast(`☕ Cafeína: +35% de velocidad`))}_clearPerk(){this.perk===`caffeine`&&(this.player.speedMul=1),this.perk=null}_updateHiding(e,t){let n=!1;return Wd.forEach((r,i)=>{let a=this.hideState[i],o=Math.hypot(r.x-t.x,r.z-t.z)<r.r;if(a.cooldownLeft>0){a.cooldownLeft=Math.max(0,a.cooldownLeft-e),a.cooldownLeft===0&&(a.usedFor=0);return}if(!o){a.usedFor=Math.max(0,a.usedFor-e*.6);return}if(a.usedFor+=e,a.usedFor>=sm){a.cooldownLeft=cm,this._toast(`Ese escondite se quemó. Busca otro.`),em(30);return}n=!0}),n}hidingCharge(e){let t=this.hideState[e];return t?t.cooldownLeft>0?0:1-t.usedFor/sm:1}_updateEggs(e){if(!this.onEgg)return;let t=this.player.position;for(let n of qd){if(this._foundEggs.has(n.id))continue;let r=Math.hypot(n.x-t.x,n.z-t.z)<n.radius,i=(this._eggDwell.get(n.id)??0)+(r?e:-e*2);this._eggDwell.set(n.id,Math.max(0,i)),i>=n.dwell&&(this._foundEggs.add(n.id),this.score+=250,this.onEgg(n))}}_warn(){this.warnings+=1,this.suspicion=0,this._caughtCooldown=3,this.combo=1,this.comboLeft=0,this.boss.resetToPatrol(),em([40,60,40]),this.warnings>=this.rules.maxWarnings?(this._toast(`Última advertencia: despedida.`),this._finish(!1)):this._toast(`Advertencia ${this.warnings}/${this.rules.maxWarnings}`)}_finish(e){this._finished||(this._finished=!0,this.gameOver=!0,this.win=e,this._clearPerk(),e&&(this.score+=Math.round(this.timeLeft*4)),this.onFinish?.({win:e,score:this.score,targetScore:this.rules.targetScore,warnings:this.warnings,timeLeft:this.timeLeft,elapsed:this.rules.duration-this.timeLeft,objectives:this.objectives,eggsFound:this._foundEggs.size}))}applyEffect(e){switch(e){case`suspicion-`:this.suspicion=Math.max(0,this.suspicion-45),this._toast(`La sospecha baja`);break;case`suspicion+`:this.suspicion=Math.min(tm,this.suspicion+30),this._toast(`Alguien levantó la voz…`);break;case`score+`:this._award(120,`Buena conversación`,this.player.position);break;case`speed+`:this._applyPerk(`caffeine`);break;case`reveal-boss`:this.revealBossUntil=12,this._toast(`Sabes dónde está el jefe`);break;default:break}}_toast(e){this.message={text:e,timer:2.6}}_snapshot(){return this.lastSnapshot={suspicion:this.suspicion,suspicionMax:tm,warnings:this.warnings,maxWarnings:this.rules.maxWarnings,timeLeft:this.timeLeft,levelDuration:this.rules.duration,objectives:this.objectives,nearStation:this.nearStation,nearDistraction:this.nearDistraction,nearNpc:this.nearNpc,focusStation:this.focusStation,playerPos:this.player.position,bossPos:this.boss.position,bossDistance:Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),minionAlert:this.minions.some(e=>e.redAlert),minionPositions:this.minions.map(e=>e.position),hidingCharge:this._hidingCharge,worldScale:Z,revealBoss:this.revealBossUntil>0,isPretending:this.player.isPretending,isHiding:this.player.isHiding,redAlert:this.boss.redAlert,bossState:this.boss.state,gameOver:this.gameOver,win:this.win,message:this.message,area:this.currentArea,score:this.score,combo:this.combo,comboLeft:this.comboLeft,comboWindow:lm,perk:this.perk,perkLeft:this.perkLeft,perkDuration:hm,targetScore:this.rules.targetScore},this.lastSnapshot}};function vm(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function ym(e){return`#${e.toString(16).padStart(6,`0`)}`}function Q(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n&&n.appendChild(r),r}jd.OPEN_OFFICE,jd.MEETING,jd.SOCIAL,jd.AUDITORIUM,jd.CORE,jd.ELEVATOR;function bm(e){let t=Q(`div`,`hud-root`,e),n=Q(`div`,`hud-topbar`,t),r=Q(`div`,`hud-panel hud-objectives`,n),i=Q(`div`,`hud-panel-title`,r);i.innerHTML=`<span class="hud-title-icon">🎯</span> OBJETIVOS <span class="hud-objectives-count"></span>`;let a=i.querySelector(`.hud-objectives-count`),o=Q(`div`,`hud-objectives-list`,r),s=Q(`div`,`hud-center`,n),c=Q(`div`,`hud-day-chip`,s),l=Q(`div`,`hud-panel hud-suspicion`,s),u=Q(`div`,`hud-panel-title`,l);u.innerHTML=`<span class="hud-title-icon">👁️</span> SOSPECHA`;let d=Q(`div`,`hud-suspicion-fill`,Q(`div`,`hud-suspicion-track`,l)),f=Q(`div`,`hud-suspicion-glint`,d),p=Q(`div`,`hud-warnings`,l),m=[],h=Q(`div`,`hud-status-badge`,s),g=Q(`div`,`hud-toast`,s),_=Q(`div`,`hud-right`,n),v=Q(`div`,`hud-panel hud-timer`,_),y=Q(`div`,`hud-panel-title`,v);y.innerHTML=`<span class="hud-title-icon">⏱️</span> JORNADA`;let b=Q(`div`,`hud-timer-value`,v),x=Q(`div`,`hud-timer-fill`,Q(`div`,`hud-timer-track`,v)),S=Q(`div`,`hud-panel hud-scorepanel`,_),C=Q(`div`,`hud-panel-title`,S);C.innerHTML=`<span class="hud-title-icon">◆</span> PUNTOS`;let w=Q(`div`,`hud-score`,S),T=Q(`span`,`hud-score-value`,w),E=Q(`span`,`hud-combo`,w),D=Q(`span`,`hud-combo-bar`,E),O=Q(`span`,`hud-combo-text`,E),k=Q(`div`,`hud-perk`,S),A=Q(`div`,`hud-overlay hidden`,t),j=Q(`div`,`hud-overlay-card`,A),ee=Q(`div`,`hud-overlay-icon`,j),M=Q(`div`,`hud-overlay-title`,j),N=Q(`div`,`hud-overlay-score`,j),P=Q(`div`,`hud-overlay-body`,j),F=Q(`div`,`hud-overlay-actions`,j),te=-1;function ne(e){c.textContent=`DÍA ${e.number} · ${e.title.toUpperCase()}`}function re(e){t.classList.toggle(`hidden`,!e)}function ie({icon:e,title:t,body:n,win:r,actions:i,rank:a,score:o,target:s}){if(ee.textContent=e,M.textContent=t,M.classList.toggle(`win`,!!r),M.classList.toggle(`lose`,!r),N.innerHTML=``,o!=null){let e=Q(`div`,`hud-result-score`,N);if(Q(`span`,`hud-result-points`,e,`${o.toLocaleString(`es`)} pts`),s){let t=Q(`div`,`hud-result-fill`,Q(`div`,`hud-result-track`,e));t.style.width=`${Math.min(100,Math.round(o/s*100))}%`,Q(`span`,`hud-result-target`,e,`objetivo ${s.toLocaleString(`es`)}`)}}if(a){let e=Q(`div`,`hud-rank rank-${a.label}`,N);Q(`span`,`hud-rank-letter`,e,a.label),Q(`span`,`hud-rank-blurb`,e,a.blurb)}P.textContent=n,F.innerHTML=``,i.forEach(e=>{let t=Q(`button`,`hud-overlay-btn${e.primary?` primary`:``}`,F);t.type=`button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick)}),A.classList.remove(`hidden`),document.body.classList.add(`overlay-open`)}function ae(){A.classList.add(`hidden`),document.body.classList.remove(`overlay-open`)}function oe(e){e.maxWarnings!==te&&(te=e.maxWarnings,p.innerHTML=``,m=Array.from({length:e.maxWarnings},()=>{let e=Q(`div`,`hud-warning-pip`,p);return e.textContent=`!`,e}));let t=e.objectives.filter(e=>e.done).length;a.textContent=`${t}/${e.objectives.length}`,T.textContent=e.score.toLocaleString(`es`);let n=e.combo>1;E.classList.toggle(`on`,n),O.textContent=`x${e.combo.toFixed(1)}`,D.style.width=n?`${Math.round(e.comboLeft/e.comboWindow*100)}%`:`0%`,k.classList.toggle(`visible`,!!e.perk),e.perk&&(k.textContent=`☕ CAFEÍNA ${Math.ceil(e.perkLeft)}s`,k.style.setProperty(`--p`,e.perkLeft/e.perkDuration));let r=Math.round(e.suspicion/e.suspicionMax*100);d.style.width=`${r}%`,d.classList.toggle(`danger`,r>70&&r<=92),d.classList.toggle(`hot`,e.redAlert||r>92),f.classList.toggle(`pulse`,e.redAlert),m.forEach((t,n)=>t.classList.toggle(`lit`,n<e.warnings)),b.textContent=vm(e.timeLeft);let i=Math.round(e.timeLeft/e.levelDuration*100);x.style.width=`${i}%`;let s=e.timeLeft<30;b.classList.toggle(`danger`,s),x.classList.toggle(`danger`,s),o.innerHTML=``,e.objectives.forEach(e=>{let t=Q(`div`,`hud-objective${e.done?` done`:``}`,o),n=Q(`span`,`hud-objective-dot`,t);n.style.background=ym(Md[e.type]??16777215);let r=Q(`span`,`hud-objective-icon`,t);r.textContent=e.done?`✓`:e.icon??`•`;let i=Q(`span`,`hud-objective-label`,t);if(i.textContent=e.label,!e.done&&e.progress>0){let n=Q(`div`,`hud-objective-bar-fill`,Q(`div`,`hud-objective-bar`,t));n.style.width=`${Math.round(e.progress/e.time*100)}%`,n.style.background=ym(Md[e.type]??14709292)}}),e.message?(g.textContent=e.message.text,g.classList.add(`visible`)):g.classList.remove(`visible`);let c=[];e.isHiding&&c.push(`🫥 ESCONDIDA`),e.isPretending&&c.push(`⌨️ FINGIENDO TRABAJAR`),e.bossState===`CHASE`?c.push(`🚨 ¡TE PERSIGUE!`):e.bossState===`SEARCH`?c.push(`🔎 TE ESTÁ BUSCANDO`):e.bossState===`INVESTIGATE`&&c.push(`❓ DISTRAÍDO`),h.textContent=c.join(`   ·   `),h.classList.toggle(`visible`,c.length>0),h.classList.toggle(`alert`,e.bossState===`CHASE`)}return{render:oe,setDay:ne,setVisible:re,showResult:ie,hideResult:ae,root:t}}var xm=new Set([` `,`enter`,`e`]);function Sm(e){let t=document.createElement(`div`);t.className=`vn-layer hidden`,t.innerHTML=`
  ...
  `,jm($(`div`,`px-screen-foot`,A),`Volver`,{onClick:()=>P(u??`title`)});let ee=p(`pause`,`px-screen-pause`);$(`h2`,`px-screen-title-text`,ee,`Pausa`);let M=$(`p`,`px-pause-info`,ee),N=$(`div`,`px-menu-list`,ee);jm(N,`Continuar`,{primary:!0,icon:`▶`,onClick:()=>r.resume()}),jm(N,`Reiniciar día`,{icon:`↺`,onClick:()=>r.restart()}),jm(N,`Ajustes`,{icon:`⚙`,onClick:()=>P(`settings`)}),jm(N,`Menú principal`,{icon:`⌂`,onClick:()=>r.toTitle()});function P(e){e===`settings`&&!d&&(d=Am(),E.appendChild(d.root),O(`game`)),l&&l!==e&&(u=l),l=e,Object.entries(f).forEach(([t,n])=>n.classList.toggle(`hidden`,t!==e)),o.classList.remove(`hidden`),document.body.classList.add(`menu-open`),o.dataset.screen=e}function F(){o.classList.add(`hidden`),document.body.classList.remove(`menu-open`),l=null}return s.addEventListener(`click`,()=>{l===`pause`&&r.resume()}),{show:P,close:F,openTitle(e){x(),_.classList.toggle(`hidden`,!e.hasProgress),v.textContent=e.summary,P(`title`)},openPause(e){M.textContent=e??``,P(`pause`)},openDays(){x(),P(`days`)},get isOpen(){return!o.classList.contains(`hidden`)},get screen(){return l}}}var Fm={sur:`ALA SUR`,norte:`ALA NORTE`,centro:`CENTRO`},Im=46;function Lm(e,t){let n=document.createElement(`div`);n.className=`compass-layer`,n.innerHTML=`
  ...
  `,e.appendChild(n);let r=n.querySelector(`.compass-card`),i=n.querySelector(`.compass-here`),a=n.querySelector(`.compass-icon`),o=n.querySelector(`.compass-label`),s=n.querySelector(`.compass-meta`),c=n.querySelector(`.compass-risk i`),l=n.querySelector(`.compass-marker`),u=n.querySelector(`.compass-arrow`),d=n.querySelector(`.compass-dist`),f=new G;function p(e){let p=e?.focusStation;if(!p||e.gameOver){n.classList.remove(`visible`);return}n.classList.add(`visible`);let m=e.playerPos.x,h=e.playerPos.z,g=Math.hypot(p.x-m,p.z-h)/Z,_=e.area;i.textContent=_?`${Fm[_.wing]??`PISO 7`} · ${_.name}`:`PISO 7`,a.textContent=p.icon??`•`,o.textContent=p.label,s.textContent=e.nearStation&&e.nearStation.id===p.id?`EN CURSO`:`${Math.round(g)} m`;let v=Math.hypot(e.bossPos.x-p.x,e.bossPos.z-p.z)/Z,y=Et.clamp(1-v/16,0,1);c.style.width=`${Math.round(y*100)}%`,r.classList.toggle(`hot`,y>.62||e.redAlert),r.classList.toggle(`warm`,y>.32&&y<=.62);let b=n.clientWidth,x=n.clientHeight;f.set(p.x,1.2*Z,p.z).project(t);let S=f.z<1&&Math.abs(f.x)<.94&&Math.abs(f.y)<.9,C=(f.x+1)/2*b,w=(1-f.y)/2*x,T=0;if(!S){let e=f.x,t=f.y;f.z>=1&&(e=-e,t=-t);let n=Math.hypot(e,t)||1,r=e/n,i=t/n,a=b/2-Im,o=x/2-Im,s=Math.min(a/Math.abs(r||.001),o/Math.abs(i||.001));C=b/2+r*s,w=x/2-i*s,T=180/Math.PI*Math.atan2(r,i)}l.classList.toggle(`edge`,!S),l.style.transform=`translate(-50%, -50%) translate(${C}px, ${w}px)`,u.style.transform=`rotate(${T}deg)`,d.textContent=S?``:`${Math.round(g)} m`}return{update:p,root:n}}var Rm={floor:`rgba(69, 224, 208, 0.10)`,outline:`rgba(69, 224, 208, 0.65)`,player:`#a8e05f`,boss:`#ff4d5e`,minion:`#f2c744`,task:`#45e0d0`,hide:`rgba(120, 220, 150, 0.85)`,hideSpent:`rgba(120, 130, 150, 0.35)`};function zm(e){let t=document.createElement(`div`);t.className=`radar`,t.innerHTML=`
    <div class="radar-head"><span>RADAR</span><span class="radar-dist"></span></div>
    <canvas class="radar-canvas"></canvas>
  `,e.appendChild(t);let n=t.querySelector(`.radar-canvas`),r=t.querySelector(`.radar-dist`),i=n.getContext(`2d`),a=1/0,o=-1/0,s=1/0,c=-1/0;for(let[e,t]of Id)a=Math.min(a,e),o=Math.max(o,e),s=Math.min(s,t),c=Math.max(c,t);let l=o-a,u=c-s,d=1,f=0,p=0,m=1;function h(){let e=n.getBoundingClientRect();return e.width?(d=Math.min(window.devicePixelRatio||1,2),f=e.width,p=e.height,n.width=Math.round(f*d),n.height=Math.round(p*d),i.setTransform(d,0,0,d,0,0),m=Math.min((f-12)/l,(p-12)/u),!0):!1}let g=e=>6+(e-a)*m+(f-12-l*m)/2,_=e=>6+(e-s)*m+(p-12-u*m)/2;function v(e,t,n,r,a=0){i.beginPath(),i.arc(g(e),_(t),n,0,Math.PI*2),i.fillStyle=r,a&&(i.shadowColor=r,i.shadowBlur=a),i.fill(),i.shadowBlur=0}let y=0;function b(e,n=0){if(!e){t.classList.remove(`visible`);return}if(t.classList.add(`visible`),!(!f&&!h())){if(y+=n,i.clearRect(0,0,f,p),i.beginPath(),Id.forEach(([e,t],n)=>{let r=g(e),a=_(t);n===0?i.moveTo(r,a):i.lineTo(r,a)}),i.closePath(),i.fillStyle=Rm.floor,i.fill(),i.strokeStyle=Rm.outline,i.lineWidth=1,i.stroke(),Wd.forEach((t,n)=>{let r=e.hidingCharge?e.hidingCharge(n):1;v(t.x,t.z,1.6,r>.05?Rm.hide:Rm.hideSpent)}),(e.objectives??[]).forEach(e=>{e.done||(i.beginPath(),i.rect(g(e.x)-2.5,_(e.z)-2.5,5,5),i.fillStyle=Rm.task,i.fill())}),(e.minionPositions??[]).forEach(e=>v(e.x,e.z,2.6,Rm.minion,4)),e.bossPos){if(e.bossState===`CHASE`||e.bossState===`SEARCH`){let t=4+(Math.sin(y*6)*.5+.5)*5;i.beginPath(),i.arc(g(e.bossPos.x),_(e.bossPos.z),t,0,Math.PI*2),i.strokeStyle=Rm.boss,i.lineWidth=1.5,i.stroke()}v(e.bossPos.x,e.bossPos.z,3.4,Rm.boss,8)}if(e.playerPos&&v(e.playerPos.x,e.playerPos.z,3,Rm.player,8),e.bossDistance!=null){let t=Math.round(e.bossDistance/(e.worldScale??1));r.textContent=`${t} m`,r.classList.toggle(`near`,t<10)}}}return window.addEventListener(`resize`,()=>{f=0}),{update:b,root:t}}function Bm(e,t,{isTouch:n=!1}={}){let r=document.createElement(`div`);r.className=`wprompt`,r.innerHTML=`
  ...
  `,e.appendChild(r);let i=r.querySelector(`.wprompt-card`),a=r.querySelector(`.wprompt-key`),o=r.querySelector(`.wprompt-label`),s=r.querySelector(`.wprompt-hint`),c=r.querySelector(`.wprompt-fill`),l=new G,u=n?`USAR`:`E`;function d(){r.classList.remove(`visible`)}function f(e){if(!e||e.gameOver)return d();let f=null;if(e.nearStation?f={x:e.nearStation.x,z:e.nearStation.z,icon:e.nearStation.icon??`•`,label:e.nearStation.label,hint:n?`MANTÉN USAR`:`MANTÉN E`,progress:e.nearStation.progress/e.nearStation.time,kind:`task`}:e.nearNpc?f={x:e.nearNpc.position.x,z:e.nearNpc.position.z,icon:`💬`,label:`Hablar con ${e.nearNpc.displayName}`,hint:`PULSA ${u}`,progress:0,kind:`talk`}:e.nearDistraction&&(f={x:e.nearDistraction.x,z:e.nearDistraction.z,icon:`⭐`,label:e.nearDistraction.label,hint:`PULSA ${u}`,progress:0,kind:`distract`}),!f||(l.set(f.x,1.9*Z,f.z).project(t),l.z>=1))return d();let p=r.parentElement.clientWidth,m=r.parentElement.clientHeight;r.style.transform=`translate(-50%, -100%) translate(${(l.x+1)/2*p}px, ${(1-l.y)/2*m}px)`,a.textContent=f.icon,o.textContent=f.label,s.textContent=f.hint,c.style.width=`${Math.round(Et.clamp(f.progress,0,1)*100)}%`,i.dataset.kind=f.kind,r.classList.add(`visible`)}return{update:f,hide:d}}function Vm({app:e,lights:t,renderer:n,scene:r,player:i,boss:a,npcs:o,camera:s,levels:c,codeEggs:l=[],manifest:u={},dialogues:d={cast:{},encounters:{},barks:{}},minions:f=new Map,onPopup:p=null}){let m=bm(e),h=Lm(e,s.camera),g=zm(e),_=Bm(e,s.camera,{isTouch:matchMedia(`(pointer: coarse)`).matches}),v=Sm(e),y=Dm(),b=[...qd.map(e=>e.id),...l.map(e=>e.id)],x=Math.min(y.dayIndex,c.length-1),S=null,C=1,w=!1,T=!1,E={setFlag:(e,t)=>y.setFlag(e,t),getFlag:e=>y.getFlag(e),applyEffect:e=>{if(D[e]){O=e;return}S?.applyEffect(e)}},D={wait:{timeDelta:-25,toast:`Llegaste con la fila. Menos jornada por delante.`},stairs:{timeDelta:0,tired:!0,toast:`Siete pisos. Llegas entera pero lenta.`},cut:{timeDelta:15,risky:!0,toast:`Te colaste. A ver si nadie lo comenta.`}},O=null,k={slowBoss:()=>{C=.78,j()}};function A(e,t){a.distract(t,6),S?._toast(`${e.name} te delató`)}f.forEach(e=>{e.onSpot=A});function j(){let e=c[x].rules??{},t=(e.bossSpeedMul??1)*C;a.speed=a.baseSpeeds.patrol*t,a.investigateSpeed=a.baseSpeeds.investigate*t,a.chaseSpeed=a.baseSpeeds.chase*t,a.searchSpeed=a.baseSpeeds.search*t,a.visionRange=a.baseVisionRange*(e.visionMul??1);let n=e.objectives,r=Ud.filter(e=>!n||n.includes(e.id)).map(e=>({x:e.x,z:e.z}));a.setPointsOfInterest(r)}let ee=Pm(e,{levels:c,save:y,title:u.title??`Modo Incógnito`,subtitle:u.subtitle??``,actions:{play:e=>ae(e),resume:()=>P(),restart:()=>ae(x),toTitle:()=>M()}});function M(){T=!1,w=!1,S?.setPaused(!0),m.setVisible(!1),m.hideResult();let e=y.state.completedDays.length;ee.openTitle({hasProgress:e>0||y.dayIndex>0,summary:`${e}/${c.length} días superados · ${y.state.eggs.length}/${b.length} secretos`})}function N(){!T||v.isOpen||S?.gameOver||(w=!0,S?.setPaused(!0),ee.openPause(`Día ${c[x].number} · ${c[x].title}`))}function P(){ee.close(),T&&(w=!1,m.setVisible(!0),!v.isOpen&&!S?.gameOver&&S?.setPaused(!1))}let F=[],te=e=>{let t=e.key.toLowerCase();if(t===`escape`){e.preventDefault(),ee.isOpen&&ee.screen===`pause`?P():ee.isOpen||N();return}if(!ee.isOpen){F.push(t),F.length>12&&F.shift();for(let e of l)y.hasEgg(e.id)||F.slice(-e.keys.length).join(`,`)===e.keys.join(`,`)&&(F.length=0,ne(e))}};window.addEventListener(`keydown`,te);async function ne(e){y.findEgg(e.id)&&(e.perk&&k[e.perk]?.(),await re(()=>v.play([...e.scene??[],{speaker:`Secreto encontrado`,portrait:`🥚`,text:`Llevas ${y.state.eggs.length} de ${b.length}. +250 puntos.`}],E)))}async function re(e){S?.setPaused(!0);try{await e()}finally{!w&&!S?.gameOver&&S?.setPaused(!1)}}function ie(){i.position.x=Ld.x,i.position.z=Ld.z,i.keys.clear(),i.touchAxis.x=0,i.touchAxis.z=0,i.speedMul=1,i.isHiding=!1,i.isPretending=!1,i.isDoingActivity=!1;let e=0,t=-1/0;Vd.forEach((n,r)=>{let i=Math.hypot(n.x-Ld.x,n.z-Ld.z);i>t&&(t=i,e=r)}),a.position.x=Vd[e].x,a.position.z=Vd[e].z,a.routeIndex=e,a.resetToPatrol()}async function ae(e){x=Math.min(Math.max(e,0),c.length-1),y.setDayIndex(x);let l=c[x];if(ee.close(),w=!1,T=!0,C=1,km(l.theme,{renderer:n,scene:r,...t}),m.setDay(l),m.setVisible(!0),m.hideResult(),ie(),j(),S=new _m({player:i,boss:a,npcs:o,minions:se(l),hud:m,rules:l.rules,onFinish:e=>ce(l,e),onEgg:e=>ne(e),onPopup:p,onTalk:e=>I(e)}),S.setPaused(!0),s.setFraming(s.camera.aspect>=1.15?.35:.8),O=null,l.prologue){let e=[...l.prologue.intro??[]];l.prologue.choice&&e.push(l.prologue.choice),await v.play(e,E),oe(l)}await v.play(l.intro??[],E),w||S.setPaused(!1)}function oe(e){let t=D[O];!S||!t||(S.timeLeft=Math.max(60,S.timeLeft+t.timeDelta),t.tired&&(i.speedMul=.85,setTimeout(()=>{i.speedMul===.85&&(i.speedMul=1)},3e4)),t.risky&&Math.random()<.35?(S.warnings=1,S._toast(`Te vieron colarte: advertencia 1`)):S._toast(t.toast))}function se(e){let t=[],n=e.rules?.objectives,r=Ud.filter(e=>!n||n.includes(e.id)).map(e=>({x:e.x,z:e.z}));return f.forEach(e=>e.setActive(!1)),(e.minions??[]).forEach(e=>{let n=f.get(e.id);if(!n)return;let i=Hd[e.route]??Hd.jefe??Vd;n.setRoute(i),n.setPointsOfInterest(r),n.setActive(!0),t.push(n)}),t}async function I(e){let t=d.encounters[e.cast];if(!t?.scenes?.length)return;let n=y.getFlag(`talk:${e.cast}`)??0;y.setFlag(`talk:${e.cast}`,n+1);let r=t.scenes[n%t.scenes.length],i=d.cast[e.cast];await re(()=>v.play(r.map(e=>({color:i?.color,...e})),E))}async function ce(e,t){T=!1;let n=t.targetScore??1e3,r=Nm(t.score,n);t.win?y.completeDay(e.id,{seconds:Math.round(t.elapsed),score:t.score}):y.recordScore(e.id,t.score),await v.play((t.win?e.outroWin:e.outroLose)??[],E);let i=x>=c.length-1,a=t.objectives.filter(e=>e.done).length,o=[];t.win&&!i&&o.push({label:`Día ${c[x+1].number} →`,primary:!0,onClick:()=>ae(x+1)}),o.push({label:t.win?`Repetir`:`Reintentar`,primary:!t.win,onClick:()=>ae(x)}),o.push({label:`Menú`,onClick:()=>M()}),m.showResult({icon:t.win?i?`🏆`:`🎉`:`🚪`,title:t.win?i?`Semana completada`:`${e.title}: superado`:`Despedida`,rank:t.win?r:null,score:t.score,target:n,body:t.win?`${a}/${t.objectives.length} actividades · ${t.eggsFound} secretos hoy · objetivo ${n} pts`:t.warnings>=(e.rules?.maxWarnings??3)?`Te quedaste sin advertencias.`:`Se acabó la jornada con objetivos pendientes.`,win:t.win,actions:o})}function le(e){S?.update(e);let t=S&&!ee.isOpen?S.lastSnapshot:null;h.update(t),g.update(t,e),_.update(v.isOpen?null:t)}return{hud:m,dialogue:v,menus:ee,compass:h,radar:g,save:y,start:()=>M(),startDay:ae,openPause:N,update:le,get game(){return S},get isPaused(){return ee.isOpen||!!S?.paused},get inLevel(){return T},dispose(){window.removeEventListener(`keydown`,te),v.dispose()}}}function Hm(e,t,{onZoom:n,onInspect:r,onPause:i}={}){let a=`ontouchstart`in window||navigator.maxTouchPoints>0||matchMedia(`(pointer: coarse)`).matches;document.body.classList.toggle(`touch-device`,a);let o=document.createElement(`div`);o.className=`touch-controls`,t.appendChild(o);let s=document.createElement(`div`);s.className=`touch-stick-zone`;let c=document.createElement(`div`);c.className=`touch-stick-base`;let l=document.createElement(`div`);l.className=`touch-stick-thumb`,c.appendChild(l),s.appendChild(c),o.appendChild(s);let u=null,d={x:0,y:0};function f(t,n){e.touchAxis.x=t,e.touchAxis.z=n}function p(e){let t=e.clientX-d.x,n=e.clientY-d.y,r=Math.hypot(t,n);r>56&&(t=t/r*56,n=n/r*56),l.style.transform=`translate(${t}px, ${n}px)`,f(t/56,n/56)}function m(e){e.pointerId===u&&(u=null,c.classList.remove(`active`),l.style.transform=`translate(0, 0)`,f(0,0))}s.addEventListener(`pointerdown`,e=>{u=e.pointerId,d={x:e.clientX,y:e.clientY};let t=s.getBoundingClientRect();c.style.left=`${e.clientX-t.left}px`,c.style.top=`${e.clientY-t.top}px`,c.classList.add(`active`),s.setPointerCapture(e.pointerId),p(e)}),s.addEventListener(`pointermove`,e=>{e.pointerId===u&&p(e)}),s.addEventListener(`pointerup`,m),s.addEventListener(`pointercancel`,m);let h=document.createElement(`div`);h.className=`touch-actions`,o.appendChild(h);function g(t,n,r,i){let a=document.createElement(`div`);a.className=`touch-btn ${t}`,a.innerHTML=`<span class="touch-btn-icon">${n}</span><span>${r}</span>`;let o=t=>{t.preventDefault(),e.keys.add(i),a.classList.add(`active`),em(8)},s=()=>{e.keys.delete(i),a.classList.remove(`active`)};return a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointercancel`,s),a.addEventListener(`pointerleave`,s),h.appendChild(a),a}g(`touch-btn-pretend`,`⌨️`,`FINGIR`,`f`),g(`touch-btn-interact`,`✋`,`USAR`,`e`);let _=document.createElement(`div`);_.className=`touch-utils`,o.appendChild(_);function v(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`touch-util`,r.textContent=e,r.title=t,r.setAttribute(`aria-label`,t),r.addEventListener(`click`,e=>{e.preventDefault(),em(8),n()}),_.appendChild(r),r}return n&&(v(`＋`,`Acercar`,()=>n(.18)),v(`－`,`Alejar`,()=>n(-.18))),r&&v(`🗺️`,`Inspeccionar plano`,r),i&&v(`⏸`,`Pausa`,i),{isTouch:a}}var Um=1.5;function Wm(e,t){let n=document.createElement(`div`);n.className=`px-popups`,e.appendChild(n);let r=[],i=new G;function a({text:e,sub:t=``,x:i,z:a,kind:o=`score`}){let s=document.createElement(`div`);s.className=`px-pop px-pop-${o}`,s.innerHTML=`<span class="px-pop-main">${e}</span>${t?`<span class="px-pop-sub">${t}</span>`:``}`,n.appendChild(s),r.push({node:s,x:i,y:1.6*Z,z:a,life:Um})}function o(e){if(!r.length)return;let a=n.clientWidth,o=n.clientHeight;for(let n=r.length-1;n>=0;n--){let s=r[n];if(s.life-=e,s.life<=0){s.node.remove(),r.splice(n,1);continue}let c=1-s.life/Um;i.set(s.x,s.y+c*1.4*Z,s.z).project(t);let l=i.z<1;s.node.style.display=l?`block`:`none`,l&&(s.node.style.transform=`translate(-50%, -50%) translate(${(i.x+1)/2*a}px, ${(1-i.y)/2*o}px)`,s.node.style.opacity=String(Math.min(1,s.life/.4)))}}function s(){r.forEach(e=>e.node.remove()),r.length=0}return{spawn:a,update:o,clear:s}}var Gm=`./`,Km=e=>`${Gm}sprites/${e}.png`,qm=document.getElementById(`scene`),Jm=document.getElementById(`app`),Ym=document.getElementById(`boot`),Xm=new od({canvas:qm,antialias:!1,powerPreference:`high-performance`}),Zm=$p();Xm.setPixelRatio(Math.min(window.devicePixelRatio,Zm.maxPixelRatio)),Xm.shadowMap.enabled=Zm.shadows,Xm.shadowMap.type=2,Xm.toneMapping=4,Xm.toneMappingExposure=1.15,Xm.outputColorSpace=Le,Xm.setSize(window.innerWidth,window.innerHeight);var Qm=new Mn;Qm.background=new J(329226);var $m=new Es(16777215,1);Qm.add($m);var eh=new us(14674175,5261626,.85);Qm.add(eh);var th=new Ts(16773846,1.35);th.position.set(26*Z,40*Z,20*Z),th.castShadow=!0,th.shadow.mapSize.set(Zm.shadowMap,Zm.shadowMap);var nh=44*Z;th.shadow.camera.left=-nh,th.shadow.camera.right=nh,th.shadow.camera.top=nh,th.shadow.camera.bottom=-nh,th.shadow.camera.far=220*Z,th.shadow.bias=-.0018,Qm.add(th);async function rh(){let e=await wp(),t=e.levels[0];Jd(e.scenes.get(t.scene));let n=up(),{roomLabels:r,markerGroup:i,hidingMarkers:a}=zf(Qm,n),o=pp(n,{radius:.3*Z}),s=e=>e.forEach(e=>{let t=o.snap(e.x,e.z);e.x=t.x,e.z=t.z});s(Vd),Object.values(Hd).forEach(s),s(Ud),s(Gd),s(Wd);let c=new $d(window.innerWidth/window.innerHeight),l=c.camera,u=new gp(Xm,{pixelSize:Xp().pixelSize,levels:Xp().colorLevels});u.setSize(window.innerWidth,window.innerHeight);let d=e.characters,f=new Set([d.player.sheet,d.boss.sheet,...Object.values(d.minions??{}).map(e=>e.sheet),...Kd.map(e=>e.sheet)]),p=new Map;await Promise.all([...f].map(async e=>p.set(e,await Ap(Km(e)))));let m=new Mp(p.get(d.player.sheet),{x:Ld.x,z:Ld.z,radius:d.player.radius,height:d.player.height,speed:d.player.speed});Qm.add(m.object3D);let h=Kd.map(t=>{let n=d.npcs[t.sheet]??{},r=e.dialogues.cast[t.cast],i=new Np(p.get(r?.sheet??t.sheet)??p.values().next().value,{...t,radius:n.radius,height:n.height});return i.cast=t.cast??null,i.displayName=r?.name??n.name??`Compañero`,i.talkCooldown=e.dialogues.encounters[t.cast]?.cooldown??40,i});h.forEach(e=>Qm.add(e.object3D));let g=new Vp(p.get(d.boss.sheet),{world:n,route:Vd,navmesh:o,radius:d.boss.radius,height:d.boss.height,speeds:d.boss.speeds,visionRange:d.boss.visionRange,visionHalfAngleDeg:d.boss.visionHalfAngleDeg});Qm.add(g.object3D),Qm.add(g.cone);let _={chispita:15910724,washo:4579536,crispo:12616791},v=new Map;for(let[t,r]of Object.entries(d.minions??{})){let i=new Vp(p.get(r.sheet),{world:n,route:Hd[t]??Vd,navmesh:o,role:`minion`,name:r.name??t,coneColor:_[t]??10466505,radius:r.radius,height:r.height,speeds:r.speeds,visionRange:r.visionRange,visionHalfAngleDeg:r.visionHalfAngleDeg});i.cast=t,i.id=t,i.displayName=r.name??t,i.talkCooldown=e.dialogues.encounters[t]?.cooldown??35,i.setActive(!1),Qm.add(i.object3D),Qm.add(i.cone),v.set(t,i)}let y=Wm(Jm,l),b=Vm({app:Jm,renderer:Xm,scene:Qm,lights:{ambient:$m,hemi:eh,key:th},player:m,boss:g,npcs:h,camera:c,levels:e.levels,codeEggs:e.codeEggs,manifest:e.manifest,dialogues:e.dialogues,minions:v,onPopup:e=>y.spawn(e)}),x=!1;function S(){x=!x,document.body.classList.toggle(`inspect-mode`,x)}Hm(m,Jm,{onZoom:e=>c.zoomBy(e),onInspect:S,onPause:()=>b.openPause()}),window.addEventListener(`wheel`,e=>{b.dialogue.isOpen||b.menus.isOpen||c.zoomBy(-e.deltaY*.0012)},{passive:!0});let C=null,w={x:0,y:0};qm.addEventListener(`contextmenu`,e=>e.preventDefault()),qm.addEventListener(`pointerdown`,e=>{e.button!==2||b.menus.isOpen||(C=e.pointerId,w={x:e.clientX,y:e.clientY},qm.setPointerCapture(e.pointerId))}),qm.addEventListener(`pointermove`,e=>{e.pointerId===C&&(c.orbitBy((e.clientX-w.x)*.25,-(e.clientY-w.y)*.2),w={x:e.clientX,y:e.clientY})});let T=e=>{e.pointerId===C&&(C=null)};qm.addEventListener(`pointerup`,T),qm.addEventListener(`pointercancel`,T);let E=null,D=0,O=null,k=e=>Math.hypot(e[0].clientX-e[1].clientX,e[0].clientY-e[1].clientY),A=e=>({x:(e[0].clientX+e[1].clientX)/2,y:(e[0].clientY+e[1].clientY)/2});qm.addEventListener(`touchstart`,e=>{e.touches.length===2&&(E=k(e.touches),D=c.framing,O=A(e.touches))},{passive:!0}),qm.addEventListener(`touchmove`,e=>{if(e.touches.length!==2||!E)return;let t=k(e.touches),n=A(e.touches),r=Math.abs(t/E-1),i=Math.hypot(n.x-O.x,n.y-O.y);r*400>i?c.setFraming(D+(t/E-1)*.9):c.orbitBy((n.x-O.x)*.3,-(n.y-O.y)*.25),O=n},{passive:!0}),qm.addEventListener(`touchend`,e=>{e.touches.length<2&&(E=null)},{passive:!0});function j(){let e=window.innerWidth,t=window.innerHeight;Xm.setSize(e,t),u.setSize(e,t),c.setAspect(e/t)}window.addEventListener(`resize`,j),window.addEventListener(`keydown`,e=>{e.key.toLowerCase()===`m`&&!b.dialogue.isOpen&&!b.menus.isOpen&&S()});let ee=0;document.addEventListener(`touchend`,e=>{let t=Date.now();t-ee<320&&e.preventDefault(),ee=t},{passive:!1}),[`gesturestart`,`gesturechange`,`gestureend`].forEach(e=>document.addEventListener(e,e=>e.preventDefault(),{passive:!1})),document.addEventListener(`dblclick`,e=>e.preventDefault(),{passive:!1}),Qp(e=>{u.setPixelSize(e.pixelSize),u.setLevels(e.colorLevels),i&&(i.visible=e.showMarkers);let t=$p(e.quality);Xm.setPixelRatio(Math.min(window.devicePixelRatio,t.maxPixelRatio)),Xm.shadowMap.enabled=t.shadows,th.shadow.mapSize.x!==t.shadowMap&&(th.shadow.mapSize.set(t.shadowMap,t.shadowMap),th.shadow.map?.dispose(),th.shadow.map=null),Qm.traverse(e=>{(e.isMesh||e.isInstancedMesh)&&(e.castShadow=e.castShadow&&t.shadows)}),Xm.setSize(window.innerWidth,window.innerHeight),u.setSize(window.innerWidth,window.innerHeight)});let M=0,N=!1;function P(e){N||Xp().quality!==`auto`||(M=e>.033?M+1:Math.max(0,M-1),M>180&&(N=!0,Zp({quality:`bajo`,pixelSize:Math.max(2,Xp().pixelSize)}),console.info(`Calidad reducida automáticamente para mantener la fluidez.`)))}let F=7*Z,te=13*Z,ne=46*Z,re=new G;function ie(){let e=!c.isFollowing,t=Xp().showLabels;r.forEach(n=>{let r=n.userData.priority??2,i;if(!t&&!x)i=0;else if(x||r===1)i=1;else if(r>=3)i=0;else if(e)i=1;else{let e=Math.hypot(n.userData.homeX-m.position.x,n.userData.homeZ-m.position.z);i=Et.clamp((te-e)/(te-F),0,1)}n.material.opacity=i,n.visible=i>.02;let a=n.userData.baseScale;if(a&&n.visible){n.getWorldPosition(re);let e=Et.clamp(l.position.distanceTo(re)/ne,.35,1.6);n.scale.set(a.x*e,a.y*e,1)}})}let ae=new J(5025642),oe=new J(5594990);function se(){let e=b.game;!e||!a||a.forEach((t,n)=>{let r=e.hidingCharge(n);t.material.color.copy(oe).lerp(ae,r),t.material.opacity=.28+r*.62,t.scale.setScalar(.82+r*.18)})}let I=[];Qm.traverse(e=>{e.userData&&e.userData.bob&&I.push(e)}),Ym?.remove(),b.start();let ce=performance.now();function le(e){let t=Math.min((e-ce)/1e3,.05);ce=e;let r=e/1e3;b.isPaused||(m.update(t,n),h.forEach(e=>e.update(t,r))),b.update(t),I.forEach(e=>{let t=e.userData.bob;e.position.y=t.base+Math.sin(r*t.speed+t.offset)*t.amp,e.rotation.y=r*.6+t.offset}),P(t),se(),ie(),c.update(t,m.position),y.update(t),u.render(Qm,l),requestAnimationFrame(le)}requestAnimationFrame(le),window.__game={world:n,navmesh:o,player:m,boss:g,engine:b,camera:l,scene:Qm,view:c,pixels:u,data:e},window.__floorplan=Ad}rh().catch(e=>{console.error(e);let t=document.createElement(`div`);t.className=`boot-error`,t.innerHTML=`<b>No se pudo iniciar el juego</b><br>${e.message??e}`,(Ym??Jm).replaceChildren(t)});