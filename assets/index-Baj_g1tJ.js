...
`,gp=class{constructor(e,{pixelSize:t=2,levels:n=24,saturation:r=1.12}={}){this.renderer=e,this.pixelSize=t,this.enabled=t>1,this.target=new Kt(1,1,{minFilter:a,magFilter:a,depthBuffer:!0,stencilBuffer:!1,colorSpace:Le}),this.material=new Lo({uniforms:{tDiffuse:{value:this.target.texture},uResolution:{value:new W(1,1)},uLevels:{value:n},uSaturation:{value:r}},vertexShader:mp,fragmentShader:hp,depthTest:!1,depthWrite:!1}),this.quadScene=new Mn,this.quadCamera=new Cs(-1,1,1,-1,0,1),this.quadScene.add(new mi(new Eo(2,2),this.material)),this.size=new W(1,1)}setSize(e,t){this.size.set(e,t),this._resizeTarget()}setPixelSize(e){this.pixelSize=Math.max(1,Math.round(e)),this.enabled=this.pixelSize>1,this._resizeTarget()}setLevels(e){this.material.uniforms.uLevels.value=e}_resizeTarget(){let e=Math.max(1,Math.floor(this.size.x/this.pixelSize)),t=Math.max(1,Math.floor(this.size.y/this.pixelSize));this.target.setSize(e,t),this.material.uniforms.uResolution.value.set(e,t)}render(e,t){if(!this.enabled){this.renderer.setRenderTarget(null),this.renderer.render(e,t);return}this.renderer.setRenderTarget(this.target),this.renderer.clear(),this.renderer.render(e,t),this.renderer.setRenderTarget(null),this.renderer.render(this.quadScene,this.quadCamera)}dispose(){this.target.dispose(),this.material.dispose()}},_p=`./`;async function vp(e){let t=await fetch(`${_p}data/${e}`,{cache:`no-cache`});if(!t.ok)throw Error(`No se pudo cargar data/${e} (${t.status})`);try{return await t.json()}catch(t){throw Error(`data/${e} no es JSON válido: ${t.message}`)}}var yp=e=>({...e,x:e.x*Z,z:e.z*Z}),bp=e=>({...e,x:e.x*Z,z:e.z*Z,w:e.w*Z,d:e.d*Z});function xp(e,t,n){if(e[t]==null)throw Error(`${n}: falta el campo "${t}"`);return e[t]}function Sp(e){let t=`escena "${e.id??`?`}"`,n=xp(e,`areas`,t).map(e=>(e.capacity??=0,bp(e)));return{id:e.id,name:e.name,areas:n,areaById:new Map(n.map(e=>[e.id,e])),footprint:xp(e,`footprint`,t).map(([e,t])=>[e*Z,t*Z]),spawn:yp(xp(e,`spawn`,t)),entrance:{...e.entrance,x:e.entrance.x*Z,z:e.entrance.z*Z,w:e.entrance.w*Z},corridors:(e.corridors??[]).map(bp),plants:(e.props??[]).filter(e=>e.type===`plant`).map(yp),props:(e.props??[]).map(yp),patrolRoute:(e.routes?.jefe??xp(e,`patrol`,t)).map(yp),routes:Object.fromEntries(Object.entries(e.routes??{jefe:e.patrol??[]}).map(([e,t])=>[e,t.map(yp)])),activityStations:(e.activities??[]).map(yp),hidingSpots:(e.hidingSpots??[]).map(e=>({...yp(e),r:(e.r??1.3)*Z})),distractions:(e.distractions??[]).map(e=>({...yp(e),radius:(e.radius??1.2)*Z})),npcs:(e.npcs??[]).map(yp),locationEggs:(e.eggs??[]).map(e=>({...yp(e),radius:(e.radius??2)*Z}))}}function Cp(e){let t=e=>({...e,height:(e.height??1.45)*Z,radius:(e.radius??.28)*Z,speed:e.speed==null?void 0:e.speed*Z,visionRange:e.visionRange==null?void 0:e.visionRange*Z,speeds:e.speeds?Object.fromEntries(Object.entries(e.speeds).map(([e,t])=>[e,t*Z])):void 0});return{player:t(e.player),boss:t(e.boss),minions:Object.fromEntries(Object.entries(e.minions??{}).map(([e,n])=>[e,t(n)])),npcs:Object.fromEntries(Object.entries(e.npcs??{}).map(([e,n])=>[e,t(n)]))}}async function wp(){let e=await vp(`manifest.json`),[t,n,r,i]=await Promise.all([vp(e.characters??`characters.json`),vp(e.dialogues??`dialogues.json`).catch(()=>({cast:{},encounters:{},barks:{}})),Promise.all((e.scenes??[]).map(e=>vp(`scenes/${e}.json`))),Promise.all((e.levels??[]).map(e=>vp(`levels/${e}.json`)))]),a=new Map(r.map(e=>[e.id,Sp(e)]));if(!a.size)throw Error(`manifest.json no declara ninguna escena`);let o=i.map((e,t)=>({...e,number:e.number??t+1,scene:e.scene??r[0].id,rules:e.rules??{}}));if(!o.length)throw Error(`manifest.json no declara ningún nivel`);for(let e of o)if(!a.has(e.scene))throw Error(`El nivel "${e.id}" apunta a la escena "${e.scene}", que no existe`);return{manifest:e,dialogues:{cast:n.cast??{},encounters:n.encounters??{},barks:n.barks??{}},characters:Cp(t),scenes:a,levels:o,codeEggs:e.codeEggs??[]}}var Tp={south:0,west:1,east:2,north:3},Ep=32/44,Dp=8,Op=new cs,kp=new Map;function Ap(e){return kp.has(e)||kp.set(e,new Promise((t,n)=>{Op.load(e,e=>{e.colorSpace=Le,e.magFilter=a,e.minFilter=a,e.generateMipmaps=!1,t(e)},void 0,n)})),kp.get(e)}var jp=class{constructor(e,{height:t=1.5,y:n=0}={}){this.texture=e.clone(),this.texture.needsUpdate=!0,this.texture.repeat.set(1/4,1/4),this.material=new Mr({map:this.texture,transparent:!0,alphaTest:.4,depthWrite:!0,toneMapped:!1}),this.object=new Kr(this.material),this.height=t,this.object.scale.set(t*Ep,t,1),this.baseY=n+t/2,this.object.position.y=this.baseY,this.facing=`south`,this.frame=0,this._timer=0,this._moving=!1,this._applyFrame()}setFacing(e){e&&e!==this.facing&&Tp[e]!==void 0&&(this.facing=e,this._applyFrame())}setMoving(e){e!==this._moving&&(this._moving=e,e||(this.frame=0,this._timer=0,this._applyFrame()))}setPosition(e,t){this.object.position.x=e,this.object.position.z=t}setTint(e){this.material.color.setScalar(e)}update(e){if(!this._moving)return;this._timer+=e;let t=1/Dp;for(;this._timer>=t;)this._timer-=t,this.frame=(this.frame+1)%4,this._applyFrame()}_applyFrame(){let e=Tp[this.facing]??0;this.texture.offset.set(this.frame/4,1-(e+1)/4)}},Mp=class{constructor(e,{x:t=0,z:n=12.6,radius:r=.26*Z,height:i=1.45*Z,speed:a=4.4*Z}={}){this.speed=a,this.radius=r,this.position={x:t,z:n},this.keys=new Set,this.touchAxis={x:0,z:0},this.speedMul=1,this.isHiding=!1,this.isPretending=!1,this.isDoingActivity=!1,this.facing=`south`,this.sprite=new jp(e,{height:i}),this.sprite.setPosition(t,n),this._onKeyDown=e=>{let t=e.key.toLowerCase();this.keys.add(t),[`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,` `].includes(t)&&e.preventDefault()},this._onKeyUp=e=>this.keys.delete(e.key.toLowerCase()),window.addEventListener(`keydown`,this._onKeyDown),window.addEventListener(`keyup`,this._onKeyUp)}get object3D(){return this.sprite.object}_readInput(){let e=this.touchAxis.x,t=this.touchAxis.z;if(Math.hypot(e,t)>.08)return{right:e,up:-t};let n=0,r=0;return(this.keys.has(`w`)||this.keys.has(`arrowup`))&&(r+=1),(this.keys.has(`s`)||this.keys.has(`arrowdown`))&&--r,(this.keys.has(`a`)||this.keys.has(`arrowleft`))&&--n,(this.keys.has(`d`)||this.keys.has(`arrowright`))&&(n+=1),{right:n,up:r}}update(e,t){let{right:n,up:r}=this._readInput(),i=Math.min(Math.hypot(n,r),1),a=!1;if(i>.001){let{dx:t,dz:o}=Od(n,r),s=Math.hypot(t,o)||1,c=(this.isPretending?.45:1)*this.speedMul,l=this.speed*c*i*e;this.position.x+=t/s*l,this.position.z+=o/s*l,this.facing=kd(t,o,this.facing),a=!0}t&&t.resolveCircle(this.position,this.radius),this.sprite.setFacing(this.facing),this.sprite.setMoving(a&&!this.isPretending),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.setTint(this.isHiding?.6:1),this.sprite.update(e)}dispose(){window.removeEventListener(`keydown`,this._onKeyDown),window.removeEventListener(`keyup`,this._onKeyUp)}},Np=class{constructor(e,{id:t,x:n,z:r,radius:i=.28*Z,height:a=1.4*Z,facing:o=`south`,sway:s=0}={}){this.id=t,this.position={x:n,z:r},this.home={x:n,z:r},this.radius=i,this.sway=s*Z,this.sprite=new jp(e,{height:a}),this.sprite.setFacing(o),this.sprite.setPosition(n,r),this._phase=Math.random()*Math.PI*2}get object3D(){return this.sprite.object}update(e,t){if(this.sway>0){let e=Math.sin(t*.6+this._phase)*this.sway,n=this.position.x;this.position.x=this.home.x+e,this.sprite.setFacing(this.position.x>=n?`east`:`west`),this.sprite.setMoving(Math.abs(this.position.x-n)>5e-4),this.sprite.setPosition(this.position.x,this.position.z)}this.sprite.update(e)}},Pp={PATROL:`PATROL`,INVESTIGATE:`INVESTIGATE`,CHASE:`CHASE`,SEARCH:`SEARCH`},{PATROL:Fp,INVESTIGATE:Ip,CHASE:Lp,SEARCH:Rp}=Pp;function zp(e,t){return Math.atan2(-e,-t)}function Bp(e,t,n=24){let r=[];for(let i=0;i<n;i++){let a=-t+2*t*(i/n),o=-t+2*t*((i+1)/n);r.push(0,0,0),r.push(Math.sin(a)*e,0,-Math.cos(a)*e),r.push(Math.sin(o)*e,0,-Math.cos(o)*e)}let i=new Er;return i.setAttribute(`position`,new mr(r,3)),i}var Vp=class{constructor(e,{world:t,route:n,navmesh:r=null,radius:i=.3*Z,height:a=1.55*Z,speeds:o={},visionRange:s=7.5*Z,visionHalfAngleDeg:c=30,speedMul:l=1,role:u=`boss`,name:d=`Jefe`,coneColor:f=15910724,onSpot:p=null}){this.role=u,this.name=d,this.onSpot=p,this._reportCooldown=0,this.world=t,this.navmesh=r,this.route=n,this.routeIndex=0,this.position={x:n[0].x,z:n[0].z},this.radius=i,this.facingDir={x:0,z:-1},this._path=null,this._pathTarget=null,this._repathTimer=0,this.state=Fp,this.baseSpeeds={patrol:o.patrol??2.4*1.2,investigate:o.investigate??3.2*1.2,chase:o.chase??4.9*1.2,search:o.search??3*1.2},this.speed=this.baseSpeeds.patrol*l,this.investigateSpeed=this.baseSpeeds.investigate*l,this.chaseSpeed=this.baseSpeeds.chase*l,this.searchSpeed=this.baseSpeeds.search*l,this.investigateTarget=null,this.investigateTimer=0,this.searchTarget=null,this.searchTimer=0,this.loseSightTimer=0,this.lastSeenPlayerPos=null,this.baseVisionRange=s,this.visionRange=s,this.halfAngle=Et.degToRad(c),this.playerVisible=!1,this.redAlert=!1,this.sprite=new jp(e,{height:a}),this.sprite.setPosition(this.position.x,this.position.z);let m=Bp(this.visionRange,this.halfAngle);this.baseConeColor=f,this.coneMaterial=new ni({color:f,transparent:!0,opacity:.55,side:2,depthWrite:!1,toneMapped:!1}),this.cone=new mi(m,this.coneMaterial),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.renderOrder=2;let h=new qi(new oa(m,1),new Fi({color:16777215,transparent:!0,opacity:.45,toneMapped:!1}));this.cone.add(h)}get object3D(){return this.sprite.object}get isHunting(){return this.state===Lp||this.state===Rp}startChase(){this.state=Lp,this.loseSightTimer=0}distract(e,t){return this.state===Lp?!1:(this.state=Ip,this.investigateTarget={x:e.x,z:e.z},this.investigateTimer=t,!0)}catches(e,t){return this.role!==`minion`&&Math.hypot(e.x-this.position.x,e.z-this.position.z)<this.radius+t+.25*Z}setRoute(e,t=0){this.route=e,this.routeIndex=Math.min(t,e.length-1),this.position.x=e[this.routeIndex].x,this.position.z=e[this.routeIndex].z,this._path=null,this.resetToPatrol()}setActive(e){this.active=e,this.sprite.object.visible=e,this.cone.visible=e}resetToPatrol(){this.state=Fp,this.loseSightTimer=0,this.searchTimer=0,this.lastSeenPlayerPos=null}update(e,t,n){if(this.active===!1)return;this._reportCooldown>0&&(this._reportCooldown-=e),this._updateVision(t,n),this.role===`minion`&&this.redAlert&&this._reportCooldown<=0&&(this._reportCooldown=8,this.onSpot?.(this,{x:t.position.x,z:t.position.z})),this._advanceState(e,t);let r=this._pickTarget(t),i=this._moveToward(e,this._steer(e,r));if(i)this.facingDir=i;else if(this.playerVisible){let e=t.position.x-this.position.x,n=t.position.z-this.position.z,r=Math.hypot(e,n);r>.001&&(this.facingDir={x:e/r,z:n/r})}this.sprite.setFacing(kd(this.facingDir.x,this.facingDir.z,`south`)),this.sprite.setMoving(!!i),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.update(e),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.rotation.y=zp(this.facingDir.x,this.facingDir.z);let a=this.redAlert||this.state===Lp;this.coneMaterial.color.set(a?15091775:this.state===Rp?14721084:this.baseConeColor),this.coneMaterial.opacity=a?.68:.55}_advanceState(e,t){switch(this.state){case Lp:this.playerVisible?this.loseSightTimer=0:(this.loseSightTimer+=e,this.loseSightTimer>1.2&&(this.state=Rp,this.searchTarget=this.lastSeenPlayerPos??{...this.position},this.searchTimer=5));break;case Rp:this.searchTimer-=e,this.playerVisible?this.startChase():this.searchTimer<=0&&this._resumeNearestRoutePoint();break;case Ip:this.investigateTimer-=e,this.playerVisible&&t.isDoingActivity?this.startChase():(this.investigateTimer<=0||this._reached(this.investigateTarget))&&this._resumeNearestRoutePoint();break;default:this.redAlert?this.startChase():this._reached(this.route[this.routeIndex])&&(this.routeIndex=(this.routeIndex+1)%this.route.length);break}}_resumeNearestRoutePoint(){let e=0,t=1/0;this.route.forEach((n,r)=>{let i=Math.hypot(n.x-this.position.x,n.z-this.position.z);i<t&&(t=i,e=r)}),this.routeIndex=e,this.state=Fp,this.searchTimer=0,this.loseSightTimer=0}_pickTarget(e){return this.state===Lp?e.isHiding?this.lastSeenPlayerPos??this.route[this.routeIndex]:{x:e.position.x,z:e.position.z}:this.state===Rp?this.searchTarget??this.route[this.routeIndex]:this.state===Ip?this.investigateTarget:this.route[this.routeIndex]}_steer(e,t){if(!t||!this.navmesh)return t;if(this._repathTimer-=e,this.world&&!this.world.lineBlocked(this.position,t))return this._path=null,t;let n=!this._pathTarget||Math.hypot(this._pathTarget.x-t.x,this._pathTarget.z-t.z)>1.2*1.2;if((!this._path||n||this._repathTimer<=0)&&(this._path=this.navmesh.path(this.position,t),this._pathTarget={x:t.x,z:t.z},this._repathTimer=.5),!this._path||!this._path.length)return t;for(;this._path.length>1&&Math.hypot(this._path[0].x-this.position.x,this._path[0].z-this.position.z)<.6*1.2;)this._path.shift();return this._path[0]}_reached(e,t=.4*Z){return!e||Math.hypot(e.x-this.position.x,e.z-this.position.z)<t}_speed(){return this.state===Lp?this.chaseSpeed:this.state===Rp?this.searchSpeed:this.state===Ip?this.investigateSpeed:this.speed}_moveToward(e,t){if(!t)return null;let n=t.x-this.position.x,r=t.z-this.position.z,i=Math.hypot(n,r);if(i<.06*1.2)return null;let a=n/i,o=r/i,s=this._speed()*e,c={x:this.position.x,z:this.position.z};if(this.position.x+=a*s,this.position.z+=o*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)<s*.3){for(let[e,t]of[[a,0],[0,o]])if(this.position.x=c.x+e*s,this.position.z=c.z+t*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)>s*.3)break}let l=this.position.x-c.x,u=this.position.z-c.z;return Math.hypot(l,u)<1e-4?null:{x:a,z:o}}_updateVision(e,t){if(this.playerVisible=!1,this.redAlert=!1,e.isHiding)return;let n=e.position.x-this.position.x,r=e.position.z-this.position.z,i=Math.hypot(n,r);if(i>this.visionRange||i<.001)return;let a={x:n/i,z:r/i};if(this.facingDir.x*a.x+this.facingDir.z*a.z<Math.cos(this.halfAngle))return;let o=t.map(e=>({x:e.position.x,z:e.position.z,radius:e.radius}));this.world&&this.world.lineBlocked(this.position,e.position,o)||(this.playerVisible=!0,this.lastSeenPlayerPos={x:e.position.x,z:e.position.z},e.isDoingActivity&&!e.isPretending&&(this.redAlert=!0))}},Hp=`modo-incognito:settings:v1`,Up={auto:{label:`Auto`},alto:{label:`Alto`,shadows:!0,shadowMap:2048,maxPixelRatio:2},medio:{label:`Medio`,shadows:!0,shadowMap:1024,maxPixelRatio:1.5},bajo:{label:`Bajo`,shadows:!1,shadowMap:512,maxPixelRatio:1}},Wp={quality:{label:`Calidad gráfica`,type:`choice`,options:[`auto`,`alto`,`medio`,`bajo`],hint:`Auto baja sola si el dispositivo no da abasto`},pixelSize:{label:`Tamaño de píxel`,type:`range`,min:1,max:6,step:1,hint:`1 = 3D nítido · 4+ = pixel art grueso`},colorLevels:{label:`Niveles de color`,type:`range`,min:6,max:64,step:2,hint:`Menos niveles = paleta más marcada`},showLabels:{label:`Rótulos de zona`,type:`toggle`},showMarkers:{label:`Marcas de suelo`,type:`toggle`},vibration:{label:`Vibración (móvil)`,type:`toggle`},screenShake:{label:`Sacudida de cámara`,type:`toggle`}},Gp=Object.freeze({quality:`auto`,pixelSize:2,colorLevels:24,showLabels:!0,showMarkers:!0,vibration:!0,screenShake:!0});function Kp(e){let t={...Gp,...e};for(let[e,n]of Object.entries(Wp))if(n.type===`range`){let r=Number(t[e]);t[e]=Number.isFinite(r)?Math.min(n.max,Math.max(n.min,r)):Gp[e]}else n.type===`choice`?t[e]=n.options.includes(t[e])?t[e]:Gp[e]:t[e]=!!t[e];return t}function qp(){try{let e=localStorage.getItem(Hp);return Kp(e?JSON.parse(e):{})}catch{return{...Gp}}}var Jp=qp(),Yp=new Set;function Xp(){return Jp}function Zp(e){Jp=Kp({...Jp,...e});try{localStorage.setItem(Hp,JSON.stringify(Jp))}catch{}return Yp.forEach(e=>e(Jp)),Jp}function Qp(e){return Yp.add(e),e(Jp),()=>Yp.delete(e)}function $p(e=Jp.quality){if(e!==`auto`)return Up[e]??Up.medio;let t=matchMedia(`(pointer: coarse)`).matches,n=(navigator.deviceMemory??8)<=4,r=(navigator.hardwareConcurrency??8)<=4;return t||n||r?Up.medio:Up.alto}function em(e=12){Jp.vibration&&navigator.vibrate?.(e)}var tm=100,nm=45,rm=12,im=16,am=1.5*Z,om=7,sm=22,cm=.5,lm=4,um=11*Z,dm=.8,fm=1.4,pm=15,mm={duration:240,maxWarnings:3,objectives:null,decayMul:1,distractionsOff:!1,targetScore:1e3},hm=class{constructor({player:e,boss:t,npcs:n,minions:r=[],hud:i,rules:a={},onFinish:o=null,onEgg:s=null,onPopup:c=null,onTalk:l=null}){this.player=e,this.boss=t,this.npcs=n,this.minions=r,this.onTalk=l,this.hud=i,this.rules={...mm,...a},this.onFinish=o,this.onEgg=s,this.onPopup=c,this.suspicion=0,this.warnings=0,this.timeLeft=this.rules.duration,this.gameOver=!1,this.win=!1,this.paused=!1,this._finished=!1,this.score=0,this.combo=1,this.comboLeft=0,this.perk=null,this.perkLeft=0,this.revealBossUntil=0;let u=this.rules.objectives;this.objectives=Ud.filter(e=>!u||u.includes(e.id)).map(e=>({...e,progress:0,done:!1})),this.distractionState=this.rules.distractionsOff?[]:Gd.map(e=>({...e,cooldownLeft:0})),this.nearStation=null,this.nearDistraction=null,this.nearNpc=null,this.focusStation=null,this.message=null,this.currentArea=null,this.talkCooldowns=new Map,this._prevInteractKey=!1,this._caughtCooldown=0,this._eggDwell=new Map,this._foundEggs=new Set}setPaused(e){this.paused=e,e&&(this.player.keys.clear(),this.player.touchAxis.x=0,this.player.touchAxis.z=0)}update(e){if(this.gameOver||this.paused){this.hud.render(this._snapshot());return}this.timeLeft=Math.max(0,this.timeLeft-e),this._caughtCooldown>0&&(this._caughtCooldown-=e),this.revealBossUntil>0&&(this.revealBossUntil-=e),this.comboLeft>0&&(this.comboLeft=Math.max(0,this.comboLeft-e),this.comboLeft===0&&(this.combo=1)),this.perkLeft>0&&(this.perkLeft=Math.max(0,this.perkLeft-e),this.perkLeft===0&&this._clearPerk());let t=this.player.position;this.currentArea=Yd(t.x,t.z)??Xd(t.x,t.z).area,this.player.isHiding=Wd.some(e=>Math.hypot(e.x-t.x,e.z-t.z)<e.r);let n=this.player.keys.has(`e`),r=this.player.keys.has(`f`);if(this.player.isPretending=r,this.nearStation=this.objectives.find(e=>!e.done&&Math.hypot(e.x-t.x,e.z-t.z)<am)??null,this.focusStation=this.objectives.filter(e=>!e.done).reduce((e,n)=>{let r=Math.hypot(n.x-t.x,n.z-t.z);return!e||r<e._d?Object.assign(n,{_d:r}):e},null),this.nearStation&&n&&!r?(this.player.isDoingActivity=!0,this.nearStation.progress=Math.min(this.nearStation.time,this.nearStation.progress+e),this.nearStation.progress>=this.nearStation.time&&!this.nearStation.done&&(this.nearStation.done=!0,this._completeActivity(this.nearStation))):this.player.isDoingActivity=!1,this.distractionState.forEach(t=>{t.cooldownLeft>0&&(t.cooldownLeft=Math.max(0,t.cooldownLeft-e))}),this.nearDistraction=this.distractionState.find(e=>e.cooldownLeft<=0&&Math.hypot(e.x-t.x,e.z-t.z)<am)??null,this.talkCooldowns.forEach((t,n)=>{t>0&&this.talkCooldowns.set(n,Math.max(0,t-e))}),this.nearNpc=this.npcs.find(e=>e.cast&&(this.talkCooldowns.get(e.id)??0)<=0&&Math.hypot(e.position.x-t.x,e.position.z-t.z)<am*1.3)??null,n&&!this._prevInteractKey&&this.nearNpc&&!this.nearStation){let e=this.nearNpc;this.talkCooldowns.set(e.id,e.talkCooldown??40),this.onTalk?.(e)}else if(n&&!this._prevInteractKey&&this.nearDistraction&&!this.nearStation){let e={x:this.nearDistraction.x,z:this.nearDistraction.z};this.boss.distract(e,om)?(this.nearDistraction.cooldownLeft=this.nearDistraction.cooldown,this._toast(`Distracción: ${this.nearDistraction.label}`),this._award(40,`Distracción`,this.player.position)):this._toast(`¡Ya te vio! Una distracción no lo detiene ahora.`)}this._prevInteractKey=n,this.boss.update(e,this.player,this.npcs),this.minions.forEach(t=>t.update(e,this.player,this.npcs)),this._updateEggs(e);let i=this.minions.some(e=>e.redAlert),a=this.rules.decayMul;if(i&&!this.boss.redAlert&&(this.suspicion=Math.min(tm,this.suspicion+12*e)),this.boss.redAlert){let t=this.nearStation?.riskRate??20;this.suspicion=Math.min(tm,this.suspicion+t*e)}else this.boss.state===Pp.CHASE&&this.boss.playerVisible?this.suspicion=Math.min(tm,this.suspicion+im*e):this.player.isHiding||this.player.isPretending?this.suspicion=Math.max(0,this.suspicion-nm*a*e):this.suspicion=Math.max(0,this.suspicion-rm*a*e);let o=this._caughtCooldown<=0&&this.boss.isHunting&&!this.player.isHiding&&this.boss.catches(t,this.player.radius);(this.suspicion>=tm||o)&&this._warn(),this.gameOver||(this.objectives.every(e=>e.done)?this._finish(!0):this.timeLeft<=0&&this._finish(!1)),this.message&&(this.message.timer-=e,this.message.timer<=0&&(this.message=null)),this.hud.render(this._snapshot())}_completeActivity(e){let t=Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),n=0,r=``;this.boss.playerVisible?(n=fm,r=` · ¡EN SUS NARICES!`):t<um&&(n=dm,r=` · con el jefe cerca`);let i=e.points??120,a=Math.round(i*(this.combo+n));this.score+=a,this.combo=Math.min(lm,this.combo+cm),this.comboLeft=sm,e.perk&&this._applyPerk(e.perk),em([12,40,18]),this._toast(`${e.label} ✔${r}`),this.onPopup?.({text:`+${a}`,sub:this.combo>1?`x${this.combo.toFixed(1)}`:``,x:e.x,z:e.z,kind:n?`nerve`:`score`})}_award(e,t,n){let r=Math.round(e*this.combo);this.score+=r,this.onPopup?.({text:`+${r}`,sub:t,x:n.x,z:n.z,kind:`minor`})}_applyPerk(e){this._clearPerk(),this.perk=e,this.perkLeft=pm,e===`caffeine`&&(this.player.speedMul=1.35,this._toast(`☕ Cafeína: +35% de velocidad`))}_clearPerk(){this.perk===`caffeine`&&(this.player.speedMul=1),this.perk=null}_updateEggs(e){if(!this.onEgg)return;let t=this.player.position;for(let n of qd){if(this._foundEggs.has(n.id))continue;let r=Math.hypot(n.x-t.x,n.z-t.z)<n.radius,i=(this._eggDwell.get(n.id)??0)+(r?e:-e*2);this._eggDwell.set(n.id,Math.max(0,i)),i>=n.dwell&&(this._foundEggs.add(n.id),this.score+=250,this.onEgg(n))}}_warn(){this.warnings+=1,this.suspicion=0,this._caughtCooldown=3,this.combo=1,this.comboLeft=0,this.boss.resetToPatrol(),em([40,60,40]),this.warnings>=this.rules.maxWarnings?(this._toast(`Última advertencia: despedida.`),this._finish(!1)):this._toast(`Advertencia ${this.warnings}/${this.rules.maxWarnings}`)}_finish(e){this._finished||(this._finished=!0,this.gameOver=!0,this.win=e,this._clearPerk(),e&&(this.score+=Math.round(this.timeLeft*4)),this.onFinish?.({win:e,score:this.score,targetScore:this.rules.targetScore,warnings:this.warnings,timeLeft:this.timeLeft,elapsed:this.rules.duration-this.timeLeft,objectives:this.objectives,eggsFound:this._foundEggs.size}))}applyEffect(e){switch(e){case`suspicion-`:this.suspicion=Math.max(0,this.suspicion-45),this._toast(`La sospecha baja`);break;case`suspicion+`:this.suspicion=Math.min(tm,this.suspicion+30),this._toast(`Alguien levantó la voz…`);break;case`score+`:this._award(120,`Buena conversación`,this.player.position);break;case`speed+`:this._applyPerk(`caffeine`);break;case`reveal-boss`:this.revealBossUntil=12,this._toast(`Sabes dónde está el jefe`);break;default:break}}_toast(e){this.message={text:e,timer:2.6}}_snapshot(){return this.lastSnapshot={suspicion:this.suspicion,suspicionMax:tm,warnings:this.warnings,maxWarnings:this.rules.maxWarnings,timeLeft:this.timeLeft,levelDuration:this.rules.duration,objectives:this.objectives,nearStation:this.nearStation,nearDistraction:this.nearDistraction,nearNpc:this.nearNpc,focusStation:this.focusStation,playerPos:this.player.position,bossPos:this.boss.position,bossDistance:Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),minionAlert:this.minions.some(e=>e.redAlert),revealBoss:this.revealBossUntil>0,isPretending:this.player.isPretending,isHiding:this.player.isHiding,redAlert:this.boss.redAlert,bossState:this.boss.state,gameOver:this.gameOver,win:this.win,message:this.message,area:this.currentArea,score:this.score,combo:this.combo,comboLeft:this.comboLeft,comboWindow:sm,perk:this.perk,perkLeft:this.perkLeft,perkDuration:pm,targetScore:this.rules.targetScore},this.lastSnapshot}};function gm(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function _m(e){return`#${e.toString(16).padStart(6,`0`)}`}function Q(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n&&n.appendChild(r),r}var vm={[jd.OPEN_OFFICE]:`Trabajo`,[jd.MEETING]:`Sala`,[jd.SOCIAL]:`Social`,[jd.AUDITORIUM]:`Auditorio`,[jd.CORE]:`Servicios`,[jd.ELEVATOR]:`Acceso`},ym={sur:`Ala Sur`,norte:`Ala Norte`,centro:`Centro`};function bm(e){let t=Q(`div`,`hud-root`,e),n=Q(`div`,`hud-location`,t),r=Q(`span`,`hud-loc-wing`,n),i=Q(`span`,`hud-loc-name`,n),a=Q(`span`,`hud-loc-meta`,n),o=Q(`div`,`hud-topbar`,t),s=Q(`div`,`hud-panel hud-objectives`,o),c=Q(`div`,`hud-panel-title`,s);c.innerHTML=`<span class="hud-title-icon">🎯</span> OBJETIVOS DE OCIO`;let l=Q(`div`,`hud-objectives-list`,s),u=Q(`div`,`hud-center`,o),d=Q(`div`,`hud-day-chip`,u),f=Q(`div`,`hud-score`,u),p=Q(`span`,`hud-score-value`,f),m=Q(`span`,`hud-combo`,f),h=Q(`span`,`hud-combo-bar`,m),g=Q(`span`,`hud-combo-text`,m),_=Q(`div`,`hud-perk`,u),v=Q(`div`,`hud-panel hud-suspicion`,u),y=Q(`div`,`hud-panel-title`,v);y.innerHTML=`<span class="hud-title-icon">👁️</span> SOSPECHA`;let b=Q(`div`,`hud-suspicion-fill`,Q(`div`,`hud-suspicion-track`,v)),x=Q(`div`,`hud-suspicion-glint`,b),S=Q(`div`,`hud-warnings`,v),C=[],w=Q(`div`,`hud-panel hud-timer`,o),T=Q(`div`,`hud-panel-title`,w);T.innerHTML=`<span class="hud-title-icon">⏱️</span> JORNADA`;let E=Q(`div`,`hud-timer-value`,w),D=Q(`div`,`hud-timer-fill`,Q(`div`,`hud-timer-track`,w)),O=Q(`div`,`hud-toast`,t),k=Q(`div`,`hud-status-badge`,t),A=Q(`div`,`hud-prompt`,t),j=Q(`span`,`hud-prompt-icon`,A),ee=Q(`span`,`hud-prompt-text`,A),M=Q(`div`,`hud-prompt-ring-fill`,Q(`div`,`hud-prompt-ring`,A)),N=Q(`div`,`hud-legend`,t);N.innerHTML=`
  ...
  `;let P=Q(`div`,`hud-overlay hidden`,t),F=Q(`div`,`hud-overlay-card`,P),te=Q(`div`,`hud-overlay-icon`,F),ne=Q(`div`,`hud-overlay-title`,F),re=Q(`div`,`hud-overlay-score`,F),ie=Q(`div`,`hud-overlay-body`,F),ae=Q(`div`,`hud-overlay-actions`,F),oe=-1;function se(e){d.textContent=`DÍA ${e.number} · ${e.title.toUpperCase()}`}function I(e){t.classList.toggle(`hidden`,!e)}function ce({icon:e,title:t,body:n,win:r,actions:i,rank:a,score:o,target:s}){if(te.textContent=e,ne.textContent=t,ne.classList.toggle(`win`,!!r),ne.classList.toggle(`lose`,!r),re.innerHTML=``,o!=null){let e=Q(`div`,`hud-result-score`,re);if(Q(`span`,`hud-result-points`,e,`${o.toLocaleString(`es`)} pts`),s){let t=Q(`div`,`hud-result-fill`,Q(`div`,`hud-result-track`,e));t.style.width=`${Math.min(100,Math.round(o/s*100))}%`,Q(`span`,`hud-result-target`,e,`objetivo ${s.toLocaleString(`es`)}`)}}if(a){let e=Q(`div`,`hud-rank rank-${a.label}`,re);Q(`span`,`hud-rank-letter`,e,a.label),Q(`span`,`hud-rank-blurb`,e,a.blurb)}ie.textContent=n,ae.innerHTML=``,i.forEach(e=>{let t=Q(`button`,`hud-overlay-btn${e.primary?` primary`:``}`,ae);t.type=`button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick)}),P.classList.remove(`hidden`),document.body.classList.add(`overlay-open`)}function le(){P.classList.add(`hidden`),document.body.classList.remove(`overlay-open`)}function ue(e){e.maxWarnings!==oe&&(oe=e.maxWarnings,S.innerHTML=``,C=Array.from({length:e.maxWarnings},()=>{let e=Q(`div`,`hud-warning-pip`,S);return e.textContent=`!`,e})),p.textContent=e.score.toLocaleString(`es`);let t=e.combo>1;m.classList.toggle(`on`,t),g.textContent=`x${e.combo.toFixed(1)}`,h.style.width=t?`${Math.round(e.comboLeft/e.comboWindow*100)}%`:`0%`,_.classList.toggle(`visible`,!!e.perk),e.perk&&(_.textContent=`☕ CAFEÍNA ${Math.ceil(e.perkLeft)}s`,_.style.setProperty(`--p`,e.perkLeft/e.perkDuration));let o=Math.round(e.suspicion/e.suspicionMax*100);b.style.width=`${o}%`,b.classList.toggle(`danger`,o>70&&o<=92),b.classList.toggle(`hot`,e.redAlert||o>92),x.classList.toggle(`pulse`,e.redAlert),C.forEach((t,n)=>t.classList.toggle(`lit`,n<e.warnings)),E.textContent=gm(e.timeLeft);let s=Math.round(e.timeLeft/e.levelDuration*100);D.style.width=`${s}%`;let c=e.timeLeft<30;E.classList.toggle(`danger`,c),D.classList.toggle(`danger`,c),l.innerHTML=``,e.objectives.forEach(e=>{let t=Q(`div`,`hud-objective${e.done?` done`:``}`,l),n=Q(`span`,`hud-objective-dot`,t);n.style.background=_m(Md[e.type]??16777215);let r=Q(`span`,`hud-objective-icon`,t);r.textContent=e.done?`✓`:e.icon??`•`;let i=Q(`span`,`hud-objective-label`,t);if(i.textContent=e.label,!e.done&&e.progress>0){let n=Q(`div`,`hud-objective-bar-fill`,Q(`div`,`hud-objective-bar`,t));n.style.width=`${Math.round(e.progress/e.time*100)}%`,n.style.background=_m(Md[e.type]??14709292)}});let u=e.area;if(u){r.textContent=ym[u.wing]??`Piso 7`,i.textContent=u.name;let e=[vm[u.kind]??`Zona`];u.capacity>0&&e.push(`${u.capacity} sillas`),a.textContent=e.join(` · `),n.style.setProperty(`--zone-color`,u.color??`#d9d9d9`),n.classList.add(`visible`)}else n.classList.remove(`visible`);e.message?(O.textContent=e.message.text,O.classList.add(`visible`)):O.classList.remove(`visible`);let d=[];if(e.isHiding&&d.push(`🫥 ESCONDIDA`),e.isPretending&&d.push(`⌨️ FINGIENDO TRABAJAR`),e.bossState===`CHASE`?d.push(`🚨 ¡TE PERSIGUE!`):e.bossState===`SEARCH`?d.push(`🔎 TE ESTÁ BUSCANDO`):e.bossState===`INVESTIGATE`&&d.push(`❓ DISTRAÍDO`),k.textContent=d.join(`   ·   `),k.classList.toggle(`visible`,d.length>0),k.classList.toggle(`alert`,e.bossState===`CHASE`),e.nearNpc)j.textContent=`💬`,ee.textContent=`Toca E: hablar con ${e.nearNpc.displayName}`,M.style.setProperty(`--p`,0),A.classList.add(`visible`,`prompt-tap`);else if(e.nearStation){let t=e.nearStation;j.textContent=t.icon??`•`,ee.textContent=`Mantén E: ${t.label}`,M.style.setProperty(`--p`,t.progress/t.time),A.classList.add(`visible`),A.classList.remove(`prompt-tap`)}else e.nearDistraction?(j.textContent=`⭐`,ee.textContent=`Toca E: ${e.nearDistraction.label}`,M.style.setProperty(`--p`,0),A.classList.add(`visible`,`prompt-tap`)):A.classList.remove(`visible`)}return{render:ue,setDay:se,setVisible:I,showResult:ce,hideResult:le,root:t}}var xm=new Set([` `,`enter`,`e`]);function Sm(e){let t=document.createElement(`div`);t.className=`vn-layer hidden`,t.innerHTML=`
  ...
  `,e.appendChild(n);let r=n.querySelector(`.compass-card`),i=n.querySelector(`.compass-icon`),a=n.querySelector(`.compass-label`),o=n.querySelector(`.compass-meta`),s=n.querySelector(`.compass-risk i`),c=n.querySelector(`.compass-marker`),l=n.querySelector(`.compass-arrow`),u=n.querySelector(`.compass-dist`),d=new G;function f(e){let f=e?.focusStation;if(!f||e.gameOver){n.classList.remove(`visible`);return}n.classList.add(`visible`);let p=e.playerPos.x,m=e.playerPos.z,h=Math.hypot(f.x-p,f.z-m)/Z;i.textContent=f.icon??`•`,a.textContent=f.label,o.textContent=e.nearStation&&e.nearStation.id===f.id?`MANTÉN USAR`:`${Math.round(h)} m`;let g=Math.hypot(e.bossPos.x-f.x,e.bossPos.z-f.z)/Z,_=Et.clamp(1-g/16,0,1);s.style.width=`${Math.round(_*100)}%`,r.classList.toggle(`hot`,_>.62||e.redAlert),r.classList.toggle(`warm`,_>.32&&_<=.62);let v=n.clientWidth,y=n.clientHeight;d.set(f.x,1.2*Z,f.z).project(t);let b=d.z<1&&Math.abs(d.x)<.94&&Math.abs(d.y)<.9,x=(d.x+1)/2*v,S=(1-d.y)/2*y,C=0;if(!b){let e=d.x,t=d.y;d.z>=1&&(e=-e,t=-t);let n=Math.hypot(e,t)||1,r=e/n,i=t/n,a=v/2-Fm,o=y/2-Fm,s=Math.min(a/Math.abs(r||.001),o/Math.abs(i||.001));x=v/2+r*s,S=y/2-i*s,C=180/Math.PI*Math.atan2(r,i)}c.classList.toggle(`edge`,!b),c.style.transform=`translate(-50%, -50%) translate(${x}px, ${S}px)`,l.style.transform=`rotate(${C}deg)`,u.textContent=b?``:`${Math.round(h)} m`}return{update:f,root:n}}function Lm({app:e,lights:t,renderer:n,scene:r,player:i,boss:a,npcs:o,camera:s,levels:c,codeEggs:l=[],manifest:u={},dialogues:d={cast:{},encounters:{},barks:{}},minions:f=new Map,onPopup:p=null}){let m=bm(e),h=Im(e,s.camera),g=Sm(e),_=Dm(),v=[...qd.map(e=>e.id),...l.map(e=>e.id)],y=Math.min(_.dayIndex,c.length-1),b=null,x=1,S=!1,C=!1,w={setFlag:(e,t)=>_.setFlag(e,t),getFlag:e=>_.getFlag(e),applyEffect:e=>{if(T[e]){E=e;return}b?.applyEffect(e)}},T={wait:{timeDelta:-25,toast:`Llegaste con la fila. Menos jornada por delante.`},stairs:{timeDelta:0,tired:!0,toast:`Siete pisos. Llegas entera pero lenta.`},cut:{timeDelta:15,risky:!0,toast:`Te colaste. A ver si nadie lo comenta.`}},E=null,D={slowBoss:()=>{x=.78,k()}};function O(e,t){a.distract(t,6),b?._toast(`${e.name} te delató`)}f.forEach(e=>{e.onSpot=O});function k(){let e=c[y].rules??{},t=(e.bossSpeedMul??1)*x;a.speed=a.baseSpeeds.patrol*t,a.investigateSpeed=a.baseSpeeds.investigate*t,a.chaseSpeed=a.baseSpeeds.chase*t,a.searchSpeed=a.baseSpeeds.search*t,a.visionRange=a.baseVisionRange*(e.visionMul??1)}let A=Pm(e,{levels:c,save:_,title:u.title??`Modo Incógnito`,subtitle:u.subtitle??``,actions:{play:e=>re(e),resume:()=>M(),restart:()=>re(y),toTitle:()=>j()}});function j(){C=!1,S=!1,b?.setPaused(!0),m.setVisible(!1),m.hideResult();let e=_.state.completedDays.length;A.openTitle({hasProgress:e>0||_.dayIndex>0,summary:`${e}/${c.length} días superados · ${_.state.eggs.length}/${v.length} secretos`})}function ee(){!C||g.isOpen||b?.gameOver||(S=!0,b?.setPaused(!0),A.openPause(`Día ${c[y].number} · ${c[y].title}`))}function M(){A.close(),C&&(S=!1,m.setVisible(!0),!g.isOpen&&!b?.gameOver&&b?.setPaused(!1))}let N=[],P=e=>{let t=e.key.toLowerCase();if(t===`escape`){e.preventDefault(),A.isOpen&&A.screen===`pause`?M():A.isOpen||ee();return}if(!A.isOpen){N.push(t),N.length>12&&N.shift();for(let e of l)_.hasEgg(e.id)||N.slice(-e.keys.length).join(`,`)===e.keys.join(`,`)&&(N.length=0,F(e))}};window.addEventListener(`keydown`,P);async function F(e){_.findEgg(e.id)&&(e.perk&&D[e.perk]?.(),await te(()=>g.play([...e.scene??[],{speaker:`Secreto encontrado`,portrait:`🥚`,text:`Llevas ${_.state.eggs.length} de ${v.length}. +250 puntos.`}],w)))}async function te(e){b?.setPaused(!0);try{await e()}finally{!S&&!b?.gameOver&&b?.setPaused(!1)}}function ne(){i.position.x=Ld.x,i.position.z=Ld.z,i.keys.clear(),i.touchAxis.x=0,i.touchAxis.z=0,i.speedMul=1,i.isHiding=!1,i.isPretending=!1,i.isDoingActivity=!1;let e=0,t=-1/0;Vd.forEach((n,r)=>{let i=Math.hypot(n.x-Ld.x,n.z-Ld.z);i>t&&(t=i,e=r)}),a.position.x=Vd[e].x,a.position.z=Vd[e].z,a.routeIndex=e,a.resetToPatrol()}async function re(e){y=Math.min(Math.max(e,0),c.length-1),_.setDayIndex(y);let l=c[y];if(A.close(),S=!1,C=!0,x=1,km(l.theme,{renderer:n,scene:r,...t}),m.setDay(l),m.setVisible(!0),m.hideResult(),ne(),k(),b=new hm({player:i,boss:a,npcs:o,minions:ae(l),hud:m,rules:l.rules,onFinish:e=>se(l,e),onEgg:e=>F(e),onPopup:p,onTalk:e=>oe(e)}),b.setPaused(!0),s.setFraming(s.camera.aspect>=1.15?.35:.8),E=null,l.prologue){let e=[...l.prologue.intro??[]];l.prologue.choice&&e.push(l.prologue.choice),await g.play(e,w),ie(l)}await g.play(l.intro??[],w),S||b.setPaused(!1)}function ie(e){let t=T[E];!b||!t||(b.timeLeft=Math.max(60,b.timeLeft+t.timeDelta),t.tired&&(i.speedMul=.85,setTimeout(()=>{i.speedMul===.85&&(i.speedMul=1)},3e4)),t.risky&&Math.random()<.35?(b.warnings=1,b._toast(`Te vieron colarte: advertencia 1`)):b._toast(t.toast))}function ae(e){let t=[];return f.forEach(e=>e.setActive(!1)),(e.minions??[]).forEach(e=>{let n=f.get(e.id);if(!n)return;let r=Hd[e.route]??Hd.jefe??Vd;n.setRoute(r),n.setActive(!0),t.push(n)}),t}async function oe(e){let t=d.encounters[e.cast];if(!t?.scenes?.length)return;let n=_.getFlag(`talk:${e.cast}`)??0;_.setFlag(`talk:${e.cast}`,n+1);let r=t.scenes[n%t.scenes.length],i=d.cast[e.cast];await te(()=>g.play(r.map(e=>({color:i?.color,...e})),w))}async function se(e,t){C=!1;let n=t.targetScore??1e3,r=Nm(t.score,n);t.win?_.completeDay(e.id,{seconds:Math.round(t.elapsed),score:t.score}):_.recordScore(e.id,t.score),await g.play((t.win?e.outroWin:e.outroLose)??[],w);let i=y>=c.length-1,a=t.objectives.filter(e=>e.done).length,o=[];t.win&&!i&&o.push({label:`Día ${c[y+1].number} →`,primary:!0,onClick:()=>re(y+1)}),o.push({label:t.win?`Repetir`:`Reintentar`,primary:!t.win,onClick:()=>re(y)}),o.push({label:`Menú`,onClick:()=>j()}),m.showResult({icon:t.win?i?`🏆`:`🎉`:`🚪`,title:t.win?i?`Semana completada`:`${e.title}: superado`:`Despedida`,rank:t.win?r:null,score:t.score,target:n,body:t.win?`${a}/${t.objectives.length} actividades · ${t.eggsFound} secretos hoy · objetivo ${n} pts`:t.warnings>=(e.rules?.maxWarnings??3)?`Te quedaste sin advertencias.`:`Se acabó la jornada con objetivos pendientes.`,win:t.win,actions:o})}function I(e){b?.update(e),h.update(b&&!A.isOpen?b.lastSnapshot:null)}return{hud:m,dialogue:g,menus:A,compass:h,save:_,start:()=>j(),startDay:re,openPause:ee,update:I,get game(){return b},get isPaused(){return A.isOpen||!!b?.paused},get inLevel(){return C},dispose(){window.removeEventListener(`keydown`,P),g.dispose()}}}function Rm(e,t,{onZoom:n,onInspect:r,onPause:i}={}){let a=`ontouchstart`in window||navigator.maxTouchPoints>0||matchMedia(`(pointer: coarse)`).matches;document.body.classList.toggle(`touch-device`,a);let o=document.createElement(`div`);o.className=`touch-controls`,t.appendChild(o);let s=document.createElement(`div`);s.className=`touch-stick-zone`;let c=document.createElement(`div`);c.className=`touch-stick-base`;let l=document.createElement(`div`);l.className=`touch-stick-thumb`,c.appendChild(l),s.appendChild(c),o.appendChild(s);let u=null,d={x:0,y:0};function f(t,n){e.touchAxis.x=t,e.touchAxis.z=n}function p(e){let t=e.clientX-d.x,n=e.clientY-d.y,r=Math.hypot(t,n);r>56&&(t=t/r*56,n=n/r*56),l.style.transform=`translate(${t}px, ${n}px)`,f(t/56,n/56)}function m(e){e.pointerId===u&&(u=null,c.classList.remove(`active`),l.style.transform=`translate(0, 0)`,f(0,0))}s.addEventListener(`pointerdown`,e=>{u=e.pointerId,d={x:e.clientX,y:e.clientY};let t=s.getBoundingClientRect();c.style.left=`${e.clientX-t.left}px`,c.style.top=`${e.clientY-t.top}px`,c.classList.add(`active`),s.setPointerCapture(e.pointerId),p(e)}),s.addEventListener(`pointermove`,e=>{e.pointerId===u&&p(e)}),s.addEventListener(`pointerup`,m),s.addEventListener(`pointercancel`,m);let h=document.createElement(`div`);h.className=`touch-actions`,o.appendChild(h);function g(t,n,r,i){let a=document.createElement(`div`);a.className=`touch-btn ${t}`,a.innerHTML=`<span class="touch-btn-icon">${n}</span><span>${r}</span>`;let o=t=>{t.preventDefault(),e.keys.add(i),a.classList.add(`active`),em(8)},s=()=>{e.keys.delete(i),a.classList.remove(`active`)};return a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointercancel`,s),a.addEventListener(`pointerleave`,s),h.appendChild(a),a}g(`touch-btn-pretend`,`⌨️`,`FINGIR`,`f`),g(`touch-btn-interact`,`✋`,`USAR`,`e`);let _=document.createElement(`div`);_.className=`touch-utils`,o.appendChild(_);function v(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`touch-util`,r.textContent=e,r.title=t,r.setAttribute(`aria-label`,t),r.addEventListener(`click`,e=>{e.preventDefault(),em(8),n()}),_.appendChild(r),r}return n&&(v(`＋`,`Acercar`,()=>n(.18)),v(`－`,`Alejar`,()=>n(-.18))),r&&v(`🗺️`,`Inspeccionar plano`,r),i&&v(`⏸`,`Pausa`,i),{isTouch:a}}var zm=1.5;function Bm(e,t){let n=document.createElement(`div`);n.className=`px-popups`,e.appendChild(n);let r=[],i=new G;function a({text:e,sub:t=``,x:i,z:a,kind:o=`score`}){let s=document.createElement(`div`);s.className=`px-pop px-pop-${o}`,s.innerHTML=`<span class="px-pop-main">${e}</span>${t?`<span class="px-pop-sub">${t}</span>`:``}`,n.appendChild(s),r.push({node:s,x:i,y:1.6*Z,z:a,life:zm})}function o(e){if(!r.length)return;let a=n.clientWidth,o=n.clientHeight;for(let n=r.length-1;n>=0;n--){let s=r[n];if(s.life-=e,s.life<=0){s.node.remove(),r.splice(n,1);continue}let c=1-s.life/zm;i.set(s.x,s.y+c*1.4*Z,s.z).project(t);let l=i.z<1;s.node.style.display=l?`block`:`none`,l&&(s.node.style.transform=`translate(-50%, -50%) translate(${(i.x+1)/2*a}px, ${(1-i.y)/2*o}px)`,s.node.style.opacity=String(Math.min(1,s.life/.4)))}}function s(){r.forEach(e=>e.node.remove()),r.length=0}return{spawn:a,update:o,clear:s}}var Vm=`./`,Hm=e=>`${Vm}sprites/${e}.png`,Um=document.getElementById(`scene`),Wm=document.getElementById(`app`),Gm=document.getElementById(`boot`),Km=new od({canvas:Um,antialias:!1,powerPreference:`high-performance`}),qm=$p();Km.setPixelRatio(Math.min(window.devicePixelRatio,qm.maxPixelRatio)),Km.shadowMap.enabled=qm.shadows,Km.shadowMap.type=2,Km.toneMapping=4,Km.toneMappingExposure=1.15,Km.outputColorSpace=Le,Km.setSize(window.innerWidth,window.innerHeight);var Jm=new Mn;Jm.background=new J(10466505);var Ym=new Es(16777215,1);Jm.add(Ym);var Xm=new us(14674175,5261626,.85);Jm.add(Xm);var Zm=new Ts(16773846,1.35);Zm.position.set(26*Z,40*Z,20*Z),Zm.castShadow=!0,Zm.shadow.mapSize.set(qm.shadowMap,qm.shadowMap);var Qm=44*Z;Zm.shadow.camera.left=-Qm,Zm.shadow.camera.right=Qm,Zm.shadow.camera.top=Qm,Zm.shadow.camera.bottom=-Qm,Zm.shadow.camera.far=220*Z,Zm.shadow.bias=-.0018,Jm.add(Zm);async function $m(){let e=await wp(),t=e.levels[0];Jd(e.scenes.get(t.scene));let n=up(),{roomLabels:r,markerGroup:i}=zf(Jm,n),a=pp(n,{radius:.3*Z}),o=new $d(window.innerWidth/window.innerHeight),s=o.camera,c=new gp(Km,{pixelSize:Xp().pixelSize,levels:Xp().colorLevels});c.setSize(window.innerWidth,window.innerHeight);let l=e.characters,u=new Set([l.player.sheet,l.boss.sheet,...Object.values(l.minions??{}).map(e=>e.sheet),...Kd.map(e=>e.sheet)]),d=new Map;await Promise.all([...u].map(async e=>d.set(e,await Ap(Hm(e)))));let f=new Mp(d.get(l.player.sheet),{x:Ld.x,z:Ld.z,radius:l.player.radius,height:l.player.height,speed:l.player.speed});Jm.add(f.object3D);let p=Kd.map(t=>{let n=l.npcs[t.sheet]??{},r=e.dialogues.cast[t.cast],i=new Np(d.get(r?.sheet??t.sheet)??d.values().next().value,{...t,radius:n.radius,height:n.height});return i.cast=t.cast??null,i.displayName=r?.name??n.name??`Compañero`,i.talkCooldown=e.dialogues.encounters[t.cast]?.cooldown??40,i});p.forEach(e=>Jm.add(e.object3D));let m=new Vp(d.get(l.boss.sheet),{world:n,route:Vd,navmesh:a,radius:l.boss.radius,height:l.boss.height,speeds:l.boss.speeds,visionRange:l.boss.visionRange,visionHalfAngleDeg:l.boss.visionHalfAngleDeg});Jm.add(m.object3D),Jm.add(m.cone);let h={chispita:15910724,washo:4579536,crispo:12616791},g=new Map;for(let[e,t]of Object.entries(l.minions??{})){let r=new Vp(d.get(t.sheet),{world:n,route:Hd[e]??Vd,navmesh:a,role:`minion`,name:t.name??e,coneColor:h[e]??10466505,radius:t.radius,height:t.height,speeds:t.speeds,visionRange:t.visionRange,visionHalfAngleDeg:t.visionHalfAngleDeg});r.setActive(!1),Jm.add(r.object3D),Jm.add(r.cone),g.set(e,r)}let _=Bm(Wm,s),v=Lm({app:Wm,renderer:Km,scene:Jm,lights:{ambient:Ym,hemi:Xm,key:Zm},player:f,boss:m,npcs:p,camera:o,levels:e.levels,codeEggs:e.codeEggs,manifest:e.manifest,dialogues:e.dialogues,minions:g,onPopup:e=>_.spawn(e)}),y=!1;function b(){y=!y,document.body.classList.toggle(`inspect-mode`,y)}Rm(f,Wm,{onZoom:e=>o.zoomBy(e),onInspect:b,onPause:()=>v.openPause()}),window.addEventListener(`wheel`,e=>{v.dialogue.isOpen||v.menus.isOpen||o.zoomBy(-e.deltaY*.0012)},{passive:!0});let x=null,S={x:0,y:0};Um.addEventListener(`contextmenu`,e=>e.preventDefault()),Um.addEventListener(`pointerdown`,e=>{e.button!==2||v.menus.isOpen||(x=e.pointerId,S={x:e.clientX,y:e.clientY},Um.setPointerCapture(e.pointerId))}),Um.addEventListener(`pointermove`,e=>{e.pointerId===x&&(o.orbitBy((e.clientX-S.x)*.25,-(e.clientY-S.y)*.2),S={x:e.clientX,y:e.clientY})});let C=e=>{e.pointerId===x&&(x=null)};Um.addEventListener(`pointerup`,C),Um.addEventListener(`pointercancel`,C);let w=null,T=0,E=null,D=e=>Math.hypot(e[0].clientX-e[1].clientX,e[0].clientY-e[1].clientY),O=e=>({x:(e[0].clientX+e[1].clientX)/2,y:(e[0].clientY+e[1].clientY)/2});Um.addEventListener(`touchstart`,e=>{e.touches.length===2&&(w=D(e.touches),T=o.framing,E=O(e.touches))},{passive:!0}),Um.addEventListener(`touchmove`,e=>{if(e.touches.length!==2||!w)return;let t=D(e.touches),n=O(e.touches),r=Math.abs(t/w-1),i=Math.hypot(n.x-E.x,n.y-E.y);r*400>i?o.setFraming(T+(t/w-1)*.9):o.orbitBy((n.x-E.x)*.3,-(n.y-E.y)*.25),E=n},{passive:!0}),Um.addEventListener(`touchend`,e=>{e.touches.length<2&&(w=null)},{passive:!0});function k(){let e=window.innerWidth,t=window.innerHeight;Km.setSize(e,t),c.setSize(e,t),o.setAspect(e/t)}window.addEventListener(`resize`,k),window.addEventListener(`keydown`,e=>{e.key.toLowerCase()===`m`&&!v.dialogue.isOpen&&!v.menus.isOpen&&b()});let A=0;document.addEventListener(`touchend`,e=>{let t=Date.now();t-A<320&&e.preventDefault(),A=t},{passive:!1}),[`gesturestart`,`gesturechange`,`gestureend`].forEach(e=>document.addEventListener(e,e=>e.preventDefault(),{passive:!1})),document.addEventListener(`dblclick`,e=>e.preventDefault(),{passive:!1}),Qp(e=>{c.setPixelSize(e.pixelSize),c.setLevels(e.colorLevels),i&&(i.visible=e.showMarkers);let t=$p(e.quality);Km.setPixelRatio(Math.min(window.devicePixelRatio,t.maxPixelRatio)),Km.shadowMap.enabled=t.shadows,Zm.shadow.mapSize.x!==t.shadowMap&&(Zm.shadow.mapSize.set(t.shadowMap,t.shadowMap),Zm.shadow.map?.dispose(),Zm.shadow.map=null),Jm.traverse(e=>{(e.isMesh||e.isInstancedMesh)&&(e.castShadow=e.castShadow&&t.shadows)}),Km.setSize(window.innerWidth,window.innerHeight),c.setSize(window.innerWidth,window.innerHeight)});let j=0,ee=!1;function M(e){ee||Xp().quality!==`auto`||(j=e>.033?j+1:Math.max(0,j-1),j>180&&(ee=!0,Zp({quality:`bajo`,pixelSize:Math.max(2,Xp().pixelSize)}),console.info(`Calidad reducida automáticamente para mantener la fluidez.`)))}let N=7*Z,P=13*Z,F=46*Z,te=new G;function ne(){let e=!o.isFollowing,t=Xp().showLabels;r.forEach(n=>{let r=n.userData.priority??2,i;if(!t&&!y)i=0;else if(y||r===1)i=1;else if(r>=3)i=0;else if(e)i=1;else{let e=Math.hypot(n.userData.homeX-f.position.x,n.userData.homeZ-f.position.z);i=Et.clamp((P-e)/(P-N),0,1)}n.material.opacity=i,n.visible=i>.02;let a=n.userData.baseScale;if(a&&n.visible){n.getWorldPosition(te);let e=Et.clamp(s.position.distanceTo(te)/F,.35,1.6);n.scale.set(a.x*e,a.y*e,1)}})}let re=[];Jm.traverse(e=>{e.userData&&e.userData.bob&&re.push(e)}),Gm?.remove(),v.start();let ie=performance.now();function ae(e){let t=Math.min((e-ie)/1e3,.05);ie=e;let r=e/1e3;v.isPaused||(f.update(t,n),p.forEach(e=>e.update(t,r))),v.update(t),re.forEach(e=>{let t=e.userData.bob;e.position.y=t.base+Math.sin(r*t.speed+t.offset)*t.amp,e.rotation.y=r*.6+t.offset}),M(t),ne(),o.update(t,f.position),_.update(t),c.render(Jm,s),requestAnimationFrame(ae)}requestAnimationFrame(ae),window.__game={world:n,navmesh:a,player:f,boss:m,engine:v,camera:s,scene:Jm,view:o,pixels:c,data:e},window.__floorplan=Ad}$m().catch(e=>{console.error(e);let t=document.createElement(`div`);t.className=`boot-error`,t.innerHTML=`<b>No se pudo iniciar el juego</b><br>${e.message??e}`,(Gm??Wm).replaceChildren(t)});