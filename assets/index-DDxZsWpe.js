...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uc(e,t,n){let r=new Float32Array(Xs),i=new G(0,1,0);return new Oo({name:`SphericalGaussianBlur`,defines:{n:Xs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:pc(),fragmentShader:`
	...
	`}var mc=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Jf=class{constructor(e,{pixelSize:t=2,levels:n=24,saturation:r=1.12}={}){this.renderer=e,this.pixelSize=t,this.enabled=t>1,this.target=new qt(1,1,{minFilter:a,magFilter:a,depthBuffer:!0,stencilBuffer:!1,colorSpace:Le}),this.material=new Oo({uniforms:{tDiffuse:{value:this.target.texture},uResolution:{value:new W(1,1)},uLevels:{value:n},uSaturation:{value:r}},vertexShader:Kf,fragmentShader:qf,depthTest:!1,depthWrite:!1}),this.quadScene=new Nn,this.quadCamera=new hs(-1,1,1,-1,0,1),this.quadScene.add(new J(new _o(2,2),this.material)),this.size=new W(1,1)}setSize(e,t){this.size.set(e,t),this._resizeTarget()}setPixelSize(e){this.pixelSize=Math.max(1,Math.round(e)),this.enabled=this.pixelSize>1,this._resizeTarget()}setLevels(e){this.material.uniforms.uLevels.value=e}_resizeTarget(){let e=Math.max(1,Math.floor(this.size.x/this.pixelSize)),t=Math.max(1,Math.floor(this.size.y/this.pixelSize));this.target.setSize(e,t),this.material.uniforms.uResolution.value.set(e,t)}render(e,t){if(!this.enabled){this.renderer.setRenderTarget(null),this.renderer.render(e,t);return}this.renderer.setRenderTarget(this.target),this.renderer.clear(),this.renderer.render(e,t),this.renderer.setRenderTarget(null),this.renderer.render(this.quadScene,this.quadCamera)}dispose(){this.target.dispose(),this.material.dispose()}},Yf=`./`;async function Xf(e){let t=await fetch(`${Yf}data/${e}`,{cache:`no-cache`});if(!t.ok)throw Error(`No se pudo cargar data/${e} (${t.status})`);try{return await t.json()}catch(t){throw Error(`data/${e} no es JSON válido: ${t.message}`)}}var Zf=e=>({...e,x:e.x*Z,z:e.z*Z}),Qf=e=>({...e,x:e.x*Z,z:e.z*Z,w:e.w*Z,d:e.d*Z});function $f(e,t,n){if(e[t]==null)throw Error(`${n}: falta el campo "${t}"`);return e[t]}function ep(e){let t=`escena "${e.id??`?`}"`,n=$f(e,`areas`,t).map(e=>(e.capacity??=0,Qf(e)));return{id:e.id,name:e.name,areas:n,areaById:new Map(n.map(e=>[e.id,e])),footprint:$f(e,`footprint`,t).map(([e,t])=>[e*Z,t*Z]),spawn:Zf($f(e,`spawn`,t)),entrance:{...e.entrance,x:e.entrance.x*Z,z:e.entrance.z*Z,w:e.entrance.w*Z},corridors:(e.corridors??[]).map(Qf),plants:(e.props??[]).filter(e=>e.type===`plant`).map(Zf),props:(e.props??[]).map(Zf),patrolRoute:$f(e,`patrol`,t).map(Zf),activityStations:(e.activities??[]).map(Zf),hidingSpots:(e.hidingSpots??[]).map(e=>({...Zf(e),r:(e.r??1.3)*Z})),distractions:(e.distractions??[]).map(e=>({...Zf(e),radius:(e.radius??1.2)*Z})),npcs:(e.npcs??[]).map(Zf),locationEggs:(e.eggs??[]).map(e=>({...Zf(e),radius:(e.radius??2)*Z}))}}function tp(e){let t=e=>({...e,height:(e.height??1.45)*Z,radius:(e.radius??.28)*Z,speed:e.speed==null?void 0:e.speed*Z,visionRange:e.visionRange==null?void 0:e.visionRange*Z,speeds:e.speeds?Object.fromEntries(Object.entries(e.speeds).map(([e,t])=>[e,t*Z])):void 0});return{player:t(e.player),boss:t(e.boss),npcs:Object.fromEntries(Object.entries(e.npcs??{}).map(([e,n])=>[e,t(n)]))}}async function np(){let e=await Xf(`manifest.json`),[t,n,r]=await Promise.all([Xf(e.characters??`characters.json`),Promise.all((e.scenes??[]).map(e=>Xf(`scenes/${e}.json`))),Promise.all((e.levels??[]).map(e=>Xf(`levels/${e}.json`)))]),i=new Map(n.map(e=>[e.id,ep(e)]));if(!i.size)throw Error(`manifest.json no declara ninguna escena`);let a=r.map((e,t)=>({...e,number:e.number??t+1,scene:e.scene??n[0].id,rules:e.rules??{}}));if(!a.length)throw Error(`manifest.json no declara ningún nivel`);for(let e of a)if(!i.has(e.scene))throw Error(`El nivel "${e.id}" apunta a la escena "${e.scene}", que no existe`);return{manifest:e,characters:tp(t),scenes:i,levels:a,codeEggs:e.codeEggs??[]}}var rp={south:0,west:1,east:2,north:3},ip=32/44,ap=8,op=new es,sp=new Map;function cp(e){return sp.has(e)||sp.set(e,new Promise((t,n)=>{op.load(e,e=>{e.colorSpace=Le,e.magFilter=a,e.minFilter=a,e.generateMipmaps=!1,t(e)},void 0,n)})),sp.get(e)}var lp=class{constructor(e,{height:t=1.5,y:n=0}={}){this.texture=e.clone(),this.texture.needsUpdate=!0,this.texture.repeat.set(1/4,1/4),this.material=new Nr({map:this.texture,transparent:!0,alphaTest:.4,depthWrite:!0,toneMapped:!1}),this.object=new qr(this.material),this.height=t,this.object.scale.set(t*ip,t,1),this.baseY=n+t/2,this.object.position.y=this.baseY,this.facing=`south`,this.frame=0,this._timer=0,this._moving=!1,this._applyFrame()}setFacing(e){e&&e!==this.facing&&rp[e]!==void 0&&(this.facing=e,this._applyFrame())}setMoving(e){e!==this._moving&&(this._moving=e,e||(this.frame=0,this._timer=0,this._applyFrame()))}setPosition(e,t){this.object.position.x=e,this.object.position.z=t}setTint(e){this.material.color.setScalar(e)}update(e){if(!this._moving)return;this._timer+=e;let t=1/ap;for(;this._timer>=t;)this._timer-=t,this.frame=(this.frame+1)%4,this._applyFrame()}_applyFrame(){let e=rp[this.facing]??0;this.texture.offset.set(this.frame/4,1-(e+1)/4)}},up=class{constructor(e,{x:t=0,z:n=12.6,radius:r=.26*Z,height:i=1.45*Z,speed:a=4.4*Z}={}){this.speed=a,this.radius=r,this.position={x:t,z:n},this.keys=new Set,this.touchAxis={x:0,z:0},this.speedMul=1,this.isHiding=!1,this.isPretending=!1,this.isDoingActivity=!1,this.facing=`south`,this.sprite=new lp(e,{height:i}),this.sprite.setPosition(t,n),this._onKeyDown=e=>{let t=e.key.toLowerCase();this.keys.add(t),[`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,` `].includes(t)&&e.preventDefault()},this._onKeyUp=e=>this.keys.delete(e.key.toLowerCase()),window.addEventListener(`keydown`,this._onKeyDown),window.addEventListener(`keyup`,this._onKeyUp)}get object3D(){return this.sprite.object}_readInput(){let e=this.touchAxis.x,t=this.touchAxis.z;if(Math.hypot(e,t)>.08)return{right:e,up:-t};let n=0,r=0;return(this.keys.has(`w`)||this.keys.has(`arrowup`))&&(r+=1),(this.keys.has(`s`)||this.keys.has(`arrowdown`))&&--r,(this.keys.has(`a`)||this.keys.has(`arrowleft`))&&--n,(this.keys.has(`d`)||this.keys.has(`arrowright`))&&(n+=1),{right:n,up:r}}update(e,t){let{right:n,up:r}=this._readInput(),i=Math.min(Math.hypot(n,r),1),a=!1;if(i>.001){let{dx:t,dz:o}=bd(n,r),s=Math.hypot(t,o)||1,c=(this.isPretending?.45:1)*this.speedMul,l=this.speed*c*i*e;this.position.x+=t/s*l,this.position.z+=o/s*l,this.facing=xd(t,o,this.facing),a=!0}t&&t.resolveCircle(this.position,this.radius),this.sprite.setFacing(this.facing),this.sprite.setMoving(a&&!this.isPretending),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.setTint(this.isHiding?.6:1),this.sprite.update(e)}dispose(){window.removeEventListener(`keydown`,this._onKeyDown),window.removeEventListener(`keyup`,this._onKeyUp)}},dp=class{constructor(e,{id:t,x:n,z:r,radius:i=.28*Z,height:a=1.4*Z,facing:o=`south`,sway:s=0}={}){this.id=t,this.position={x:n,z:r},this.home={x:n,z:r},this.radius=i,this.sway=s*Z,this.sprite=new lp(e,{height:a}),this.sprite.setFacing(o),this.sprite.setPosition(n,r),this._phase=Math.random()*Math.PI*2}get object3D(){return this.sprite.object}update(e,t){if(this.sway>0){let e=Math.sin(t*.6+this._phase)*this.sway,n=this.position.x;this.position.x=this.home.x+e,this.sprite.setFacing(this.position.x>=n?`east`:`west`),this.sprite.setMoving(Math.abs(this.position.x-n)>5e-4),this.sprite.setPosition(this.position.x,this.position.z)}this.sprite.update(e)}},fp={PATROL:`PATROL`,INVESTIGATE:`INVESTIGATE`,CHASE:`CHASE`,SEARCH:`SEARCH`},{PATROL:pp,INVESTIGATE:mp,CHASE:hp,SEARCH:gp}=fp;function _p(e,t){return Math.atan2(-e,-t)}function vp(e,t,n=24){let r=[];for(let i=0;i<n;i++){let a=-t+2*t*(i/n),o=-t+2*t*((i+1)/n);r.push(0,0,0),r.push(Math.sin(a)*e,0,-Math.cos(a)*e),r.push(Math.sin(o)*e,0,-Math.cos(o)*e)}let i=new Dr;return i.setAttribute(`position`,new hr(r,3)),i}var yp=class{constructor(e,{world:t,route:n,navmesh:r=null,radius:i=.3*Z,height:a=1.55*Z,speeds:o={},visionRange:s=7.5*Z,visionHalfAngleDeg:c=30,speedMul:l=1}){this.world=t,this.navmesh=r,this.route=n,this.routeIndex=0,this.position={x:n[0].x,z:n[0].z},this.radius=i,this.facingDir={x:0,z:-1},this._path=null,this._pathTarget=null,this._repathTimer=0,this.state=pp,this.baseSpeeds={patrol:o.patrol??2.4*1.2,investigate:o.investigate??3.2*1.2,chase:o.chase??4.9*1.2,search:o.search??3*1.2},this.speed=this.baseSpeeds.patrol*l,this.investigateSpeed=this.baseSpeeds.investigate*l,this.chaseSpeed=this.baseSpeeds.chase*l,this.searchSpeed=this.baseSpeeds.search*l,this.investigateTarget=null,this.investigateTimer=0,this.searchTarget=null,this.searchTimer=0,this.loseSightTimer=0,this.lastSeenPlayerPos=null,this.baseVisionRange=s,this.visionRange=s,this.halfAngle=Et.degToRad(c),this.playerVisible=!1,this.redAlert=!1,this.sprite=new lp(e,{height:a}),this.sprite.setPosition(this.position.x,this.position.z);let u=vp(this.visionRange,this.halfAngle);this.coneMaterial=new ri({color:15910724,transparent:!0,opacity:.55,side:2,depthWrite:!1,toneMapped:!1}),this.cone=new J(u,this.coneMaterial),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.renderOrder=2;let d=new Ri(new Zi(u,1),new Ei({color:16777215,transparent:!0,opacity:.45,toneMapped:!1}));this.cone.add(d)}get object3D(){return this.sprite.object}get isHunting(){return this.state===hp||this.state===gp}startChase(){this.state=hp,this.loseSightTimer=0}distract(e,t){return this.state===hp?!1:(this.state=mp,this.investigateTarget={x:e.x,z:e.z},this.investigateTimer=t,!0)}catches(e,t){return Math.hypot(e.x-this.position.x,e.z-this.position.z)<this.radius+t+.25*Z}resetToPatrol(){this.state=pp,this.loseSightTimer=0,this.searchTimer=0,this.lastSeenPlayerPos=null}update(e,t,n){this._updateVision(t,n),this._advanceState(e,t);let r=this._pickTarget(t),i=this._moveToward(e,this._steer(e,r));if(i)this.facingDir=i;else if(this.playerVisible){let e=t.position.x-this.position.x,n=t.position.z-this.position.z,r=Math.hypot(e,n);r>.001&&(this.facingDir={x:e/r,z:n/r})}this.sprite.setFacing(xd(this.facingDir.x,this.facingDir.z,`south`)),this.sprite.setMoving(!!i),this.sprite.setPosition(this.position.x,this.position.z),this.sprite.update(e),this.cone.position.set(this.position.x,.16,this.position.z),this.cone.rotation.y=_p(this.facingDir.x,this.facingDir.z);let a=this.redAlert||this.state===hp;this.coneMaterial.color.set(a?15091775:this.state===gp?14721084:15910724),this.coneMaterial.opacity=a?.68:.55}_advanceState(e,t){switch(this.state){case hp:this.playerVisible?this.loseSightTimer=0:(this.loseSightTimer+=e,this.loseSightTimer>1.2&&(this.state=gp,this.searchTarget=this.lastSeenPlayerPos??{...this.position},this.searchTimer=5));break;case gp:this.searchTimer-=e,this.playerVisible?this.startChase():this.searchTimer<=0&&this._resumeNearestRoutePoint();break;case mp:this.investigateTimer-=e,this.playerVisible&&t.isDoingActivity?this.startChase():(this.investigateTimer<=0||this._reached(this.investigateTarget))&&this._resumeNearestRoutePoint();break;default:this.redAlert?this.startChase():this._reached(this.route[this.routeIndex])&&(this.routeIndex=(this.routeIndex+1)%this.route.length);break}}_resumeNearestRoutePoint(){let e=0,t=1/0;this.route.forEach((n,r)=>{let i=Math.hypot(n.x-this.position.x,n.z-this.position.z);i<t&&(t=i,e=r)}),this.routeIndex=e,this.state=pp,this.searchTimer=0,this.loseSightTimer=0}_pickTarget(e){return this.state===hp?e.isHiding?this.lastSeenPlayerPos??this.route[this.routeIndex]:{x:e.position.x,z:e.position.z}:this.state===gp?this.searchTarget??this.route[this.routeIndex]:this.state===mp?this.investigateTarget:this.route[this.routeIndex]}_steer(e,t){if(!t||!this.navmesh)return t;if(this._repathTimer-=e,this.world&&!this.world.lineBlocked(this.position,t))return this._path=null,t;let n=!this._pathTarget||Math.hypot(this._pathTarget.x-t.x,this._pathTarget.z-t.z)>1.2*1.2;if((!this._path||n||this._repathTimer<=0)&&(this._path=this.navmesh.path(this.position,t),this._pathTarget={x:t.x,z:t.z},this._repathTimer=.5),!this._path||!this._path.length)return t;for(;this._path.length>1&&Math.hypot(this._path[0].x-this.position.x,this._path[0].z-this.position.z)<.6*1.2;)this._path.shift();return this._path[0]}_reached(e,t=.4*Z){return!e||Math.hypot(e.x-this.position.x,e.z-this.position.z)<t}_speed(){return this.state===hp?this.chaseSpeed:this.state===gp?this.searchSpeed:this.state===mp?this.investigateSpeed:this.speed}_moveToward(e,t){if(!t)return null;let n=t.x-this.position.x,r=t.z-this.position.z,i=Math.hypot(n,r);if(i<.06*1.2)return null;let a=n/i,o=r/i,s=this._speed()*e,c={x:this.position.x,z:this.position.z};if(this.position.x+=a*s,this.position.z+=o*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)<s*.3){for(let[e,t]of[[a,0],[0,o]])if(this.position.x=c.x+e*s,this.position.z=c.z+t*s,this.world&&this.world.resolveCircle(this.position,this.radius),Math.hypot(this.position.x-c.x,this.position.z-c.z)>s*.3)break}let l=this.position.x-c.x,u=this.position.z-c.z;return Math.hypot(l,u)<1e-4?null:{x:a,z:o}}_updateVision(e,t){if(this.playerVisible=!1,this.redAlert=!1,e.isHiding)return;let n=e.position.x-this.position.x,r=e.position.z-this.position.z,i=Math.hypot(n,r);if(i>this.visionRange||i<.001)return;let a={x:n/i,z:r/i};if(this.facingDir.x*a.x+this.facingDir.z*a.z<Math.cos(this.halfAngle))return;let o=t.map(e=>({x:e.position.x,z:e.position.z,radius:e.radius}));this.world&&this.world.lineBlocked(this.position,e.position,o)||(this.playerVisible=!0,this.lastSeenPlayerPos={x:e.position.x,z:e.position.z},e.isDoingActivity&&!e.isPretending&&(this.redAlert=!0))}},bp=`modo-incognito:settings:v1`,xp={pixelSize:{label:`Tamaño de píxel`,type:`range`,min:1,max:6,step:1,hint:`1 = 3D nítido · 4+ = pixel art grueso`},colorLevels:{label:`Niveles de color`,type:`range`,min:6,max:64,step:2,hint:`Menos niveles = paleta más marcada`},showLabels:{label:`Rótulos de zona`,type:`toggle`},showMarkers:{label:`Marcas de suelo`,type:`toggle`},vibration:{label:`Vibración (móvil)`,type:`toggle`},screenShake:{label:`Sacudida de cámara`,type:`toggle`}},Sp=Object.freeze({pixelSize:2,colorLevels:24,showLabels:!0,showMarkers:!0,vibration:!0,screenShake:!0});function Cp(e){let t={...Sp,...e};for(let[e,n]of Object.entries(xp))if(n.type===`range`){let r=Number(t[e]);t[e]=Number.isFinite(r)?Math.min(n.max,Math.max(n.min,r)):Sp[e]}else t[e]=!!t[e];return t}function wp(){try{let e=localStorage.getItem(bp);return Cp(e?JSON.parse(e):{})}catch{return{...Sp}}}var Tp=wp(),Ep=new Set;function Dp(){return Tp}function Op(e){Tp=Cp({...Tp,...e});try{localStorage.setItem(bp,JSON.stringify(Tp))}catch{}return Ep.forEach(e=>e(Tp)),Tp}function kp(e){return Ep.add(e),e(Tp),()=>Ep.delete(e)}function Ap(e=12){Tp.vibration&&navigator.vibrate?.(e)}var jp=100,Mp=45,Np=12,Pp=16,Fp=1.5*Z,Ip=7,Lp=22,Rp=.5,zp=4,Bp=11*Z,Vp=.8,Hp=1.4,Up=15,Wp={duration:240,maxWarnings:3,objectives:null,decayMul:1,distractionsOff:!1,targetScore:1e3},Gp=class{constructor({player:e,boss:t,npcs:n,hud:r,rules:i={},onFinish:a=null,onEgg:o=null,onPopup:s=null}){this.player=e,this.boss=t,this.npcs=n,this.hud=r,this.rules={...Wp,...i},this.onFinish=a,this.onEgg=o,this.onPopup=s,this.suspicion=0,this.warnings=0,this.timeLeft=this.rules.duration,this.gameOver=!1,this.win=!1,this.paused=!1,this._finished=!1,this.score=0,this.combo=1,this.comboLeft=0,this.perk=null,this.perkLeft=0;let c=this.rules.objectives;this.objectives=Pd.filter(e=>!c||c.includes(e.id)).map(e=>({...e,progress:0,done:!1})),this.distractionState=this.rules.distractionsOff?[]:Id.map(e=>({...e,cooldownLeft:0})),this.nearStation=null,this.nearDistraction=null,this.message=null,this.currentArea=null,this._prevInteractKey=!1,this._caughtCooldown=0,this._eggDwell=new Map,this._foundEggs=new Set}setPaused(e){this.paused=e,e&&(this.player.keys.clear(),this.player.touchAxis.x=0,this.player.touchAxis.z=0)}update(e){if(this.gameOver||this.paused){this.hud.render(this._snapshot());return}this.timeLeft=Math.max(0,this.timeLeft-e),this._caughtCooldown>0&&(this._caughtCooldown-=e),this.comboLeft>0&&(this.comboLeft=Math.max(0,this.comboLeft-e),this.comboLeft===0&&(this.combo=1)),this.perkLeft>0&&(this.perkLeft=Math.max(0,this.perkLeft-e),this.perkLeft===0&&this._clearPerk());let t=this.player.position;this.currentArea=Bd(t.x,t.z)??Vd(t.x,t.z).area,this.player.isHiding=Fd.some(e=>Math.hypot(e.x-t.x,e.z-t.z)<e.r);let n=this.player.keys.has(`e`),r=this.player.keys.has(`f`);if(this.player.isPretending=r,this.nearStation=this.objectives.find(e=>!e.done&&Math.hypot(e.x-t.x,e.z-t.z)<Fp)??null,this.nearStation&&n&&!r?(this.player.isDoingActivity=!0,this.nearStation.progress=Math.min(this.nearStation.time,this.nearStation.progress+e),this.nearStation.progress>=this.nearStation.time&&!this.nearStation.done&&(this.nearStation.done=!0,this._completeActivity(this.nearStation))):this.player.isDoingActivity=!1,this.distractionState.forEach(t=>{t.cooldownLeft>0&&(t.cooldownLeft=Math.max(0,t.cooldownLeft-e))}),this.nearDistraction=this.distractionState.find(e=>e.cooldownLeft<=0&&Math.hypot(e.x-t.x,e.z-t.z)<Fp)??null,n&&!this._prevInteractKey&&this.nearDistraction&&!this.nearStation){let e={x:this.nearDistraction.x,z:this.nearDistraction.z};this.boss.distract(e,Ip)?(this.nearDistraction.cooldownLeft=this.nearDistraction.cooldown,this._toast(`Distracción: ${this.nearDistraction.label}`),this._award(40,`Distracción`,this.player.position)):this._toast(`¡Ya te vio! Una distracción no lo detiene ahora.`)}this._prevInteractKey=n,this.boss.update(e,this.player,this.npcs),this._updateEggs(e);let i=this.rules.decayMul;if(this.boss.redAlert){let t=this.nearStation?.riskRate??20;this.suspicion=Math.min(jp,this.suspicion+t*e)}else this.boss.state===fp.CHASE&&this.boss.playerVisible?this.suspicion=Math.min(jp,this.suspicion+Pp*e):this.player.isHiding||this.player.isPretending?this.suspicion=Math.max(0,this.suspicion-Mp*i*e):this.suspicion=Math.max(0,this.suspicion-Np*i*e);let a=this._caughtCooldown<=0&&this.boss.isHunting&&!this.player.isHiding&&this.boss.catches(t,this.player.radius);(this.suspicion>=jp||a)&&this._warn(),this.gameOver||(this.objectives.every(e=>e.done)?this._finish(!0):this.timeLeft<=0&&this._finish(!1)),this.message&&(this.message.timer-=e,this.message.timer<=0&&(this.message=null)),this.hud.render(this._snapshot())}_completeActivity(e){let t=Math.hypot(this.boss.position.x-this.player.position.x,this.boss.position.z-this.player.position.z),n=0,r=``;this.boss.playerVisible?(n=Hp,r=` · ¡EN SUS NARICES!`):t<Bp&&(n=Vp,r=` · con el jefe cerca`);let i=e.points??120,a=Math.round(i*(this.combo+n));this.score+=a,this.combo=Math.min(zp,this.combo+Rp),this.comboLeft=Lp,e.perk&&this._applyPerk(e.perk),Ap([12,40,18]),this._toast(`${e.label} ✔${r}`),this.onPopup?.({text:`+${a}`,sub:this.combo>1?`x${this.combo.toFixed(1)}`:``,x:e.x,z:e.z,kind:n?`nerve`:`score`})}_award(e,t,n){let r=Math.round(e*this.combo);this.score+=r,this.onPopup?.({text:`+${r}`,sub:t,x:n.x,z:n.z,kind:`minor`})}_applyPerk(e){this._clearPerk(),this.perk=e,this.perkLeft=Up,e===`caffeine`&&(this.player.speedMul=1.35,this._toast(`☕ Cafeína: +35% de velocidad`))}_clearPerk(){this.perk===`caffeine`&&(this.player.speedMul=1),this.perk=null}_updateEggs(e){if(!this.onEgg)return;let t=this.player.position;for(let n of Rd){if(this._foundEggs.has(n.id))continue;let r=Math.hypot(n.x-t.x,n.z-t.z)<n.radius,i=(this._eggDwell.get(n.id)??0)+(r?e:-e*2);this._eggDwell.set(n.id,Math.max(0,i)),i>=n.dwell&&(this._foundEggs.add(n.id),this.score+=250,this.onEgg(n))}}_warn(){this.warnings+=1,this.suspicion=0,this._caughtCooldown=3,this.combo=1,this.comboLeft=0,this.boss.resetToPatrol(),Ap([40,60,40]),this.warnings>=this.rules.maxWarnings?(this._toast(`Última advertencia: despedida.`),this._finish(!1)):this._toast(`Advertencia ${this.warnings}/${this.rules.maxWarnings}`)}_finish(e){this._finished||(this._finished=!0,this.gameOver=!0,this.win=e,this._clearPerk(),e&&(this.score+=Math.round(this.timeLeft*4)),this.onFinish?.({win:e,score:this.score,targetScore:this.rules.targetScore,warnings:this.warnings,timeLeft:this.timeLeft,elapsed:this.rules.duration-this.timeLeft,objectives:this.objectives,eggsFound:this._foundEggs.size}))}_toast(e){this.message={text:e,timer:2.6}}_snapshot(){return{suspicion:this.suspicion,suspicionMax:jp,warnings:this.warnings,maxWarnings:this.rules.maxWarnings,timeLeft:this.timeLeft,levelDuration:this.rules.duration,objectives:this.objectives,nearStation:this.nearStation,nearDistraction:this.nearDistraction,isPretending:this.player.isPretending,isHiding:this.player.isHiding,redAlert:this.boss.redAlert,bossState:this.boss.state,gameOver:this.gameOver,win:this.win,message:this.message,area:this.currentArea,score:this.score,combo:this.combo,comboLeft:this.comboLeft,comboWindow:Lp,perk:this.perk,perkLeft:this.perkLeft,perkDuration:Up,targetScore:this.rules.targetScore}}};function Kp(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function qp(e){return`#${e.toString(16).padStart(6,`0`)}`}function Q(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n&&n.appendChild(r),r}var Jp={[Cd.OPEN_OFFICE]:`Trabajo`,[Cd.MEETING]:`Sala`,[Cd.SOCIAL]:`Social`,[Cd.AUDITORIUM]:`Auditorio`,[Cd.CORE]:`Servicios`,[Cd.ELEVATOR]:`Acceso`},Yp={sur:`Ala Sur`,norte:`Ala Norte`,centro:`Centro`};function Xp(e){let t=Q(`div`,`hud-root`,e),n=Q(`div`,`hud-location`,t),r=Q(`span`,`hud-loc-wing`,n),i=Q(`span`,`hud-loc-name`,n),a=Q(`span`,`hud-loc-meta`,n),o=Q(`div`,`hud-topbar`,t),s=Q(`div`,`hud-panel hud-objectives`,o),c=Q(`div`,`hud-panel-title`,s);c.innerHTML=`<span class="hud-title-icon">🎯</span> OBJETIVOS DE OCIO`;let l=Q(`div`,`hud-objectives-list`,s),u=Q(`div`,`hud-center`,o),d=Q(`div`,`hud-day-chip`,u),f=Q(`div`,`hud-score`,u),p=Q(`span`,`hud-score-value`,f),m=Q(`span`,`hud-combo`,f),h=Q(`span`,`hud-combo-bar`,m),g=Q(`span`,`hud-combo-text`,m),_=Q(`div`,`hud-perk`,u),v=Q(`div`,`hud-panel hud-suspicion`,u),y=Q(`div`,`hud-panel-title`,v);y.innerHTML=`<span class="hud-title-icon">👁️</span> SOSPECHA`;let b=Q(`div`,`hud-suspicion-fill`,Q(`div`,`hud-suspicion-track`,v)),x=Q(`div`,`hud-suspicion-glint`,b),S=Q(`div`,`hud-warnings`,v),C=[],w=Q(`div`,`hud-panel hud-timer`,o),T=Q(`div`,`hud-panel-title`,w);T.innerHTML=`<span class="hud-title-icon">⏱️</span> JORNADA`;let E=Q(`div`,`hud-timer-value`,w),D=Q(`div`,`hud-timer-fill`,Q(`div`,`hud-timer-track`,w)),O=Q(`div`,`hud-toast`,t),k=Q(`div`,`hud-status-badge`,t),A=Q(`div`,`hud-prompt`,t),j=Q(`span`,`hud-prompt-icon`,A),ee=Q(`span`,`hud-prompt-text`,A),M=Q(`div`,`hud-prompt-ring-fill`,Q(`div`,`hud-prompt-ring`,A)),N=Q(`div`,`hud-legend`,t);N.innerHTML=`
  ...
  `,e.appendChild(t);let n=t.querySelector(`.vn-box`),r=t.querySelector(`.vn-portrait`),i=t.querySelector(`.vn-portrait-emoji`),a=t.querySelector(`.vn-speaker`),o=t.querySelector(`.vn-text`),s=t.querySelector(`.vn-options`),c=t.querySelector(`.vn-hint`),l=null,u=null,d=``,f=null,p=!1;function m(e){return new Promise(t=>{d=e,u=t,o.textContent=``;let n=0,r=()=>{if(n+=1,o.textContent=e.slice(0,n),n>=e.length){l=null,u=null,t();return}l=setTimeout(r,18)};l=setTimeout(r,18)})}function h(){if(!l)return!1;clearTimeout(l),l=null,o.textContent=d;let e=u;return u=null,e?.(),!0}function g(){return c.classList.remove(`hidden`),new Promise(e=>{f=e})}function _(){if(p&&!h()&&f){let e=f;f=null,c.classList.add(`hidden`),e()}}let v=e=>{p&&Zp.has(e.key.toLowerCase())&&(e.preventDefault(),_())};window.addEventListener(`keydown`,v),t.addEventListener(`pointerdown`,e=>{e.target.closest(`.vn-option`)||_()});async function y(e,t){s.innerHTML=``,s.classList.add(`hidden`);let o=x(e.speaker,t)??``;a.textContent=o,a.classList.toggle(`hidden`,!o),i.textContent=e.portrait??`🗨️`,r.dataset.mood=e.mood??`neutral`,n.dataset.mood=e.mood??`neutral`,await m(x(e.text,t)),await g()}function b(e,t){return new Promise(async r=>{a.textContent=x(e.speaker,t)??``,a.classList.toggle(`hidden`,!e.speaker),i.textContent=e.portrait??`❓`,n.dataset.mood=e.mood??`neutral`,await m(x(e.prompt,t)),c.classList.add(`hidden`),s.innerHTML=``,s.classList.remove(`hidden`),e.options.forEach(e=>{let n=document.createElement(`button`);n.className=`vn-option`,n.type=`button`,n.textContent=e.label,n.addEventListener(`click`,async n=>{n.stopPropagation(),s.innerHTML=``,s.classList.add(`hidden`),e.flag&&t.setFlag?.(e.flag,!0),e.effect?.(t),e.reply&&await y({speaker:e.replySpeaker??`Tú`,portrait:`🙂`,text:e.reply},t),e.then&&await S(e.then,t),r(e)}),s.appendChild(n)})})}function x(e,t){return typeof e==`function`?e(t):e}async function S(e,t){for(let n of e)n.when&&!n.when(t)||(n.options?await b(n,t):await y(n,t))}async function C(e,n={}){if(!(!e||!e.length)){p=!0,t.classList.remove(`hidden`),document.body.classList.add(`vn-open`);try{await S(e,n)}finally{p=!1,t.classList.add(`hidden`),document.body.classList.remove(`vn-open`),s.innerHTML=``}}}return{play:C,get isOpen(){return p},dispose(){window.removeEventListener(`keydown`,v),t.remove()}}}var $p=`modo-incognito:progress:v1`,em={dayIndex:0,completedDays:[],eggs:[],flags:{},bestTimes:{},bestScores:{}};function tm(){try{let e=localStorage.getItem($p);return e?{...em,...JSON.parse(e)}:{...em}}catch{return{...em}}}function nm(e){try{localStorage.setItem($p,JSON.stringify(e))}catch{}}function rm(){let e=tm();return{get state(){return e},get dayIndex(){return e.dayIndex},setDayIndex(t){e.dayIndex=t,nm(e)},completeDay(t,{seconds:n,score:r}={}){if(e.completedDays.includes(t)||e.completedDays.push(t),n!=null){let r=e.bestTimes[t];(r==null||n<r)&&(e.bestTimes[t]=n)}if(r!=null){let n=e.bestScores[t];(n==null||r>n)&&(e.bestScores[t]=r)}nm(e)},recordScore(t,n){let r=e.bestScores[t];(r==null||n>r)&&(e.bestScores[t]=n,nm(e))},hasCompleted(t){return e.completedDays.includes(t)},findEgg(t){return e.eggs.includes(t)?!1:(e.eggs.push(t),nm(e),!0)},hasEgg(t){return e.eggs.includes(t)},setFlag(t,n=!0){e.flags[t]=n,nm(e)},getFlag(t){return e.flags[t]},reset(){e={...em,completedDays:[],eggs:[],flags:{},bestTimes:{},bestScores:{}},nm(e)}}}var im={morning:{background:10466505,ambient:{color:16777215,intensity:1},hemi:{sky:14674175,ground:5261626,intensity:.85},key:{color:16773846,intensity:1.35},exposure:1.15},overcast:{background:9147296,ambient:{color:15330805,intensity:1.05},hemi:{sky:13950186,ground:4868944,intensity:.9},key:{color:15199477,intensity:.95},exposure:1.05},dusk:{background:4866647,ambient:{color:16770767,intensity:.85},hemi:{sky:16767408,ground:3814214,intensity:.75},key:{color:16759674,intensity:1.25},exposure:1.2}};function am(e,{renderer:t,scene:n,ambient:r,hemi:i,key:a}){let o=im[e]??im.morning;return n.background=new q(o.background),r.color.set(o.ambient.color),r.intensity=o.ambient.intensity,i.color.set(o.hemi.sky),i.groundColor.set(o.hemi.ground),i.intensity=o.hemi.intensity,a.color.set(o.key.color),a.intensity=o.key.intensity,t.toneMappingExposure=o.exposure,o}function om(){let e=document.createElement(`div`);e.className=`cam-panel`;let t=new Map,n=document.createElement(`div`);n.className=`cam-grid`,e.appendChild(n);for(let[e,r]of Object.entries(td)){let i=document.createElement(`label`);i.className=`cam-row`;let a=document.createElement(`div`);a.className=`cam-row-head`;let o=document.createElement(`span`);o.textContent=r.label;let s=document.createElement(`output`);s.className=`cam-value`,a.append(o,s);let c=document.createElement(`input`);c.type=`range`,c.min=r.min,c.max=r.max,c.step=r.step,c.className=`cam-slider`,c.addEventListener(`input`,()=>ud({[e]:Number(c.value)})),i.append(a,c),n.appendChild(i),t.set(e,{input:c,value:s,lim:r})}let r=document.createElement(`p`);r.className=`cam-hint`,r.innerHTML=`Arrastra con el <b>botón derecho</b> (o con <b>dos dedos</b>) sobre el escenario para orbitar. Cuando te guste, copia los parámetros y pégalos en <code>src/scene/config.js</code>.`,e.appendChild(r);let i=document.createElement(`pre`);i.className=`cam-code`,e.appendChild(i);let a=document.createElement(`div`);a.className=`cam-actions`,e.appendChild(a);let o=document.createElement(`button`);o.type=`button`,o.className=`px-btn px-btn-primary`,o.textContent=`Copiar parámetros`,o.addEventListener(`click`,async()=>{let e=pd(),t=!1;try{await navigator.clipboard.writeText(e),t=!0}catch{let e=document.createRange();e.selectNodeContents(i);let t=window.getSelection();t.removeAllRanges(),t.addRange(e)}o.textContent=t?`¡Copiado!`:`Selecciona y copia ↑`,setTimeout(()=>o.textContent=`Copiar parámetros`,1800)}),a.appendChild(o);let s=document.createElement(`button`);return s.type=`button`,s.className=`px-btn`,s.textContent=`Restablecer`,s.addEventListener(`click`,()=>dd()),a.appendChild(s),{root:e,dispose:fd(e=>{for(let[n,{input:r,value:i,lim:a}]of t){document.activeElement!==r&&(r.value=e[n]);let t=a.step<1?2:0;i.textContent=`${e[n].toFixed(t)}${a.unit}`}i.textContent=pd()})}}function $(e,t,n,r){let i=document.createElement(e);return t&&(i.className=t),r!=null&&(i.textContent=r),n&&n.appendChild(i),i}function sm(e,t,{primary:n=!1,icon:r=``,onClick:i}={}){let a=$(`button`,`px-btn${n?` px-btn-primary`:``}`,e);return a.type=`button`,r&&$(`span`,`px-btn-icon`,a,r),$(`span`,null,a,t),a.addEventListener(`click`,()=>{Ap(10),i?.()}),a}var cm=[{min:1,label:`S`,blurb:`Fantasma corporativo`},{min:.8,label:`A`,blurb:`Prácticamente invisible`},{min:.6,label:`B`,blurb:`Sospechosamente eficiente`},{min:.35,label:`C`,blurb:`Te vieron un par de veces`},{min:0,label:`D`,blurb:`Necesitas practicar`}];function lm(e,t){let n=t>0?e/t:0;return cm.find(e=>n>=e.min)??cm[cm.length-1]}function um(e,{levels:t,save:n,actions:r,title:i=`Modo Incógnito`,subtitle:a=``}){let o=$(`div`,`px-menu hidden`,e),s=$(`div`,`px-menu-scrim`,o),c=$(`div`,`px-menu-stage`,o),l=null,u=null,d=null,f={};function p(e,t=``){let n=$(`section`,`px-screen ${t}`,c);return n.dataset.screen=e,f[e]=n,n}let m=p(`title`,`px-screen-title`),h=$(`div`,`px-logo`,m);$(`span`,`px-logo-main`,h,i),$(`span`,`px-logo-sub`,h,a);let g=$(`div`,`px-menu-list`,m),_=sm(g,`Continuar`,{primary:!0,icon:`▶`,onClick:()=>r.play(n.dayIndex)});sm(g,`Nueva semana`,{icon:`✦`,onClick:()=>{n.setDayIndex(0),r.play(0)}}),sm(g,`Elegir día`,{icon:`▦`,onClick:()=>P(`days`)}),sm(g,`Ajustes`,{icon:`⚙`,onClick:()=>P(`settings`)}),sm(g,`Cómo se juega`,{icon:`?`,onClick:()=>P(`help`)});let v=$(`div`,`px-title-foot`,m),y=p(`days`);$(`h2`,`px-screen-title-text`,y,`Elige un día`);let b=$(`div`,`px-day-grid`,y);sm($(`div`,`px-screen-foot`,y),`Volver`,{onClick:()=>P(`title`)});function x(){b.innerHTML=``,t.forEach((e,i)=>{let a=i===0||n.hasCompleted(t[i-1].id)||n.dayIndex>=i,o=$(`button`,`px-day${n.hasCompleted(e.id)?` done`:``}${a?``:` locked`}`,b);o.type=`button`,o.disabled=!a,$(`span`,`px-day-num`,o,String(e.number).padStart(2,`0`)),$(`span`,`px-day-name`,o,e.title),$(`span`,`px-day-sub`,o,a?e.subtitle??``:`Bloqueado`);let s=n.state.bestScores?.[e.id];s!=null&&$(`span`,`px-day-best`,o,`${s} pts · ${lm(s,e.rules?.targetScore??1).label}`),o.addEventListener(`click`,()=>{a&&(Ap(10),r.play(i))})})}let S=p(`settings`);$(`h2`,`px-screen-title-text`,S,`Ajustes`);let C=$(`div`,`px-tabs`,S),w=$(`div`,`px-panes`,S),T=$(`div`,`px-pane`,w),E=$(`div`,`px-pane hidden`,w),D=[{id:`game`,label:`Juego`,pane:T},{id:`camera`,label:`Cámara`,pane:E}].map(e=>{let t=$(`button`,`px-tab`,C,e.label);return t.type=`button`,t.addEventListener(`click`,()=>O(e.id)),{...e,btn:t}});function O(e){D.forEach(t=>{t.btn.classList.toggle(`active`,t.id===e),t.pane.classList.toggle(`hidden`,t.id!==e)})}let k=new Map;for(let[e,t]of Object.entries(xp)){let n=$(`label`,`px-opt`,T),r=$(`div`,`px-opt-head`,n);$(`span`,`px-opt-label`,r,t.label);let i=$(`span`,`px-opt-value`,r),a;t.type===`range`?(a=$(`input`,`cam-slider`,n),a.type=`range`,a.min=t.min,a.max=t.max,a.step=t.step,a.addEventListener(`input`,()=>Op({[e]:Number(a.value)}))):(a=$(`button`,`px-switch`,n),a.type=`button`,a.addEventListener(`click`,()=>Op({[e]:!Dp()[e]}))),t.hint&&$(`span`,`px-opt-hint`,n,t.hint),k.set(e,{input:a,readout:i,def:t})}kp(e=>{for(let[t,{input:n,readout:r,def:i}]of k)i.type===`range`?(document.activeElement!==n&&(n.value=e[t]),r.textContent=String(e[t])):(n.classList.toggle(`on`,e[t]),n.textContent=e[t]?`SÍ`:`NO`,r.textContent=``)}),sm($(`div`,`px-screen-foot`,S),`Volver`,{onClick:()=>P(u??`title`)});let A=p(`help`);$(`h2`,`px-screen-title-text`,A,`Cómo se juega`);let j=$(`div`,`px-help`,A);j.innerHTML=`
  ...
  `,sm($(`div`,`px-screen-foot`,A),`Volver`,{onClick:()=>P(u??`title`)});let ee=p(`pause`,`px-screen-pause`);$(`h2`,`px-screen-title-text`,ee,`Pausa`);let M=$(`p`,`px-pause-info`,ee),N=$(`div`,`px-menu-list`,ee);sm(N,`Continuar`,{primary:!0,icon:`▶`,onClick:()=>r.resume()}),sm(N,`Reiniciar día`,{icon:`↺`,onClick:()=>r.restart()}),sm(N,`Ajustes`,{icon:`⚙`,onClick:()=>P(`settings`)}),sm(N,`Menú principal`,{icon:`⌂`,onClick:()=>r.toTitle()});function P(e){e===`settings`&&!d&&(d=om(),E.appendChild(d.root),O(`game`)),l&&l!==e&&(u=l),l=e,Object.entries(f).forEach(([t,n])=>n.classList.toggle(`hidden`,t!==e)),o.classList.remove(`hidden`),document.body.classList.add(`menu-open`),o.dataset.screen=e}function F(){o.classList.add(`hidden`),document.body.classList.remove(`menu-open`),l=null}return s.addEventListener(`click`,()=>{l===`pause`&&r.resume()}),{show:P,close:F,openTitle(e){x(),_.classList.toggle(`hidden`,!e.hasProgress),v.textContent=e.summary,P(`title`)},openPause(e){M.textContent=e??``,P(`pause`)},openDays(){x(),P(`days`)},get isOpen(){return!o.classList.contains(`hidden`)},get screen(){return l}}}function dm({app:e,lights:t,renderer:n,scene:r,player:i,boss:a,npcs:o,camera:s,levels:c,codeEggs:l=[],manifest:u={},onPopup:d=null}){let f=Xp(e),p=Qp(e),m=rm(),h=[...Rd.map(e=>e.id),...l.map(e=>e.id)],g=Math.min(m.dayIndex,c.length-1),_=null,v=1,y=!1,b=!1,x={setFlag:(e,t)=>m.setFlag(e,t),getFlag:e=>m.getFlag(e)},S={slowBoss:()=>{v=.78,C()}};function C(){let e=c[g].rules??{},t=(e.bossSpeedMul??1)*v;a.speed=a.baseSpeeds.patrol*t,a.investigateSpeed=a.baseSpeeds.investigate*t,a.chaseSpeed=a.baseSpeeds.chase*t,a.searchSpeed=a.baseSpeeds.search*t,a.visionRange=a.baseVisionRange*(e.visionMul??1)}let w=um(e,{levels:c,save:m,title:u.title??`Modo Incógnito`,subtitle:u.subtitle??``,actions:{play:e=>M(e),resume:()=>D(),restart:()=>M(g),toTitle:()=>T()}});function T(){b=!1,y=!1,_?.setPaused(!0),f.setVisible(!1),f.hideResult();let e=m.state.completedDays.length;w.openTitle({hasProgress:e>0||m.dayIndex>0,summary:`${e}/${c.length} días superados · ${m.state.eggs.length}/${h.length} secretos`})}function E(){!b||p.isOpen||_?.gameOver||(y=!0,_?.setPaused(!0),w.openPause(`Día ${c[g].number} · ${c[g].title}`))}function D(){w.close(),b&&(y=!1,f.setVisible(!0),!p.isOpen&&!_?.gameOver&&_?.setPaused(!1))}let O=[],k=e=>{let t=e.key.toLowerCase();if(t===`escape`){e.preventDefault(),w.isOpen&&w.screen===`pause`?D():w.isOpen||E();return}if(!w.isOpen){O.push(t),O.length>12&&O.shift();for(let e of l)m.hasEgg(e.id)||O.slice(-e.keys.length).join(`,`)===e.keys.join(`,`)&&(O.length=0,A(e))}};window.addEventListener(`keydown`,k);async function A(e){m.findEgg(e.id)&&(e.perk&&S[e.perk]?.(),await j(()=>p.play([...e.scene??[],{speaker:`Secreto encontrado`,portrait:`🥚`,text:`Llevas ${m.state.eggs.length} de ${h.length}. +250 puntos.`}],x)))}async function j(e){_?.setPaused(!0);try{await e()}finally{!y&&!_?.gameOver&&_?.setPaused(!1)}}function ee(){i.position.x=kd.x,i.position.z=kd.z,i.keys.clear(),i.touchAxis.x=0,i.touchAxis.z=0,i.speedMul=1,i.isHiding=!1,i.isPretending=!1,i.isDoingActivity=!1;let e=0,t=-1/0;Nd.forEach((n,r)=>{let i=Math.hypot(n.x-kd.x,n.z-kd.z);i>t&&(t=i,e=r)}),a.position.x=Nd[e].x,a.position.z=Nd[e].z,a.routeIndex=e,a.resetToPatrol()}async function M(e){g=Math.min(Math.max(e,0),c.length-1),m.setDayIndex(g);let l=c[g];w.close(),y=!1,b=!0,v=1,am(l.theme,{renderer:n,scene:r,...t}),f.setDay(l),f.setVisible(!0),f.hideResult(),ee(),C(),_=new Gp({player:i,boss:a,npcs:o,hud:f,rules:l.rules,onFinish:e=>N(l,e),onEgg:e=>A(e),onPopup:d}),_.setPaused(!0),s.setFraming(s.camera.aspect>=1.15?.35:.8),await p.play(l.intro??[],x),y||_.setPaused(!1)}async function N(e,t){b=!1;let n=t.targetScore??1e3,r=lm(t.score,n);t.win?m.completeDay(e.id,{seconds:Math.round(t.elapsed),score:t.score}):m.recordScore(e.id,t.score),await p.play((t.win?e.outroWin:e.outroLose)??[],x);let i=g>=c.length-1,a=t.objectives.filter(e=>e.done).length,o=[];t.win&&!i&&o.push({label:`Día ${c[g+1].number} →`,primary:!0,onClick:()=>M(g+1)}),o.push({label:t.win?`Repetir`:`Reintentar`,primary:!t.win,onClick:()=>M(g)}),o.push({label:`Menú`,onClick:()=>T()}),f.showResult({icon:t.win?i?`🏆`:`🎉`:`🚪`,title:t.win?i?`Semana completada`:`${e.title}: superado`:`Despedida`,rank:t.win?r:null,score:t.score,target:n,body:t.win?`${a}/${t.objectives.length} actividades · ${t.eggsFound} secretos hoy · objetivo ${n} pts`:t.warnings>=(e.rules?.maxWarnings??3)?`Te quedaste sin advertencias.`:`Se acabó la jornada con objetivos pendientes.`,win:t.win,actions:o})}function P(e){_?.update(e)}return{hud:f,dialogue:p,menus:w,save:m,start:()=>T(),startDay:M,openPause:E,update:P,get game(){return _},get isPaused(){return w.isOpen||!!_?.paused},get inLevel(){return b},dispose(){window.removeEventListener(`keydown`,k),p.dispose()}}}function fm(e,t,{onZoom:n,onInspect:r,onPause:i}={}){let a=`ontouchstart`in window||navigator.maxTouchPoints>0||matchMedia(`(pointer: coarse)`).matches;document.body.classList.toggle(`touch-device`,a);let o=document.createElement(`div`);o.className=`touch-controls`,t.appendChild(o);let s=document.createElement(`div`);s.className=`touch-stick-zone`;let c=document.createElement(`div`);c.className=`touch-stick-base`;let l=document.createElement(`div`);l.className=`touch-stick-thumb`,c.appendChild(l),s.appendChild(c),o.appendChild(s);let u=null,d={x:0,y:0};function f(t,n){e.touchAxis.x=t,e.touchAxis.z=n}function p(e){let t=e.clientX-d.x,n=e.clientY-d.y,r=Math.hypot(t,n);r>56&&(t=t/r*56,n=n/r*56),l.style.transform=`translate(${t}px, ${n}px)`,f(t/56,n/56)}function m(e){e.pointerId===u&&(u=null,c.classList.remove(`active`),l.style.transform=`translate(0, 0)`,f(0,0))}s.addEventListener(`pointerdown`,e=>{u=e.pointerId,d={x:e.clientX,y:e.clientY};let t=s.getBoundingClientRect();c.style.left=`${e.clientX-t.left}px`,c.style.top=`${e.clientY-t.top}px`,c.classList.add(`active`),s.setPointerCapture(e.pointerId),p(e)}),s.addEventListener(`pointermove`,e=>{e.pointerId===u&&p(e)}),s.addEventListener(`pointerup`,m),s.addEventListener(`pointercancel`,m);let h=document.createElement(`div`);h.className=`touch-actions`,o.appendChild(h);function g(t,n,r,i){let a=document.createElement(`div`);a.className=`touch-btn ${t}`,a.innerHTML=`<span class="touch-btn-icon">${n}</span><span>${r}</span>`;let o=t=>{t.preventDefault(),e.keys.add(i),a.classList.add(`active`),Ap(8)},s=()=>{e.keys.delete(i),a.classList.remove(`active`)};return a.addEventListener(`pointerdown`,o),a.addEventListener(`pointerup`,s),a.addEventListener(`pointercancel`,s),a.addEventListener(`pointerleave`,s),h.appendChild(a),a}g(`touch-btn-pretend`,`⌨️`,`FINGIR`,`f`),g(`touch-btn-interact`,`✋`,`USAR`,`e`);let _=document.createElement(`div`);_.className=`touch-utils`,o.appendChild(_);function v(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`touch-util`,r.textContent=e,r.title=t,r.setAttribute(`aria-label`,t),r.addEventListener(`click`,e=>{e.preventDefault(),Ap(8),n()}),_.appendChild(r),r}return n&&(v(`＋`,`Acercar`,()=>n(.18)),v(`－`,`Alejar`,()=>n(-.18))),r&&v(`🗺️`,`Inspeccionar plano`,r),i&&v(`⏸`,`Pausa`,i),{isTouch:a}}var pm=1.5;function mm(e,t){let n=document.createElement(`div`);n.className=`px-popups`,e.appendChild(n);let r=[],i=new G;function a({text:e,sub:t=``,x:i,z:a,kind:o=`score`}){let s=document.createElement(`div`);s.className=`px-pop px-pop-${o}`,s.innerHTML=`<span class="px-pop-main">${e}</span>${t?`<span class="px-pop-sub">${t}</span>`:``}`,n.appendChild(s),r.push({node:s,x:i,y:1.6*Z,z:a,life:pm})}function o(e){if(!r.length)return;let a=n.clientWidth,o=n.clientHeight;for(let n=r.length-1;n>=0;n--){let s=r[n];if(s.life-=e,s.life<=0){s.node.remove(),r.splice(n,1);continue}let c=1-s.life/pm;i.set(s.x,s.y+c*1.4*Z,s.z).project(t);let l=i.z<1;s.node.style.display=l?`block`:`none`,l&&(s.node.style.transform=`translate(-50%, -50%) translate(${(i.x+1)/2*a}px, ${(1-i.y)/2*o}px)`,s.node.style.opacity=String(Math.min(1,s.life/.4)))}}function s(){r.forEach(e=>e.node.remove()),r.length=0}return{spawn:a,update:o,clear:s}}var hm=`./`,gm=e=>`${hm}sprites/${e}.png`,_m=document.getElementById(`scene`),vm=document.getElementById(`app`),ym=document.getElementById(`boot`),bm=new Qu({canvas:_m,antialias:!1});bm.setPixelRatio(Math.min(window.devicePixelRatio,2)),bm.shadowMap.enabled=!0,bm.shadowMap.type=2,bm.toneMapping=4,bm.toneMappingExposure=1.15,bm.outputColorSpace=Le,bm.setSize(window.innerWidth,window.innerHeight);var xm=new Nn;xm.background=new q(10466505);var Sm=new vs(16777215,1);xm.add(Sm);var Cm=new ns(14674175,5261626,.85);xm.add(Cm);var wm=new _s(16773846,1.35);wm.position.set(26*Z,40*Z,20*Z),wm.castShadow=!0,wm.shadow.mapSize.set(2048,2048);var Tm=44*Z;wm.shadow.camera.left=-Tm,wm.shadow.camera.right=Tm,wm.shadow.camera.top=Tm,wm.shadow.camera.bottom=-Tm,wm.shadow.camera.far=220*Z,wm.shadow.bias=-.0018,xm.add(wm);async function Em(){let e=await np(),t=e.levels[0];zd(e.scenes.get(t.scene));let n=Hf(),{roomLabels:r,markerGroup:i}=bf(xm,n),a=Gf(n,{radius:.3*Z}),o=new Wd(window.innerWidth/window.innerHeight),s=o.camera,c=new Jf(bm,{pixelSize:Dp().pixelSize,levels:Dp().colorLevels});c.setSize(window.innerWidth,window.innerHeight);let l=e.characters,u=new Set([l.player.sheet,l.boss.sheet,...Ld.map(e=>e.sheet)]),d=new Map;await Promise.all([...u].map(async e=>d.set(e,await cp(gm(e)))));let f=new up(d.get(l.player.sheet),{x:kd.x,z:kd.z,radius:l.player.radius,height:l.player.height,speed:l.player.speed});xm.add(f.object3D);let p=Ld.map(e=>{let t=l.npcs[e.sheet]??{};return new dp(d.get(t.sheet??e.sheet)??d.values().next().value,{...e,radius:t.radius,height:t.height})});p.forEach(e=>xm.add(e.object3D));let m=new yp(d.get(l.boss.sheet),{world:n,route:Nd,navmesh:a,radius:l.boss.radius,height:l.boss.height,speeds:l.boss.speeds,visionRange:l.boss.visionRange,visionHalfAngleDeg:l.boss.visionHalfAngleDeg});xm.add(m.object3D),xm.add(m.cone);let h=mm(vm,s),g=dm({app:vm,renderer:bm,scene:xm,lights:{ambient:Sm,hemi:Cm,key:wm},player:f,boss:m,npcs:p,camera:o,levels:e.levels,codeEggs:e.codeEggs,manifest:e.manifest,onPopup:e=>h.spawn(e)}),_=!1;function v(){_=!_,document.body.classList.toggle(`inspect-mode`,_)}fm(f,vm,{onZoom:e=>o.zoomBy(e),onInspect:v,onPause:()=>g.openPause()}),window.addEventListener(`wheel`,e=>{g.dialogue.isOpen||g.menus.isOpen||o.zoomBy(-e.deltaY*.0012)},{passive:!0});let y=null,b={x:0,y:0};_m.addEventListener(`contextmenu`,e=>e.preventDefault()),_m.addEventListener(`pointerdown`,e=>{e.button!==2||g.menus.isOpen||(y=e.pointerId,b={x:e.clientX,y:e.clientY},_m.setPointerCapture(e.pointerId))}),_m.addEventListener(`pointermove`,e=>{e.pointerId===y&&(o.orbitBy((e.clientX-b.x)*.25,-(e.clientY-b.y)*.2),b={x:e.clientX,y:e.clientY})});let x=e=>{e.pointerId===y&&(y=null)};_m.addEventListener(`pointerup`,x),_m.addEventListener(`pointercancel`,x);let S=null,C=0,w=null,T=e=>Math.hypot(e[0].clientX-e[1].clientX,e[0].clientY-e[1].clientY),E=e=>({x:(e[0].clientX+e[1].clientX)/2,y:(e[0].clientY+e[1].clientY)/2});_m.addEventListener(`touchstart`,e=>{e.touches.length===2&&(S=T(e.touches),C=o.framing,w=E(e.touches))},{passive:!0}),_m.addEventListener(`touchmove`,e=>{if(e.touches.length!==2||!S)return;let t=T(e.touches),n=E(e.touches),r=Math.abs(t/S-1),i=Math.hypot(n.x-w.x,n.y-w.y);r*400>i?o.setFraming(C+(t/S-1)*.9):o.orbitBy((n.x-w.x)*.3,-(n.y-w.y)*.25),w=n},{passive:!0}),_m.addEventListener(`touchend`,e=>{e.touches.length<2&&(S=null)},{passive:!0});function D(){let e=window.innerWidth,t=window.innerHeight;bm.setSize(e,t),c.setSize(e,t),o.setAspect(e/t)}window.addEventListener(`resize`,D),window.addEventListener(`keydown`,e=>{e.key.toLowerCase()===`m`&&!g.dialogue.isOpen&&!g.menus.isOpen&&v()}),kp(e=>{c.setPixelSize(e.pixelSize),c.setLevels(e.colorLevels),i&&(i.visible=e.showMarkers)});let O=7*Z,k=13*Z,A=46*Z,j=new G;function ee(){let e=!o.isFollowing,t=Dp().showLabels;r.forEach(n=>{let r=n.userData.priority??2,i;if(!t&&!_)i=0;else if(_||r===1)i=1;else if(r>=3)i=0;else if(e)i=1;else{let e=Math.hypot(n.userData.homeX-f.position.x,n.userData.homeZ-f.position.z);i=Et.clamp((k-e)/(k-O),0,1)}n.material.opacity=i,n.visible=i>.02;let a=n.userData.baseScale;if(a&&n.visible){n.getWorldPosition(j);let e=Et.clamp(s.position.distanceTo(j)/A,.35,1.6);n.scale.set(a.x*e,a.y*e,1)}})}let M=[];xm.traverse(e=>{e.userData&&e.userData.bob&&M.push(e)}),ym?.remove(),g.start();let N=performance.now();function P(e){let t=Math.min((e-N)/1e3,.05);N=e;let r=e/1e3;g.isPaused||(f.update(t,n),p.forEach(e=>e.update(t,r))),g.update(t),M.forEach(e=>{let t=e.userData.bob;e.position.y=t.base+Math.sin(r*t.speed+t.offset)*t.amp,e.rotation.y=r*.6+t.offset}),ee(),o.update(t,f.position),h.update(t),c.render(xm,s),requestAnimationFrame(P)}requestAnimationFrame(P),window.__game={world:n,navmesh:a,player:f,boss:m,engine:g,camera:s,scene:xm,view:o,pixels:c,data:e},window.__floorplan=Sd}Em().catch(e=>{console.error(e);let t=document.createElement(`div`);t.className=`boot-error`,t.innerHTML=`<b>No se pudo iniciar el juego</b><br>${e.message??e}`,(ym??vm).replaceChildren(t)});